...
void 0 === n && (n = null);
void 0 === o && (o = 30);
if (this.istaiwan) t(); else if (cc.sys.os === cc.sys.OS_ANDROID || cc.sys.os === cc.sys.OS_IOS) if (u.default.instance.isopenAdvert && !d.default.isTouTiaoChannel) {
...
var l = e("../../code/manager/PanelManager"), s = e("../../code/manager/MyRoleDataManager"), c = e("../../code/manager/MissionManger"), u = e("../../code/manager/LoadManager"), d = e("../../code/Lib/LocalStorage"), p = e("../../code/manager/SDKManager"), f = e("../../code/manager/SoundManager"), h = e("../../code/Config/Config"), g = e("../../code/Lib/Global"), y = e("../../code/manager/GuideManager"), m = e("../../code/manager/EffectManager"), b = e("../../code/manager/NodePoolMananger"), v = e("../../code/manager/TableManager"), S = e("../../code/manager/BallManager"), _ = e("../../code/manager/BoxManager"), P = e("../prefab/BoxPrefab"), M = e("../../code/Lib/DateUtils"), C = e("../../code/ads/AdsGroupController"), L = e("../../OffLineSkill"), T = e("../../code/manager/Advert_Manager"), N = e("../../OfflineEarnings"), A = e("../../IsHaveUnlock"), B = e("../../EndlessManagement"), I = e("../../code/manager/Umeng_Manager"), w = e("../../code/manager/New_HttpManager"), k = e("./Connon"), O = e("../../BuffManager"), R = cc._decorator, G = R.ccclass, x = R.property, D = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.uiInAni = [];
...
w.default.instance.putPoint("10");
}
};
...
O.default.instance.addBuffShow(5e5, 10, l.default.game.BuffPrefab, this.buffIconAtlas[0], GlobalFun.i18n.t("lable.10269"));
}
}
this.playStartAni();
...
C.default.instance.cancelWaitAdsReady();
};
...
w.default.instance.putPointAdvertisement("4");
...
w.default.instance.putPointAdvertResult("1", "4");
}.bind(this), function() {
w.default.instance.putPointAdvertResult("0", "4");
}.bind(this));
} else {
f.default.playSoundEffect(f.default.btnSound);
l.default.instance.openPanel(h.PanelName.SkinPanel, this.middleNode);
...
a([ x(B.default) ], t.prototype, "EndlessManager", void 0);
a([ x({
type: cc.Button,
tooltip: "强化技能按钮"

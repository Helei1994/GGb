...
var a = e("../manager/LoadManager"), r = e("./AdsSetAndScene"), l = e("./AdsGroupPlatformTool"), s = e("./AdsQueue"), c = e("./AdsUnit"), u = e("../manager/SDKManager"), d = e("../Lib/LocalStorage"), p = e("../Lib/Global"), f = e("../manager/PanelManager"), h = cc._decorator, g = h.ccclass, y = (h.property, 
function(e) {
o(t, e);
function t() {
...
var i = c[o], a = e.thr[i].split("{");
a[1] = '{"id":' + i + ',"name":"' + a[0].slice(0, a[0].length - 1) + '",' + a[1];
this.severData.unit.push(JSON.parse(a[1]));
GlobalFun.log("severData[unit]:" + JSON.parse(a[1]));
}
}
if (e.one) {
...
var e = a.default.instance.getRes("/json/ads/ads_setting", cc.JsonAsset).json;
this.adsSet = new r.AdsSetting(e[0]);
};
t.prototype.initAdsScene = function() {
this.adsScene = {};
for (var e = this.adsSet._fromServerInfo ? this.severData.scence : a.default.instance.getRes("/json/ads/ads_scene", cc.JsonAsset).json, t = e.length, n = 0; n < t; n++) {
var o = e[n];
...
this.adsQueue = {};
for (var e = this.adsSet._fromServerInfo ? this.severData.group : a.default.instance.getRes("/json/ads/ads_group", cc.JsonAsset).json, t = e.length, n = 0; n < t; n++) {
var o = e[n];
...
this.adsUnit = {};
for (var e = this.adsSet._fromServerInfo ? this.severData.unit : a.default.instance.getRes("/json/ads/ads_units", cc.JsonAsset).json, t = e.length, n = 0; n < t; n++) {
var o = e[n];
...
for (var t = [], n = Object.keys(this.adsUnit), o = n.length, i = 0; i < o; i++) {
var a = this.adsUnit[n[i]];
a && a.placementID == e && t.push(a);
}
return t;
};
...
var i = this.getAdsScence(e);
GlobalFun.log("加载广告场景:adsScene" + i + "..." + e);
if (i) {
var a = this.getAdsQueue(i.queueID);
GlobalFun.log("加载广告策略adsScene:" + i + "..." + i.queueID);
if (a) {
a._isInPreload = !1;
a.load(o, t);
}
...
void 0 === t && (t = !1);
void 0 === n && (n = null);
for (var o = this.getPlacementUnits(e), i = o.length, a = 0; a < i; a++) {
var r = o[a];
...
for (var o, i = p.default.getTime(), a = this.getPlacementUnits(e), r = a.length, l = 0; l < r; l++) {
o = a[l];
if (!n && o.isAutoLoad) return;
if (t && o.noFillWait) {
o._isInNoFill = !0;
o._noFillStartTime = i;
}
o._isLoading = !1;
o._isReady = !1;
o._readyTime = 0;
...
var n, o = this.getPlacementUnits(e.placementID), i = o.length;
...
var i = o.isReady();
if (i) {
var a = o.getAdIndex(i.id);
return i && (a <= t || this.check(a, o.getCurloadAdsIndex(), t, i.price));
}
return !1;
}
}
...
t.prototype.waitAdsReady = function(e, t, n, o, i, a, r, l, s, c) {
var d = this;
void 0 === a && (a = null);
void 0 === r && (r = null);
void 0 === l && (l = 0);
...
var h = 0 == i ? cc.macro.REPEAT_FOREVER : i - 1;
...
for (var o = n.instance.getPlacementUnits(e.placementID), i = o.length, a = 0; a < i; a++) o[a]._isLoading = t;
};
t.prototype._onUnitChangeDestroy = function(e, t) {
for (var n = this.getPlacementUnits(e.placementID), o = n.length, i = 0; i < o; i++) {
n[i]._isDestroy = t;
}
};
...
var i = t[o];
i._isInNoFill = !1;
i._noFillStartTime = 0;
}
};
t.prototype.getAdmobSet = function() {
var e = "", t = "a";
if (this.adsSet) for (var n = this.adsSet.extraArgs.split(";"), o = n.length, i = 0; i < o; i++) for (var a = n[i].split(":"), r = a.length, l = 0; l < r; l++) "VungleVideoPlacements" == a[0] ? e = a[1] : "VunglePagePlacements" == a[0] ? t = a[1] : "isThirty" == a[0] ? this.isThirty = "true" == a[1] : "dailyAdsMax" == a[0] ? this.dailyAdsMax = Number(a[1]) : "isUseAppsflyer" == a[0] && (this.isUseAppsflyer = "true" == a[1]);
...
var i = e("./AdsGroupController"), a = e("../manager/SDKManager"), r = e("./AdsSetAndScene"), l = e("../manager/PanelManager"), s = e("../Config/Config"), c = e("../Lib/Global"), u = cc._decorator, d = u.ccclass, p = (u.property, 
function() {
function e() {}
t = e;
...
i.default.instance.checkAllAdsQueueLoadOnInit();
};
e.prototype.isAdsReady = function(e) {
var t = e.placementID, n = e.adsPlatform, o = e.type;
return a.default.instance.callJava("isAdsReady", "(IILjava/lang/String;)Z", Number(n), Number(o), t);
};
e.prototype.loadAds = function(e) {
GlobalFun.log("loadAds " + e.placementID);
var t = e.id, n = e.placementID, o = e.adsPlatform, i = e.type;
a.default.instance.callJava("loadAds", "(IILjava/lang/String;Ljava/lang/String;)V", Number(o), Number(i), n, t);
};
e.prototype.showAds = function(e) {
GlobalFun.log("showAds" + e.placementID);
if (e.adsPlatform != r.AdsPlatform.Self) {
var t = e.id, n = e.placementID, o = e.adsPlatform, i = e.type;
a.default.instance.callJava("showAds", "(IIILjava/lang/String;)V", Number(o), Number(i), Number(t), n);
...
a.default.instance.callJava("sendAdmobString", "(Ljava/lang/String;)V", i.default.instance.getAdmobSet());
};
e.prototype.test = function() {
a.default.instance.callJava("jsSend", "(Ljava/lang/String;)V", "jsSend");
};
...
var t = e.split(":");
i.default.instance._onPlacementReady(t[0], "true" == t[1] || "1" == t[1]);
};
e.prototype.onAdsClosed = function(e) {
GlobalFun.log("onAdsClosed: " + e);
var t = e.split(":");
i.default.instance._onUnitClosedEvent(Number(t[0]), "1" == t[1]);
};
e.prototype.onAdsLoadError = function(e) {
GlobalFun.log("onAdsLoadError: " + e);
var t = e.split(":");
i.default.instance._onPlacementLoadError(t[0], "1" == t[1], !0);
};
...
i.default.instance._onUnitClosedEvent(e.id, !0);
};
var t;
return e = t = o([ d ], e);
}());
...
var i = e("./AdsSetAndScene"), a = e("./AdsGroupController"), r = e("./AdsGroupPlatformTool"), l = function(e) {
o(t, e);
function t(t) {
...
if (this.type == i.AdsQueueType.INVALID) return null;
var t = this.getReady();
if (t) {
...
for (var e, t, n, o = {
value: 0
}, a = this.adsUnitsInfos.length; ;) {
var r = o.value;
e = r;
if (!this._gainLoadingCount(o)) break;
for (var l = (r = o.value) - e, s = 0; e < r; e++, s++) {
if (this.type == i.AdsQueueType.TURNS) {
t = (e + this._showCount * this.subQueueMembersCountInPriority) % a;
} else t = this.type == i.AdsQueueType.TURNS_PRIORITY ? r - l + (s + this._showCount) % l : e;
...
if (this.type != i.AdsQueueType.INVALID) {
this.subQueueLoadTimeout || (e = !1);
for (var n = this.adsUnitsInfos.length, o = 0; o < n; o++) {
var a = this.adsUnitsInfos[o];
if (a) {
a.refreshReadyState(!1);
a.prior && a.load(!0);
}
}
...
return this.type != i.AdsQueueType.INVALID && this.getReady();
};
t.prototype.isHighReady = function() {
if (this.type == i.AdsQueueType.INVALID) return !1;
var e = this.getReady();
...
var n = this.adsUnitsIDs[t], o = a.default.instance.getAdsUnit(n);
if (o && !o.isInNoFillWithRefreshNoFillState() && !o.isReady()) return !1;
}
return !0;
};
t.prototype.getCurloadAdsPrice = function() {
return this._curLoadAdUnits ? this._curLoadAdUnits.price : i.AdsPrice.Top;
};
...
if (!n._gainLoadingCount(a)) {
n._inLoadingCount = a.value;
return !1;
}
n._inLoadingCount = a.value;
for (var l = n._inLoadingCount - n.lastIndex, s = 0; n.lastIndex < n._inLoadingCount; n.lastIndex++, 
s++) {
if (n.type == i.AdsQueueType.TURNS) {
var c = n._showCount * n.subQueueMembersCountInPriority;
t = (n.lastIndex + c) % o;
} else t = n.type == i.AdsQueueType.TURNS_PRIORITY ? n._inLoadingCount - l + (s + n._showCount) % l : n.lastIndex;
var u = n.adsUnitsInfos[t];
if (u.price == i.AdsPrice.Auto && n._isInPreload && u.adsPlatform == i.AdsPlatform.Admob) r.default.instance.onAdsLoadError(u.placementID + ":0"); else {
n._curLoadAdUnits = u;
...
var o = e("./AdsSetAndScene"), i = e("./AdsGroupController"), a = e("./AdsGroupPlatformTool"), r = e("../manager/MyRoleDataManager"), l = e("../Config/Config"), s = e("../Lib/Global"), c = e("../manager/SDKManager"), u = function() {
function e(e) {
...
a.default.instance.isAdsReady(this) && (this._isReady = !0);
...
if (!(this.type == o.AdsType.Page && i.default.instance.noPage || this._isDestroy || this._isShown || this.isInNoFillWithRefreshNoFillState())) {
this.isAutoLoad && this.refreshReadyState(!0);
if (!this._isLoading && !this.isReady()) {
this.isAutoLoad || i.default.instance._onUnitChangeLoading(this, !0);
...
a.default.instance.loadAds(this);
}
}
};
e.prototype.show = function() {
if (this.type == o.AdsType.Page && i.default.instance.noPage) return !1;
if (this._isDestroy) return !1;
if (this.isReady()) {
i.default.instance.lastShowAdType = this.type;
a.default.instance.showAds(this);
return !0;
}
i.default.instance._onUnitClosed(this, !1);
this.load(!1);
return !1;
};
e.prototype.destroy = function() {
this._isDestroy || i.default.instance._onUnitChangeDestroy(this, !0);
};
...
i.default.instance._onFreshPlacementReady(this.placementID);
}
return this.isReady();
};
...
i.default.instance._onUnitClearNoFillState(this);
return !1;
}
return !0;
};
...
s.default.Random(0, 100) < e ? a.default.instance.onAdsReady(this.placementID) : a.default.instance.onAdsLoadError(this.placementID + ":true");
};
return e;
}();
n.default = u;
...
n.Adver_Type = void 0;
var a, r = e("./SDKManager"), l = e("./PanelManager"), s = e("./Umeng_Manager"), c = cc._decorator, u = c.ccclass, d = (c.property, 
function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.current_advert_type = a.ReWardVideo_Adv;
...
case a.ReWardVideo_Adv:
return !1;

case a.CanCloseVideo_Adv:
return !0;
}
};
...
var e = a.default.instance.getFunnelInfo(this.funnelId), t = s.default.instance.aircraftTable.getInfo(this.funnelId);
if (e && t) {
this.isUnlock = !0;
...
for (var n = this.pro.children.length, o = Math.floor((e - 1) / 5) + 1, i = 1; i < n; i++) if (e >= 5 * i + 1) this.pro.children[i].getComponent(d.default).pro = 5; else if (e <= 5 * (i - 1) + 1 && i <= t) this.pro.children[i].getComponent(d.default).pro = 0; else if (e <= 5 * i + 1 && e >= 5 * (i - 1) + 1 && i == o && i <= t) {
var a = (e - 2 - 5 * (o - 1)) % 5 + 1;
this.pro.children[i].getComponent(d.default).pro = a;
} else {
this.pro.children[i].getComponent(d.default).pro = 0;
this.pro.children[i].getComponent(d.default).lock();
}
};
...
if (a.default.instance.dleCurrency(this.upgradeMoney)) {
u.default.playSoundEffect(u.default.upgradeAircraft);
a.default.instance.funnelLevelUp(this.funnelId, 1);
...
var o = e[n];
if (o) {
var i = cc.instantiate(this.aircraftPrefab);
this.itemNode.addChild(i);
var a = i.getComponent("AircraftItem");
a.init(o.id, this.iconAtlas.getSpriteFrame(o.icon), this.iconAtlas.getSpriteFrame("Aircraft_" + o.id));
this.itemArr.push(a);
}
}
};
...
var i = this.findLockNode(), a = 0;
if (i > 3) {
this.scrollNode.scrollToBottom(.5);
a = .5;
}
var r = this.scrollNode.content.children[i];
this.scheduleOnce(function() {
...
var o = e("../../code/manager/MyRoleDataManager"), i = e("../../code/Lib/Global"), a = function() {
function e(e) {
this.table = e;
}
...
var n = this.table[t];
if (n) {
var a = o.default.instance.getFunnelInfo(Number(n.id));
a && a.phase < n.level_max / n.stage ? e.push(Number(n.id)) : a || e.push(Number(n.id));
}
}
return 0 == Object.keys(o.default.instance.funnelObject).length ? 302003 : i.default.arrRandom(e);
};
e.prototype.getRandomId = function() {
return Number(i.default.arrRandom(this.table).id);
};
return e;
}();
n.default = a;
...
var i = e("./NodePoolMananger"), a = e("./MyRoleDataManager"), r = e("./PanelManager"), l = e("../Lib/QuadTree"), s = e("../Lib/Global"), c = e("./TableManager"), u = e("../../src/prefab/PropPrefab"), d = e("./MissionManger"), p = cc._decorator, f = p.ccclass, h = (p.property, 
function() {
function e() {
this.ballPreArr = [];
...
this.ballPreArr = e;
this.physicsNode = t;
for (var a = 0; a < this.ballPreArr.length; a++) i.default.instance.addPool(this.ballPreArr[a], "BallPrefab");
this.preloadBall();
...
0 == a.default.instance.gameType && a.default.instance.curLevel % 5 == 0 && a.default.instance.curLevel >= 20 ? this.isBoss = 1 : this.isBoss = 0;
var t = c.default.instance.mapLevelTable.getDataByLevel(a.default.instance.curLevel);
this.minBallNum = Number(t.ball_low);
this.curLevelBallNum = Number(t.ball_complete);
this.curLevelBallNum = a.default.instance.curLevel >= 1 && a.default.instance.curLevel <= 3 ? 5 + 2 * (a.default.instance.curLevel - 1) : this.curLevelBallNum;
this.ballBasisHp = c.default.instance.mapLevelTable.getBaseHpByLevel(a.default.instance.curLevel);
...
var i = 0, r = Number((o / this.curLevelBallNum).toFixed(1));
if (this.countIsBossBall(r, n)) {
i = 3;
n++;
} else i = this.getBallPrefab();
this.ballOutTimes++;
this.ballOutArr.push(i);
this.totalSamllBall += Math.pow(2, i);
}
a.default.instance.curLevelTotalBall = this.curLevelBallNum;
this.ballOutTimes = 0;
};
...
if (!(a.default.instance.checkGameState([ 0, 2, 3, 4 ]) || this.ballOutTimes >= a.default.instance.curLevelTotalBall && 0 == a.default.instance.gameType)) {
...
if (!(a.default.instance.checkGameState([ 0, 2, 3, 4, 5 ]) || this.ballOutTimes >= a.default.instance.curLevelTotalBall && 0 == a.default.instance.gameType)) {
...
var o = 0, i = a.default.instance.curCannonID, r = c.default.instance.connonTable.getDataById(i);
if (0 == a.default.instance.gameType) {
var l = c.default.instance.mapLevelTable.getCurLevelIndex(a.default.instance.curLevel) + 1;
...
} else if (1 == a.default.instance.gameType) {
var p = a.default.instance.getConnonInfo(i);
...
if (!a.default.instance.checkGameState([ 0, 2, 4, 5 ])) for (var l = 0; l < e; l++) {
this.curBallNum++;
var u = i.default.instance.pop(this.ballPreArr[n].name);
...
a.default.instance.isInFrozen && u.ECScript.playFrozen();
...
if (!a.default.instance.checkGameState([ 0, 2, 3, 4 ])) {
var e = 0;
if (0 == a.default.instance.gameType) {
...
n = n <= 0 ? 1 : n;
var o = i.default.instance.pop(this.ballPreArr[e].name);
...
o = a.default.instance.goldDropCount(o);
o += Math.floor(1e-4 * l);
this.goldNumArr = [];
var p = s.default.Random(1, 2);
r.default.game.isGameComplete() && (p = 5);
1 == a.default.instance.gameType && (p = 0);
for (var f = 0; f < p; f++) {
var h = i.default.instance.pop("coinPrefab");
...
if (g && 1 != a.default.instance.gameType && !g.isCompleteAll && s.default.Random(0, 100) <= 10 && g.pro < g.quest) {
var y = i.default.instance.pop("propPrefab"), m = g.collectPropId;
...
this.propTime = n;
var o = i.default.instance.pop("propPrefab"), r = void 0;
if (s.default.Random(0, 100) <= 50 && (Object.keys(a.default.instance.funnelObject).length > 0 || 0 == a.default.instance.curLevel)) r = 500004; else {
var l = this.hpPropNum <= 4 ? s.default.Random(0, 100) : s.default.Random(0, 75);
r = 0 == a.default.instance.curLevel ? 500001 : l <= 10 ? 500001 : l <= 35 ? 500003 : l <= 75 ? 500005 : 500002;
}
...
if (this.isDiamond()) {
var d = i.default.instance.pop("coinPrefab");
...
var t = e.toString(), n = t.length, o = Number("1" + new Array(n).join("0")), i = Math.floor(e / o), a = Math.floor(i / 5);
a > 0 && this.goldNumArr.push(5 * o);
var r = Math.floor((i - 5 * a) / 2);
r > 1 ? this.goldNumArr.splice(0, 0, 2 * o, 2 * o) : r > 0 && this.goldNumArr.push(2 * o);
i - 5 * a - 2 * r > 0 && this.goldNumArr.push(1 * o);
return 1 != n ? this.countGoldNum(Number(t.toString().slice(1, t.toString().length))) : void 0;
};
e.prototype.isDiamond = function() {
if (1 == a.default.instance.gameType || 0 == a.default.instance.gameType) return !1;
if (a.default.instance.curDiamond >= this.maxDiamond || t.instance.clearSamllBall / t.instance.totalSamllBall < .4) return !1;
...
if (0 == this.leftLevel) {
this.leftLevel = s.default.Random(3, 8);
this.maxDiamond = 3 + 2 * c.default.instance.mapLevelTable.getCurChapter(a.default.instance.curLevel);
...
e.ECScript.toRight();
a.default.instance.isInFrozen && e.ECScript.playFrozen();
}, this), n = this.getBallEndPos(e.getPosition(), e.getComponent(cc.PhysicsCircleCollider).radius), o = .01 * Math.abs(e.getPosition().x - n.x) * .5, i = cc.sequence(cc.moveTo(o, n), t);
e.runAction(i);
};
...
if (1 == a.default.instance.gameType) {
...
for (var e = 0; e < 2; e++) {
var t = i.default.instance.pop(this.ballPreArr[0].name);
i.default.instance.push(t);
var n = i.default.instance.pop(this.ballPreArr[0].name);
i.default.instance.push(n);
var o = i.default.instance.pop(this.ballPreArr[1].name);
i.default.instance.push(o);
var a = i.default.instance.pop(this.ballPreArr[2].name);
i.default.instance.push(a);
var l = i.default.instance.pop(this.ballPreArr[3].name);
i.default.instance.push(l);
}
for (e = 0; e < 50; e++) {
var s = i.default.instance.pop("bulletPrefab");
s.active = !1;
r.default.game.bulletNode.addChild(s);
i.default.instance.push(s);
}
for (e = 0; e < 20; e++) {
var c = i.default.instance.pop("coinPrefab");
i.default.instance.push(c);
var u = i.default.instance.pop("bloodPrefab");
i.default.instance.push(u);
}
for (e = 0; e < 10; e++) {
var d = i.default.instance.pop(r.default.game.boomPrefab.name), p = i.default.instance.pop(r.default.game.smokePrefab.name);
i.default.instance.push(d);
...
if (2 == e || 3 == e) {
var i = t.exp_Colors[t.c_index];
t.icon_up.node.color = cc.color(i[0], i[1], i[2]);
}
}
...
this.unschedule(n);
if (1 == e || 3 == e) {
var i = d.default.game.ballSpriteAtlas.getSpriteFrame(this.expression_2[o]);
this.icon.spriteFrame = i;
}
if (2 == e || 3 == e) {
var a = [ 200, 0, 0 ];
this.icon_up.node.color = cc.color(a[0], a[1], a[2]);
}
}
...
var o = t.sub(e), i = o.mag();
return o.mul(n / i).add(e);
};
...
i([ P(cc.Integer) ], t.prototype, "jumpHeight", void 0);
i([ P(cc.Integer) ], t.prototype, "size", void 0);
i([ P(cc.Sprite) ], t.prototype, "icon", void 0);
i([ P(cc.Sprite) ], t.prototype, "icon_up", void 0);
i([ P(cc.Node) ], t.prototype, "myLable", void 0);
i([ P(cc.Float) ], t.prototype, "radius", void 0);
i([ P(cc.Node) ], t.prototype, "quan", void 0);
i([ P(b.default) ], t.prototype, "iconProgressBar2", void 0);
return t = i([ _ ], t);
}(l.default);
n.default = M;
cc._RF.pop();
...
var a = e("../manager/UiAniManager"), r = cc._decorator, l = r.ccclass, s = (r.property, 
function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
...
if (this.aniType != a.UiAniType.Null) {
this.addUiClip();
this.panelAni.playAdditive(this.aniType + e);
} else e == a.InOrOut.IN ? this.panelIn() : e == a.InOrOut.OUT && this.panelOut();
};
...
this.panelAni.addClip(a.default.getUiClip(this.aniType + a.InOrOut.IN));
this.panelAni.addClip(a.default.getUiClip(this.aniType + a.InOrOut.OUT));
...
var a = e("../../../code/manager/MyRoleDataManager"), r = cc._decorator, l = r.ccclass, s = r.property, c = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.sprite = null;
...
this.isUnlock ? this.isUnlock && a.default.instance.curLevel == this.level ? this.sprite.spriteFrame = this.resArr[1] : this.isUnlock && a.default.instance.curLevel > this.level && (this.sprite.spriteFrame = this.resArr[2]) : this.sprite.spriteFrame = this.resArr[0];
};
i([ s({
type: cc.Sprite,
tooltip: "图片"
...
var o = e("../Lib/LocalStorage"), i = e("../Lib/Global"), a = e("./SDKManager"), r = function() {
function e() {
this.boxDataArr = [];
...
for (var t = -1, n = [ 0, 1, 2, 3 ], o = this.boxDataArr.length, i = 0; i < o; i++) this.boxDataArr[i] && (n[this.boxDataArr[i].index] = -1);
var r = n.length;
for (i = 0; i < r; i++) -1 != n[i] && (t = n[i]);
if (-1 == t) return !1;
var l = this.initBoxData(t, e);
a.default.instance.callJava("trackEventWithType", "(Ljava/lang/String;Ljava/lang/String;I)V", "GetBox", e + "", 1);
...
a.default.instance.callJava("trackEventWithType", "(Ljava/lang/String;Ljava/lang/String;I)V", "OpenBox", this.boxDataArr[n].boxLevel + "", 1);
...
var i = GlobalFun.i18n.t("lable.10243").split("%d");
this.goldLabel.string = "<b>" + i[0] + "<color=#ffe262>" + u.default.setNum(o[1]) + "</c>-<color=#ffe262>" + u.default.setNum(o[2]) + "</c>" + i[1] + "</b>";
} else if (o[0] == s.CurrencyType.Diamond) {
this.diamondNode.active = !0;
i = GlobalFun.i18n.t("lable.10244").split("%d");
this.diamondLabel.string = "<b>" + i[0] + "<color=#ffe262>" + u.default.setNum(o[1]) + "</c>-<color=#ffe262>" + u.default.setNum(o[2]) + "</c>" + i[1] + "</b>";
} else if (o[0] == s.CurrencyType.Diamond) {
this.chipNode.active = !0;
i = GlobalFun.i18n.t("lable.10245").split("%d");
this.chipLabel.string = "<b>" + i[0] + "<color=#ffe262>" + u.default.setNum(o[1]) + "</c>-<color=#ffe262>" + u.default.setNum(o[2]) + "</c>" + i[1] + "</b>";
}
}
};
...
var a = e("../../code/manager/BoxManager"), r = e("../../code/Lib/Global"), l = e("../../code/Lib/DateUtils"), s = e("../../code/manager/PanelManager"), c = e("../../code/Config/Config"), u = cc._decorator, d = u.ccclass, p = u.property, f = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.timeLabel = null;
...
a.default.instance.openBox(this.boxData.index);
this.boxData = null;
...
var o = e("../../code/Lib/StringUtils"), i = e("../../code/manager/TableManager"), a = e("../../code/Lib/Global"), r = e("../../code/Config/Config"), l = function() {
function e(e) {
this.table = e;
}
e.prototype.getTime = function(e) {
...
for (var t = new Map(), n = this.rewardDis(e), o = n.length, i = 0; i < o; i++) {
var r = n[i], l = this.rewardType(), s = (r[2] - r[1]) / 4, c = a.default.Random(Math.round(r[1] + l * s), Math.round(r[1] + (l + 1) * s));
c = c < 1 ? 1 : c;
t.set(r[0], c);
}
return t;
...
for (var t = [], n = o.default.instance.strToArr4(e), a = n.length, l = 0; l < a; l++) {
var s = n[l], c = s[0] == r.CurrencyType.Gold ? Math.floor(i.default.instance.connonTable.getBestTenUpgradeMoney() * s[1] * .001) : s[1], u = s[0] == r.CurrencyType.Gold ? Math.floor(i.default.instance.connonTable.getBestTenUpgradeMoney() * s[2] * .001) : s[2];
t.push([ s[0], c, u ]);
}
return t;
};
...
var a = e("./BuffManager"), r = cc._decorator, l = r.ccclass, s = r.property, c = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.ProgressBar = null;
...
t.prototype.setPicture = function(e, t, n, o, i, r) {
void 0 === i && (i = !1);
void 0 === r && (r = -1);
this.isAircraft = r;
this.Times = t;
this.timemaximum = i ? 8 : t;
this.buffID = n;
...
500004 == this.buffID ? 0 == this.isAircraft ? delete a.default.instance.aircraft[0] : delete a.default.instance.aircraft[1] : delete a.default.instance.gobj[this.buffID];
...
i([ s(cc.ProgressBar) ], t.prototype, "ProgressBar", void 0);
i([ s(cc.Label) ], t.prototype, "Describe", void 0);
return t = i([ l ], t);
}(cc.Component);
n.default = c;
cc._RF.pop();
...
var o = e("./BuffHint"), i = e("./src/game/GameUI"), a = e("./code/manager/PanelManager"), r = e("./code/manager/MyRoleDataManager"), l = function() {
function e() {
this.gobj = {};
this.aircraft = {};
}
...
get: function() {
this._instance || (this._instance = new e());
this.GameUILiving || (this.GameUILiving = cc.find("Canvas").getComponent(i.default));
return this._instance;
},
enumerable: !1,
configurable: !0
});
e.prototype.addBuffShow = function(t, n, i, a, r, l) {
void 0 === l && (l = !1);
...
this.gobj[t] = c;
c.setPicture(a, n, t, r, l);
}
};
e.prototype.addBuffShow2 = function(t, n, i, a, r, l) {
void 0 === l && (l = !1);
...
switch (Number(e)) {
case 5e5:
a.default.game.playerScript.pauseInvincible(0, !0);
break;

case 500001:
r.default.instance.pauseInMagnet(0, !0);
break;
...
case 500003:
r.default.instance.pauseHit(0, !0);
break;
...
case 500005:
r.default.instance.pausefrozen(0, !0);
}
}
if (this.aircraft) for (var e in this.aircraft) {
this.aircraft[e].pauseBuff();
0 == Number(e) ? null != a.default.gameUi.Connon.funnelLeftScript && a.default.gameUi.Connon.funnelLeftScript.pauseInvincible(0, !0) : null != a.default.gameUi.Connon.funnelRightScript && a.default.gameUi.Connon.funnelRightScript.pauseInvincible(0, !0);
}
};
e.prototype.resumeAllBuff = function() {
if (this.gobj) for (var e in this.gobj) {
(n = this.gobj[e]).resumeBuff();
var t = n.getTimeRemaining();
switch (Number(e)) {
case 5e5:
a.default.game.playerScript.pauseInvincible(t);
break;

case 500001:
r.default.instance.pauseInMagnet(t);
break;
...
case 500005:
r.default.instance.pausefrozen(t);
}
}
if (this.aircraft) for (var e in this.aircraft) {
var n;
(n = this.aircraft[e]).resumeBuff();
t = n.getTimeRemaining();
0 == Number(e) ? null != a.default.gameUi.Connon.funnelLeftScript && a.default.gameUi.Connon.funnelLeftScript.pauseInvincible(t) : null != a.default.gameUi.Connon.funnelRightScript && a.default.gameUi.Connon.funnelRightScript.pauseInvincible(t);
}
};
return e;
}();
...
var a = e("../../code/basecode/EasyGetCompleteClass"), r = e("../../code/manager/BallManager"), l = e("../../code/manager/NodePoolMananger"), s = cc._decorator, c = s.ccclass, u = s.property, d = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.iconImg = null;
...
for (var e = r.default.instance.quadTree.findObjects([], this), t = e.length, n = 0; n < t; n++) for (var o = e[n], i = e[n].length, a = 0; a < i; a++) {
var l = o[a];
...
i([ u(cc.Sprite) ], t.prototype, "iconImg", void 0);
return t = i([ c ], t);
}(a.default);
n.default = d;
cc._RF.pop();
...
var a = e("./BulletBase"), r = e("../../code/manager/PanelManager"), l = e("../../code/manager/BallManager"), s = e("../../code/manager/MyRoleDataManager"), c = e("../../code/manager/EffectManager"), u = cc._decorator, d = u.ccclass, p = (u.property, 
function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
...
}), n = t.length, o = 0; o < n; o++) for (var i = t[o], a = t[o].length, s = 0; s < a; s++) {
var c = i[s];
...
var a = e("./BulletBase"), r = e("../../code/manager/BallManager"), l = e("./BallPrefab"), s = e("../../code/manager/PanelManager"), c = e("../../code/manager/MyRoleDataManager"), u = e("../../code/manager/EffectManager"), d = cc._decorator, p = d.ccclass, f = d.property, h = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.fire = null;
...
var o = this.target.x - this.node.x, i = this.target.y - this.node.y, a = GlobalFun.huToJiao * Math.acos(o / t);
a = this.changeRotation(a, o, i);
a = this.getTempRotation(a, -this.node.angle);
this.xSpeed = this.speed * Math.sin(a / GlobalFun.huToJiao);
this.ySpeed = this.speed * Math.cos(a / GlobalFun.huToJiao);
this.node.angle = -a;
...
t.prototype.setIcon = function(e) {};
i([ f(cc.ParticleSystem) ], t.prototype, "fire", void 0);
return t = i([ p ], t);
}(a.default);
n.default = h;
cc._RF.pop();
...
var a = e("./BulletBase"), r = e("../../code/manager/BallManager"), l = e("../../code/manager/MyRoleDataManager"), s = e("../../code/manager/PanelManager"), c = e("../../code/Config/Config"), u = cc._decorator, d = u.ccclass, p = u.property, f = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.attackImg = null;
...
for (var i in t) {
var a = r.default.instance.curBallArr[i];
if (a && a.isInit && Math.abs(a.node.x - this.node.x) <= a.radius) {
var l = a.radius - Math.sqrt(Math.pow(a.radius, 2) - Math.pow(a.node.x - this.node.x, 2)), u = a.node.y - this.node.y - .5 * a.node.height + l;
u = u <= 0 ? 0 : u;
if (Math.min(u, o) == u) {
o = u;
n = a;
...
t.prototype.setIcon = function(e) {};
i([ p(cc.Sprite) ], t.prototype, "attackImg", void 0);
return t = i([ d ], t);
}(a.default);
n.default = f;
cc._RF.pop();
...
var a = e("./BulletBase"), r = e("../../code/manager/MyRoleDataManager"), l = e("../../code/manager/NodePoolMananger"), s = e("../../code/manager/BallManager"), c = cc._decorator, u = c.ccclass, d = c.property, p = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.laserImg = null;
...
t.prototype.isCollided = function() {
if (!(this.node.x < 0 || this.node.x > 750) && this.isInit) for (var e = s.default.instance.quadTree.findObjects([], this), t = e.length, n = 0; n < t; n++) for (var o = e[n], i = e[n].length, a = 0; a < i; a++) {
var r = o[a];
...
var o = this.node.x - e.node.x, i = this.node.y - e.node.y, a = -e.node.angle / GlobalFun.huToJiao, r = cc.v2(o * Math.cos(a) + i * Math.sin(a), i * Math.cos(a) - o * Math.sin(a));
this.node.setPosition(r);
var l = cc.v2(o, i).angle(cc.v2(1, 0)) * GlobalFun.huToJiao + 270 - n, s = (e.radius + 70) / r.mag(), c = cc.sequence(cc.rotateTo(.2, l), cc.moveTo(.5, r.mulSelf(s)), cc.callFunc(function() {
t.inAttack = !0;
...
var a = e("./BulletBase"), r = e("../../code/manager/PanelManager"), l = e("../../code/manager/BallManager"), s = e("../../code/manager/MyRoleDataManager"), c = e("../../code/Config/Config"), u = cc._decorator, d = u.ccclass, p = u.property, f = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.attackImg = null;
...
for (var i in t) {
var a = l.default.instance.curBallArr[i];
if (a && a.isInit && Math.abs(a.node.x - this.node.x) <= a.radius) {
var s = a.radius - Math.sqrt(Math.pow(a.radius, 2) - Math.pow(a.node.x - this.node.x, 2)), u = a.node.y - this.node.y - .5 * a.node.height + s;
u = u <= 0 ? 0 : u;
if (Math.min(u, o) == u) {
o = u;
n = a;
...
var a = e("../../code/manager/PanelManager"), r = e("./BulletBase"), l = e("../../code/manager/MyRoleDataManager"), s = cc._decorator, c = s.ccclass, u = (s.property, 
function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
...
if (e) {
a.default.game.addScore(this.killNum);
...
var a = e("./BulletBase"), r = e("../../code/manager/MyRoleDataManager"), l = e("../../code/manager/PanelManager"), s = cc._decorator, c = s.ccclass, u = (s.property, 
function(e) {
o(t, e);
function t() {
...
var o = e("./code/Lib/LocalStorage"), i = function() {
function e(e) {
this.table = e;
}
...
var a = cc._decorator, r = a.ccclass, l = a.property, s = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.toggle = null;
...
i([ l(cc.Toggle) ], t.prototype, "toggle", void 0);
i([ l(cc.Sprite) ], t.prototype, "checkedSprite", void 0);
i([ l(cc.Sprite) ], t.prototype, "uncheckSprite", void 0);
return t = i([ r ], t);
}(cc.Component);
n.default = s;
cc._RF.pop();
...
var a = e("../../Script/code/Config/Config"), r = cc._decorator, l = r.ccclass, s = r.property, c = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.progressBar = null;
...
void 0 === t && (t = null);
if (t && t == a.BulletType.BulletLaser) {
...
i([ s(cc.ProgressBar) ], t.prototype, "progressBar", void 0);
i([ s(cc.Mask) ], t.prototype, "mask", void 0);
i([ s(cc.Sprite) ], t.prototype, "life_bar", void 0);
return t = i([ l ], t);
}(cc.Component);
n.default = c;
cc._RF.pop();
...
var a = e("../../code/basecode/EasyGetCompleteClass"), r = e("../../code/manager/NodePoolMananger"), l = e("../../code/manager/MyRoleDataManager"), s = e("../../code/manager/PanelManager"), c = e("../../code/manager/SoundManager"), u = e("../../code/Lib/Global"), d = e("../../code/manager/MissionManger"), p = cc._decorator, f = p.ccclass, h = p.property, g = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.disappeatAni = null;
...
i([ h(cc.Animation) ], t.prototype, "disappeatAni", void 0);
i([ h([ cc.SpriteFrame ]) ], t.prototype, "iconArr", void 0);
i([ h(cc.Sprite) ], t.prototype, "coinIcon", void 0);
return t = i([ f ], t);
}(a.default);
n.default = g;
cc._RF.pop();
...
c.default.instance.curSpecilMission.pro / c.default.instance.curSpecilMission.quest), i = o / 50;
this.missionProLabel.string = c.default.instance.curSpecilMission.pro + "/" + c.default.instance.curSpecilMission.quest;
this.missIonNumLabel.string = "+" + c.default.instance.itemCollectNum;
this.missionIcon.spriteFrame = l.default.gameUi.iconAtlas.getSpriteFrame(f.default.instance.propTable.getIcon(c.default.instance.curSpecilMission.collectPropId));
var a = 0;
...
e.missionPro.progress += i;
o <= e.missionPro.progress && (e.missionPro.progress = o);
if (a >= 51) if (!(e.levelPro.progress > .3 || u.default.instance.curDiamond >= 2) && g.default.instance.isThirty || g.default.instance.checkDailyAdsFull()) {
e.actionStep = 4;
e.adsCanTap();
} else e.actionStep++;
}, .01, 50);
...
var a = e("../../code/basecode/BasePanel"), r = e("../../code/manager/UiAniManager"), l = e("../../code/manager/PanelManager"), s = e("../../code/Config/Config"), c = e("../../code/manager/MyRoleDataManager"), u = e("./MissionPanel/RewardItem"), d = cc._decorator, p = d.ccclass, f = d.property, h = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.nameLabel = null;
...
i([ l(cc.Node) ], t.prototype, "bulletNode", void 0);
i([ l(cc.Sprite) ], t.prototype, "connonSprite", void 0);
return t = i([ r ], t);
}(cc.Component);
n.default = s;
cc._RF.pop();
...
var o = e("../../code/manager/MyRoleDataManager"), i = e("../../code/Config/Config"), a = e("../../code/manager/TableManager"), r = e("../../code/Lib/LocalStorage"), l = function() {
function e(e) {
this.table = e;
}
...
var o = 0;
n == i.RoleAttribute.MainGunLevel ? o = Math.pow(e.c_price_b, t) * e.c_price : n == i.RoleAttribute.ExtraGun ? o = Math.pow(e.m_price_b, t) * e.m_price : n == i.RoleAttribute.LifeLevel && (o = Math.pow(e.armor_price_b, t) * e.armor_price);
return Math.floor(o);
};
e.prototype.getBestTenUpgradeMoney = function() {
for (var e = 0, t = Number(r.default.getItem("skillIntensifyLevel")), n = t; n < t + 10; n++) {
n > 10 * this.table.length && this.table.length;
e += a.default.instance.connonTable.getRewardPrice(Number(n)) + a.default.instance.connonTable.getRewardPrice_up(Number(n)) * (n - 10 * Math.floor(n / 10 - .005));
}
return e;
};
...
var a = n[i];
if (a) for (var r = a.split(":"), l = r.length, s = 0; s < l; s++) if (Number(r[0]) == t) return Number(r[1]);
}
return 0;
};
return e;
...
void 0 === e && (e = -1);
var t = Number(u.default.getItem("skillIntensifyLevel")), n = c.default.instance.cannonGrowUp.getDataById(t), o = c.default.instance.connonTable.getDataById(this.connonId), i = c.default.instance.cannonGrowUp.getLine(t);
if (-1 == e) this.maxLife = this.life = Number(o.armor_basis) + Number(n.armor_basis) + Number(n.armor_up_b) * (t - 10 * (i - 1)); else if (0 == e) this.life = this.maxLife; else {
var a = Math.floor(this.maxLife * e);
this.life = this.life + a <= this.maxLife ? this.life + a : this.maxLife;
}
...
this.bulletNum += 3;
var i = c.default.instance.workShopTable.getCount(h.PropType.Tempest, s.default.instance.getPropLevel(h.PropType.Tempest));
this.bulletHit = Math.floor(this.bulletHit * (1 + i));
}
...
void 0 === t && (t = 0);
void 0 === n && (n = -1);
var i = 0 == t ? e : Math.ceil(this.mainGunHit * e);
this.bulletHit = this.mainGunHit + s.default.instance.addTempBulletHit(i);
-1 != n && this.scheduleOnce(function() {
s.default.instance.checkGameState([ 0, 3, 4, 5 ]) || (o.bulletHit = o.mainGunHit + s.default.instance.addTempBulletHit(-i));
}, n);
};
...
t.prototype.pauseInvincible = function(e, t) {
void 0 === t && (t = !1);
if (t) this.unschedule(this.delayed); else {
this.invincibleEndTime = f.default.getTime() + 1e3 * e;
this.scheduleOnce(this.delayed, e);
}
};
...
t[2]), i = s.default.instance.getConnonInfo(this.connonId);
this.connonSprite.spriteFrame = this.connonAtlas.getSpriteFrame(n + s.default.instance.getSourceNum(i.mainGunLevel - 1));
...
i([ _(cc.Sprite) ], t.prototype, "wheelSprite", void 0);
i([ _(cc.SpriteAtlas) ], t.prototype, "connonAtlas", void 0);
i([ _(cc.Sprite) ], t.prototype, "fire", void 0);
i([ _(cc.Sprite) ], t.prototype, "subConnon", void 0);
i([ _(cc.Node) ], t.prototype, "funnelLeftNode", void 0);
i([ _(cc.Node) ], t.prototype, "funnelRightNode", void 0);
i([ _(cc.Animation) ], t.prototype, "invincibleAin", void 0);
i([ _(cc.Integer) ], t.prototype, "invincibleTime", void 0);
i([ _(cc.Integer) ], t.prototype, "maxSpeed", void 0);
i([ _(cc.Integer) ], t.prototype, "aSpeed", void 0);
i([ _({
type: [ cc.Prefab ],
tooltip: "副炮预制体"
}) ], t.prototype, "funnelPrefabArr", void 0);
i([ _(cc.Animation) ], t.prototype, "invincibleAins", void 0);
return t = i([ S ], t);
}(p.default);
n.default = P;
cc._RF.pop();
...
t = 0 == n ? "00" : n < 10 ? "0" + n : "" + n;
var o, i, a = Math.floor((e - 3600 * n) / 60), r = Math.floor((e - 3600 * n) % 60);
o = 0 == a ? "00" : a < 10 ? "0" + a : "" + a;
i = 0 == r ? "00" : r < 10 ? "0" + r : "" + r;
...
var t = Math.floor(e / 86400), n = Math.floor(e % 86400 / 3600), o = Math.floor((e - 3600 * n - 86400 * t) / 60), i = Math.floor((e - 3600 * n - 86400 * t - 60 * o) % 60), a = "";
if (e > 0) {
if (0 == t) {
"";
if (0 == n) {
...
var a = cc._decorator, r = a.ccclass, l = (a.property, function(e) {
o(t, e);
function t() {
return null !== e && e.apply(this, arguments) || this;
}
...
n.EffectName = void 0;
var a = e("./LoadManager"), r = e("./NodePoolMananger"), l = e("../../src/prefab/FlyRewardPrefab"), s = e("../Lib/Global"), c = function() {
function e() {
...
e.prototype.playEffect = function(e, t, n, a, l, s) {
void 0 === l && (l = "");
void 0 === s && (s = 1);
...
e.prototype.playLoopEffect = function(e, t, n, a) {
void 0 === a && (a = "");
return o(this, void 0, void 0, function() {
var o;
return i(this, function(i) {
...
t.addChild(o);
o.setPosition(n);
o.getComponent(cc.Animation).play(a);
return [ 2, o ];
}
});
});
...
switch (n.label) {
case 0:
return (t = a.default.instance.getRes(this.url + e, cc.Prefab)) ? [ 3, 2 ] : [ 4, a.default.instance.loadRes(this.url + e, cc.Prefab) ];
...
(u = r.default.instance.pop("flyRewardPrefab")).getComponent(l.default).init(e[i], t[i], n[i], o);
} else {
var a = void 0;
if (0 == n) return;
a = n <= 10 ? Number(n) : n <= 100 ? Math.floor(Number(n) / 10) + 10 : n <= 1e3 ? Math.floor(Number(n) / 100) + 15 : n <= 1e4 ? Math.floor(Number(n) / 1e3) + 20 : 30;
e.position;
for (var c = 0; c < a; c++) {
...
var i = u.default.instance.ballOutTimes, a = 0;
a = i < 5 ? 1 : i >= 5 && i < 10 ? 5 : i >= 10 && i < 20 ? Math.floor(i / 2) : 20;
if (Number(h.default.getItem("EndlessIsRunOutOf")) > 0) {
this.moreRewardMap.set(s.CurrencyType.Diamond, a);
this.masonry.string = a.toString();
} else {
...
i([ S([ cc.Label ]) ], t.prototype, "setLabelString", void 0);
return t = i([ v ], t);
}(a.default);
n.default = _;
cc._RF.pop();
...
var a = e("./code/Lib/LocalStorage"), r = cc._decorator, l = r.ccclass, s = r.property, c = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.video = null;
...
t.EndlessIsRunOutOf = 7;
return t;
}
t.prototype.onLoad = function() {
this.video.active = !1;
var e = a.default.getItem("Endless");
if (!e) {
e = "3";
a.default.saveItem("Endless", e);
}
this.nowEndlessNumber = Number(e);
this.cishu.string = GlobalFun.i18n.t("lable.10287").replace("%d", this.nowEndlessNumber.toString());
var t = new Date(), n = a.default.getItem("DateTime");
if (!n || "0" == n) {
n = t.toLocaleDateString();
a.default.saveItem("DateTime", n);
}
var o = n.split("/"), i = t.toLocaleDateString(), r = i.split("/");
if (this.compareDate(r, o)) {
a.default.saveItem("EndlessIsRunOutOf", "7");
this.EndlessIsRunOutOf = 7;
a.default.saveItem("Endless", "3");
this.nowEndlessNumber = 3;
a.default.saveItem("DateTime", i);
}
this.updateVideo();
};
...
a.default.saveItem("Endless", this.nowEndlessNumber.toString());
if (-1 == e) {
this.EndlessIsRunOutOf--;
a.default.saveItem("EndlessIsRunOutOf", this.EndlessIsRunOutOf.toString());
}
this.updateVideo();
};
...
i([ s(cc.Node) ], t.prototype, "video", void 0);
i([ s(cc.Label) ], t.prototype, "cishu", void 0);
return t = i([ l ], t);
}(cc.Component);
n.default = c;
cc._RF.pop();
...
var a = e("../../code/manager/SDKManager"), r = e("../../code/manager/MyRoleDataManager"), l = e("../../code/Lib/LocalStorage"), s = e("../../code/manager/SoundManager"), c = e("../../code/basecode/BasePanel"), u = e("../../code/manager/PanelManager"), d = e("../../code/manager/UiAniManager"), p = e("../../code/Config/Config"), f = cc._decorator, h = f.ccclass, g = f.property, y = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.nameLable = null;
...
a.default.instance.rate();
};
t.prototype.panelOut = function() {
this.node.removeFromParent();
};
i([ g(cc.Label) ], t.prototype, "nameLable", void 0);
i([ g(cc.Label) ], t.prototype, "infoLable", void 0);
i([ g(cc.Label) ], t.prototype, "questionLable", void 0);
i([ g(cc.Label) ], t.prototype, "rateLabelShadow", void 0);
i([ g(cc.Label) ], t.prototype, "rateLabel", void 0);
i([ g(cc.Label) ], t.prototype, "endLabelShadow", void 0);
i([ g(cc.Label) ], t.prototype, "endLabel", void 0);
i([ g({
type: cc.Button,
tooltip: "评价按钮"
...
var a = e("../../code/Config/Config"), r = e("../../code/manager/PanelManager"), l = e("../../code/manager/NodePoolMananger"), s = e("../../code/manager/EffectManager"), c = e("../../code/manager/SoundManager"), u = e("../../code/manager/TableManager"), d = e("../../code/manager/MyRoleDataManager"), p = e("../../code/Lib/Global"), f = cc._decorator, h = f.ccclass, g = f.property, y = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.icon = null;
...
t.prototype.init = function(e, t, n, o, i, a) {
void 0 === o && (o = null);
void 0 === i && (i = null);
void 0 === a && (a = !0);
this.rewadrType = t;
...
s.default.instance.playEffect(s.EffectName.RewardFlyBoom, i.node, cc.v2(0, 0), function() {
i.node.stopAction(S);
i.node.removeFromParent();
l.default.instance.push(i.node);
r.default.instance.openPanel(a.PanelName.RefitShopPanel, r.default.gameUi.middleNode, i.rewadrType);
});
}));
...
r.default.gameUi.updataGold();
if (i.rewadrType == a.CurrencyType.Gold) {
var e = "";
d.default.instance.allGoldMore > 1 && (e = "(x" + d.default.instance.allGoldMore + ")");
r.default.gameUi.showToast(i.num + "", e, null == t ? cc.v2(-235.1, -32.7) : cc.v2(0, -32.7), null == t ? r.default.gameUi.highTopUiNode : t);
o && c.default.playSoundEffect(c.default.getCoinEnd);
r.default.gameUi.getTextTween(null == t ? r.default.gameUi.goldLable : t.getComponent(cc.Label), d.default.instance.Gold, d.default.instance.Gold - i.num, .01);
} else if (i.rewadrType == a.CurrencyType.Diamond) {
r.default.gameUi.showToast(i.num + "", "", null == t ? cc.v2(-11.3, -32.7) : cc.v2(0, -32.7), null == t ? r.default.gameUi.highTopUiNode : t);
o && c.default.playSoundEffect(c.default.getDiamod);
r.default.gameUi.getTextTween(null == t ? r.default.gameUi.goldLable : t.getComponent(cc.Label), d.default.instance.Diamond, d.default.instance.Diamond - i.num, .01);
}
i.node.stopAction(L);
i.node.removeFromParent();
l.default.instance.push(i.node);
...
t.prototype.funnelInit = function(e, t, n, o, i) {
void 0 === i && (i = !1);
this.node.y = -500;
this.showType = i;
this.isAni = !0;
...
var a = f.default.instance.getFunnelInfo(this.funnelId);
this.showType ? this.bulletHit = 1 : this.bulletType == d.BulletType.LifeShield && a ? this.leftLife = p.default.instance.aircraftTable.countAtk(this.funnelId, a.level) : a && (this.bulletHit = Math.ceil(c.default.game.playerScript.mainGunHit * p.default.instance.aircraftTable.countAtk(this.funnelId, a.level)));
};
...
t.prototype.pauseInvincible = function(e, t) {
void 0 === t && (t = !1);
t ? this.unschedule(this.funnelOut) : this.showType || this.scheduleOnce(this.funnelOut, e);
};
t.prototype.setEndTime = function() {
var e = p.default.instance.aircraftTable.getTime(this.funnelId) + 1, t = u.default.getTime();
t > this.endTime ? this.endTime = t + 1e3 * e : this.endTime += 1e3 * e;
this.unschedule(this.funnelOut);
this.pauseInvincible(.001 * (this.endTime - t));
};
t.prototype.dleLife = function(e) {
this.leftLife -= e;
...
this.exp_type = 0;
0 == s.default.instance.gameType && (this.exp_type = 4);
this.playStartAni();
...
this.startLab.string = GlobalFun.i18n.t("lable.10002");
...
this.lifeNode.stopAllActions();
this.Newincrease.stopAllActions();
var i = cc.moveTo(.25, cc.v2(375, 200)), a = cc.moveTo(.25, cc.v2(-375, 200)), r = cc.moveTo(.25, cc.v2(600, -1100));
this.goldLayout.node.runAction(i);
this.lifeNode.runAction(a);
...
this.redLife.unscheduleAllCallbacks();
var i = this.redLife.node.width, a = (o - i) / 20;
this.redLife.schedule(function() {
if (a >= 0 && n.redLife.node.width >= n.blueLife.node.width || a < 0 && n.redLife.node.width <= n.blueLife.node.width) {
n.redLife.node.width = o;
n.redLife.unscheduleAllCallbacks();
} else {
var e = n.redLife.node.width + a;
...
var i = b.default.instance.pop(this.toastPrefab.name);
if (i) {
i.getChildByName("firstLabel").getComponent(cc.Label).string = "+" + e;
i.getChildByName("secLabel").getComponent(cc.Label).string = t;
o.addChild(i);
i.position = n;
i.opacity = 255;
var a = cc.sequence(cc.moveBy(.5, cc.v2(0, -50)), cc.fadeOut(.5), cc.callFunc(function() {
i.removeFromParent();
i.stopAllActions();
b.default.instance.push(i);
}));
i.runAction(a);
}
};
...
t.prototype.getTextTween = function(e, t, n, o, i) {
void 0 === n && (n = 0);
void 0 === o && (o = .02);
void 0 === i && (i = .3);
var a = 0, r = this.getScrollingTimes(t.toString());
o = i / r;
...
i([ R([ cc.Animation ]) ], t.prototype, "uiInAni", void 0);
i([ R([ cc.Animation ]) ], t.prototype, "uiOutAni", void 0);
i([ R(cc.Animation) ], t.prototype, "handMoveAni", void 0);
i([ R(cc.Node) ], t.prototype, "scoreLable", void 0);
i([ R(cc.Label) ], t.prototype, "startLab", void 0);
i([ R(cc.Sprite) ], t.prototype, "handSprite", void 0);
i([ R(cc.Node) ], t.prototype, "levelCompleteNode", void 0);
i([ R(cc.Sprite) ], t.prototype, "backGroud", void 0);
i([ R(cc.Label) ], t.prototype, "maxScoreLable", void 0);
i([ R({
type: cc.Label,
tooltip: "游戏币lable"
}) ], t.prototype, "goldLable", void 0);
...
i([ R(cc.Animation) ], t.prototype, "goldLableAni", void 0);
i([ R(cc.Sprite) ], t.prototype, "goldImg", void 0);
i([ R(cc.Animation) ], t.prototype, "backgroundShackAni", void 0);
i([ R(cc.Animation) ], t.prototype, "blackAni", void 0);
i([ R(cc.Node) ], t.prototype, "middleNode", void 0);
i([ R([ cc.Prefab ]) ], t.prototype, "effectPrefabArr", void 0);
i([ R(cc.Node) ], t.prototype, "effectNode", void 0);
i([ R(cc.Layout) ], t.prototype, "goldLayout", void 0);
i([ R({
type: cc.Label,
tooltip: "游戏币lable"
...
i([ R(cc.SpriteFrame) ], t.prototype, "singleColor", void 0);
i([ R(cc.Node) ], t.prototype, "maskNode", void 0);
i([ R(cc.Label) ], t.prototype, "curLevel", void 0);
i([ R(cc.Label) ], t.prototype, "nextLevel", void 0);
i([ R(cc.ProgressBar) ], t.prototype, "pro", void 0);
i([ R({
type: cc.Node,
tooltip: "进度条节点"
}) ], t.prototype, "proNode", void 0);
i([ R(cc.Node) ], t.prototype, "maxscoreLayout", void 0);
i([ R(cc.Label) ], t.prototype, "levelLable", void 0);
i([ R({
type: cc.Button,
tooltip: "设置按钮"
...
i([ R([ cc.Node ]) ], t.prototype, "uiInNodes", void 0);
i([ R(cc.Button) ], t.prototype, "openLeftSideHurdle", void 0);
i([ R(A.default) ], t.prototype, "EndlessManager", void 0);
i([ R({
type: cc.Button,
tooltip: "强化技能按钮"
...
i([ R(cc.Label) ], t.prototype, "proTxt", void 0);
i([ R(N.default) ], t.prototype, "OfflineEarnings", void 0);
i([ R({
type: [ cc.SpriteFrame ],
tooltip: "buff icon资源"
...
i = f.default.instance.scenceTable.getEffectId(u.default.instance.curScenceID);
...
a.color = new cc.Color(Number(l[0]), Number(l[1]), Number(l[2]));
return [ 2 ];
}
});
});
...
var o = cc.v2(b.default.Random(0, n.node.width), b.default.Random(0, n.node.height)), i = cc.sequence(cc.moveTo(.6 * Math.random(), o), cc.moveTo(.6 * Math.random() + .3, o), cc.scaleTo(.2, 0), cc.callFunc(function() {
t.removeFromParent();
...
o.setBullet();
var i = cc.sequence(cc.moveTo(.3, cc.v2(150 * (e + 1), t.Player.y)), cc.callFunc(function() {
o.startShoot();
}));
n.runAction(i);
...
n++;
t = 0;
var i = c.default.instance.pop(e.specialLaser.name);
e.bulletNode.addChild(i);
var a = Object.keys(s.default.instance.curBallArr), r = a.length > 0 && 1 != o ? s.default.instance.curBallArr[b.default.arrRandom(a)].node.y : b.default.Random(600, 1200);
i.setPosition(cc.v2(750, r));
...
i.getComponent(P.default).init(5 * (l + 1) * e.playerScript.mainGunHit);
i.getComponent(cc.Animation).play();
i.getComponent(cc.Animation).once("stop", function() {
i.removeFromParent();
c.default.instance.push(i);
});
if (n >= 25) {
...
i([ B(cc.Node) ], t.prototype, "ballNode", void 0);
i([ B(cc.Node) ], t.prototype, "bulletNode", void 0);
i([ B(cc.Node) ], t.prototype, "Player", void 0);
i([ B(cc.Node) ], t.prototype, "wall", void 0);
i([ B(cc.Node) ], t.prototype, "frozen", void 0);
i([ B([ cc.Prefab ]) ], t.prototype, "ballPreArr", void 0);
i([ B(cc.Prefab) ], t.prototype, "coinPre", void 0);
i([ B(cc.Prefab) ], t.prototype, "connonPrefab", void 0);
i([ B(cc.Prefab) ], t.prototype, "boomPrefab", void 0);
i([ B(cc.Prefab) ], t.prototype, "funnulBommPrefab", void 0);
i([ B(cc.Prefab) ], t.prototype, "smokePrefab", void 0);
i([ B(cc.Prefab) ], t.prototype, "bloodPrefab", void 0);
i([ B(cc.Prefab) ], t.prototype, "coinNumPrefab", void 0);
i([ B(cc.Prefab) ], t.prototype, "completeEffect", void 0);
i([ B(cc.Prefab) ], t.prototype, "propPrefab", void 0);
i([ B({
type: cc.Prefab,
tooltip: "炮展示预制体"
...
var a = e("../../../code/Lib/Global"), r = e("../../../code/manager/TableManager"), l = e("../../../code/manager/SDKManager"), s = e("../../../code/Config/Config"), c = e("../../../code/Lib/Secret"), u = e("../../../code/manager/PanelManager"), d = e("../../../code/manager/EffectManager"), p = e("../../../code/Lib/DateUtils"), f = e("../../../code/manager/MyRoleDataManager"), h = cc._decorator, g = h.ccclass, y = h.property, m = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.nameLabel = null;
...
var e = a.default.getTime(), t = f.default.instance.discountEndTime - e;
...
o.active = !0;
if (2 == n) {
for (var i = t.length, l = 0; l < 2; l++) {
o.children[0].children[l].getChildByName("icon").getComponent(cc.Sprite).spriteFrame = this.iconSource[t[l][0] - 51e4];
o.children[0].children[l].getChildByName("num").getComponent(cc.Label).string = a.default.setNum(t[l][1]) + "";
}
o.children[1].getChildByName("icon").getComponent(cc.Sprite).spriteFrame = this.iconSource[t[2][0] - 51e4];
o.children[1].getChildByName("num").getComponent(cc.Label).string = a.default.setNum(t[2][1]) + "";
} else for (i = t.length, l = 0; l < i; l++) {
o.children[l].getChildByName("icon").getComponent(cc.Sprite).spriteFrame = this.iconSource[t[l][0] - 51e4];
o.children[l].getChildByName("num").getComponent(cc.Label).string = a.default.setNum(t[l][1]) + "";
}
}
};
...
t.children[0].children[o].getChildByName("num").getComponent(cc.Label).string = a.default.setNum(e[o][1]) + "";
...
var o = e("LanguageData"), i = e("ShaderUtils1");
e("QuadTree");
window.GlobalFun = {
i18n: null,
shaderUtils: null,
...
var a = e[n];
this.bloodColorArr[11 - n] = cc.color(a[0], a[1], a[2]);
}
...
void 0 === o && (o = 0);
if (!t) return 0;
var i = t.length, a = e.Random(0, i - 1);
return n ? t[a] != o ? t[a] : e.arrRandom(t, n, o) : t[a];
};
...
e.getAngle2 = function(t, n, o, i) {
var a = e.Length1(t, n, o, i);
return 180 * Math.asin((o - t) / a) / Math.PI;
};
e.random = function() {
return 0 == e.Random() ? -1 : 1;
};
e.disorderArr = function(t) {
for (var n, o, i = t.length, a = 0; a < i; a++) {
o = e.Random(0, i - 1);
n = t[a];
t[a] = t[o];
t[o] = n;
...
for (var t = this.getNumUnit(e, 6), n = t[0], o = t[1], i = Math.floor(e / o) + "", a = ""; i.length > 3; ) {
a = "," + i.slice(-3) + a;
...
if (n <= t) return [ "", 1 ];
var o = [ "K", "M", "B", "T", "Q" ], i = Math.floor((n - t - 1) / 3);
return [ o[i = i > o.length - 1 ? o.length - 1 : i], Number("1" + new Array(3 * (i + 1) + 1).join("0")) ];
};
e.exactSub = function(e, t) {
var n = e.toString().split("."), o = n[1] ? n[1].length : 0, i = t.toString().split("."), a = i[1] ? i[1].length : 0, r = Math.max(o, a), l = Number("1" + new Array(r + 1).join("0"));
return (e * l - t * l) / l;
};
e.exactAdd = function(e) {
for (var t = 0, n = 0; n < e.length; n++) {
var o = e[n].toString().split("."), i = o[1] ? o[1].length : 0;
t = Math.max(t, i);
}
var a = "1";
for (n = 0; n < t; n++) a += "0";
...
var n = 0, o = e.toString(), i = t.toString();
try {
n += o.split(".")[1].length;
} catch (e) {}
try {
...
return Number(o.replace(".", "")) * Number(i.replace(".", "")) / Math.pow(10, n);
};
...
var a = e("../../code/basecode/BasePanel"), r = e("../../code/manager/UiAniManager"), l = e("../../code/manager/PanelManager"), s = e("../../code/Config/Config"), c = cc._decorator, u = c.ccclass, d = c.property, p = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.nameLabel = null;
...
n.GuideType = void 0;
var i, a = e("./PanelManager"), r = e("../Config/Config"), l = e("./MyRoleDataManager"), s = e("./TableManager"), c = e("../../src/ui/RefitShopPanel/RefitItem"), u = e("../Lib/LocalStorage"), d = e("../../src/ui/AircraftPanel/AircraftItem"), p = e("./MissionManger"), f = e("../../src/ui/MissionPanel/MissionItem"), h = cc._decorator, g = h.ccclass, y = (h.property, 
function() {
function e() {
this.guideStep = 0;
this.isInGuide = 0;
...
u.default.saveItem("guideHistory", JSON.stringify(this.guideHistory));
this.guideStep++;
var e = a.default.gameUi.refitBtn.node.parent.convertToWorldSpaceAR(a.default.gameUi.refitBtn.node.position);
a.default.instance.openPanel(r.PanelName.GuidePanel, a.default.gameUi.node, a.default.gameUi.refitBtn.node, e, "click", i.ClickTarget, s.default.instance.guideTable.getWord(10001, 0));
} else if (1 == this.guideStep) {
this.guideStep++;
var t = a.default.instance.getExistPanel(r.PanelName.RefitShopPanel).itemNodeArr[1], n = (e = t.parent.convertToWorldSpaceAR(t.position), 
t.getComponent(c.default).levelUpBtn.node);
a.default.instance.openPanel(r.PanelName.GuidePanel, a.default.gameUi.node, n, e, "click", i.ClickTarget, -1, {
width: t.width,
height: t.height
});
}
...
u.default.saveItem("guideHistory", JSON.stringify(this.guideHistory));
this.guideStep++;
var e = a.default.gameUi.aircraftBtn.node.parent.convertToWorldSpaceAR(a.default.gameUi.aircraftBtn.node.position);
a.default.instance.openPanel(r.PanelName.GuidePanel, a.default.gameUi.node, a.default.gameUi.aircraftBtn.node, e, "click", i.ClickTarget, s.default.instance.guideTable.getWord(10001, 1));
} else if (1 == this.guideStep) {
this.guideStep++;
var t = a.default.instance.getExistPanel(r.PanelName.AircraftPanel).openGiftNode, n = (e = t.parent.convertToWorldSpaceAR(t.position), 
a.default.instance.getExistPanel(r.PanelName.AircraftPanel).openBtn.node);
a.default.instance.openPanel(r.PanelName.GuidePanel, a.default.gameUi.node, n, e, "click", i.ClickTarget, -1, {
width: t.width,
height: t.height
});
...
this.guideStep++;
var o = a.default.instance.getExistPanel(r.PanelName.AircraftPanel).openGiftNode.parent.children[4];
e = o.parent.convertToWorldSpaceAR(o.position), n = o.getComponent(d.default).levelUpBtn.node;
a.default.instance.openPanel(r.PanelName.GuidePanel, a.default.gameUi.node, n, e, "click", i.ClickTarget, s.default.instance.guideTable.getWord(10001, 3), {
width: o.width,
height: o.height
});
}
...
this.guideStep++;
var e = a.default.gameUi.refitBtn.node.parent.convertToWorldSpaceAR(a.default.gameUi.refitBtn.node.position);
a.default.instance.openPanel(r.PanelName.GuidePanel, a.default.gameUi.node, a.default.gameUi.refitBtn.node, e, "click", i.ClickTarget, s.default.instance.guideTable.getWord(10002, 1));
} else if (1 == this.guideStep) {
this.guideStep++;
a.default.instance.getExistPanel(r.PanelName.RefitShopPanel).setCurrentPage(1);
this.endGuide();
}
};
...
u.default.saveItem("guideHistory", JSON.stringify(this.guideHistory));
this.guideStep++;
var e = a.default.gameUi.missionBtn.node.parent.convertToWorldSpaceAR(a.default.gameUi.missionBtn.node.position);
a.default.instance.openPanel(r.PanelName.GuidePanel, a.default.gameUi.node, a.default.gameUi.missionBtn.node, e, "click", i.ClickTarget, s.default.instance.guideTable.getWord(10003, 0));
} else if (1 == this.guideStep) {
this.guideStep++;
var t = a.default.instance.getExistPanel(r.PanelName.MissionPanel).getCompleteNode(), n = (e = t.parent.convertToWorldSpaceAR(t.position), 
...
this.guideStep++;
var e = a.default.gameUi.missionBtn.node.parent.convertToWorldSpaceAR(a.default.gameUi.missionBtn.node.position);
a.default.instance.openPanel(r.PanelName.GuidePanel, a.default.gameUi.node, a.default.gameUi.missionBtn.node, e, "click", i.ClickTarget, p.default.instance.curSpecilMission.missionStartDes);
} else if (1 == this.guideStep) {
this.guideStep++;
var t = a.default.instance.getExistPanel(r.PanelName.MissionPanel).completeBtn.node, n = (e = t.parent.convertToWorldSpaceAR(t.position), 
a.default.instance.getExistPanel(r.PanelName.MissionPanel).completeBtn.node);
a.default.instance.openPanel(r.PanelName.GuidePanel, a.default.gameUi.node, n, e, "click", i.ClickAny, -1, {
width: t.width + 10,
height: t.height + 10
}, function() {
...
this.isInGuide = 10003;
if (0 == this.guideStep) {
a.default.gameUi.endlessBtn.interactable = !1;
u.default.saveItem("guideHistory", JSON.stringify(this.guideHistory));
this.guideStep++;
var e = a.default.gameUi.endlessBtn.node.parent.convertToWorldSpaceAR(a.default.gameUi.endlessBtn.node.position);
a.default.instance.openPanel(r.PanelName.GuidePanel, a.default.gameUi.node, a.default.gameUi.endlessBtn.node, e, "click", i.ClickTarget, s.default.instance.guideTable.getWord(10003, 1));
} else if (1 == this.guideStep) {
this.guideStep++;
var t = a.default.instance.getExistPanel(r.PanelName.SkinPanel).startBtn.node;
e = t.parent.convertToWorldSpaceAR(t.position);
a.default.instance.openPanel(r.PanelName.GuidePanel, a.default.gameUi.node, t, e, "click", i.ClickTarget, s.default.instance.guideTable.getWord(10003, 2), {
width: t.width,
height: t.height
});
}
...
var a = e("../../code/basecode/BasePanel"), r = e("../../code/manager/UiAniManager"), l = e("../../code/manager/PanelManager"), s = e("../../code/Config/Config"), c = e("../../code/manager/GuideManager"), u = e("../../code/manager/MyRoleDataManager"), d = cc._decorator, p = d.ccclass, f = d.property, h = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.showNode = null;
...
t.prototype.openPanel = function(e, t, n, o, i, a, l) {
void 0 === i && (i = -1);
void 0 === l && (l = null);
this.playUIAni(r.InOrOut.IN);
this.jiantouNode.active = !1;
this.init(e, t, n, o, i, a, l);
};
t.prototype.closePanel = function() {
this.playUIAni(r.InOrOut.OUT);
this.clear();
...
t.prototype.init = function(e, t, n, o, i, a, r) {
var l = this;
void 0 === i && (i = -1);
void 0 === r && (r = null);
...
this.wordNode.active = !(-1 == i);
this.wordLabel.string = GlobalFun.i18n.t("lable." + i);
this.showNode.x = s.x;
this.showNode.y = s.y;
...
this.guideAni(a && a.width ? a.width : this.targetNode.width, a && a.height ? a.height : this.targetNode.height, function() {
l.jiantouNode.x = s.x;
l.jiantouNode.y = s.y + -.1 * (a && a.height ? a.height : l.targetNode.height);
...
var o = this, i = (e - this.showNode.width) / 25, a = (t - this.showNode.height) / 25, r = 0;
this.schedule(function() {
r++;
o.showNode.width += i;
o.showNode.height += a;
o.showEventNode.width += i;
o.showEventNode.height += a;
if (r >= 25) {
o.showNode.width = e;
o.showNode.height = t;
...
var a = e("../ads/AdsGroupController"), r = e("./PanelManager"), l = cc._decorator, s = l.ccclass, c = (l.property, 
function(e) {
o(t, e);
function t() {
var t = e.call(this) || this;
...
void 0 === n && (n = null);
void 0 === o && (o = !0);
var i = this.adsRequest;
o && r.default.gameUi && r.default.gameUi.openMask(!0);
i.responseType = "text";
i.open("POST", e);
i.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
i.send(t);
i.onload = n || this.onPostComplete;
i.onerror = this.onPostIOError;
i.onprogress = this.onPostProgress;
i.ontimeout = this.onTimeOut;
i.abort = this.onAbort;
...
a.default.instance.dataFromSever(e);
};
...
a.default.instance.adsset || a.default.instance.initAdsSet();
this.postName = "advertisA";
this.adsRequest.type = e;
var n = "gameId=" + a.default.instance.adsset.appId + "&table=" + t, o = 0 == e ? a.default.instance.adsset.mainServer : a.default.instance.adsset.secondServer;
this.post(o + "/advertisA.json", n, null, !1);
} else a.default.instance.init();
};
var n;
t._instance = null;
return t = n = i([ s ], t);
...
var a = e("./code/manager/MyRoleDataManager"), r = e("./code/manager/TableManager"), l = cc._decorator, s = l.ccclass, c = l.property, u = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.tishi = null;
...
for (var e = r.default.instance.cannonUnlock.getCannonIdS(), t = 0; t < e.length; t++) if (!a.default.instance.checkConnonUnlocked(e[t])) {
var n = r.default.instance.cannonUnlock.getType(e[t], !0), o = r.default.instance.cannonUnlock.getConsume(e[t], !0), i = r.default.instance.cannonUnlock.getMap(e[t], !0);
switch (n) {
case "1":
if (a.default.instance.Gold >= Number(o) && a.default.instance.curLevel >= i) {
this.tishi.active = !0;
return;
}
break;
...
case "2":
if (a.default.instance.Diamond >= Number(o) && a.default.instance.curLevel >= i) {
this.tishi.active = !0;
return;
}
break;
...
case "3":
if (a.default.instance.curLevel >= i) {
this.tishi.active = !0;
return;
}
}
...
i([ c(cc.Node) ], t.prototype, "tishi", void 0);
return t = i([ s ], t);
}(cc.Component);
n.default = u;
cc._RF.pop();
...
i([ b(cc.Label) ], t.prototype, "loadLable", void 0);
i([ b(cc.Animation) ], t.prototype, "loadAni", void 0);
return t = i([ m ], t);
}(cc.Component);
n.default = v;
cc._RF.pop();
...
function r(e) {
if (!e) return "en";
for (var t = 0; t < i.length; t++) if (-1 != e.search(i[t])) return i[t];
return "en";
}
function l(e) {
var t = window.i18n.languages.languageText;
i = window.i18n.languages.languageArr;
var n = {
lable: {}
};
t[0][e] || (e = r(e));
...
var a = e("../../code/manager/NodePoolMananger"), r = cc._decorator, l = r.ccclass, s = r.property, c = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.proNode = null;
...
if (!(o = a.default.instance.popWithCheckExist(this.latticeNode.name))) {
a.default.instance.addPool(this.latticeNode);
this.latticeNode.setPosition(cc.v3(this.latticeNode.x, 0));
o = a.default.instance.pop(this.latticeNode.name);
}
o.active = !0;
...
var a = e("../../code/basecode/EasyGetCompleteClass"), r = e("../../code/Lib/Global"), l = cc._decorator, s = l.ccclass, c = l.property, u = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.scroll = null;
...
if (o) {
t++;
var i = this.itemPool.shift();
i || (i = cc.instantiate(this.itemPreFab));
this.scroll.content.addChild(i);
var a = o.icon ? this.spriteAtlas.getSpriteFrame(o.icon) : null;
i.ECScript.init({
icon: a,
data: o
});
...
var t = this.selectItem, n = [], o = cc.v2(0, 0), i = cc.v2(0, 0), a = this.scroll.getMaxScrollOffset();
...
this.scroll.scrollToOffset(i, e);
}
};
...
t.prototype.chooseSelectItemW = function(e, t, n, o, i) {
void 0 === n && (n = 0);
void 0 === o && (o = 0);
void 0 === i && (i = 0);
if (!e) return [ 0, 0 ];
var a = e.content.width, r = Math.abs(e.getScrollOffset().x), l = (a - n - o) / t, s = Math.round(r / l);
return [ s = (s = s > t ? t : s) < 0 ? 0 : s, (a - n - o - (t - 1) * i) / t ];
};
t.prototype.chooseSelectItemH = function(e, t, n, o, i) {
void 0 === n && (n = 0);
void 0 === o && (o = 0);
void 0 === i && (i = 0);
if (!e) return [ 0, 0 ];
var a = e.content.height, r = Math.abs(e.getScrollOffset().y), l = (a - n - o) / t, s = Math.round(r / l);
return [ s = (s = s > t ? t : s) < 0 ? 0 : s, (a - n - o - (t - 1) * i) / t ];
};
i([ c(cc.ScrollView) ], t.prototype, "scroll", void 0);
i([ c(cc.Prefab) ], t.prototype, "itemPreFab", void 0);
i([ c(cc.SpriteAtlas) ], t.prototype, "spriteAtlas", void 0);
i([ c(cc.Layout) ], t.prototype, "content", void 0);
return t = i([ s ], t);
}(a.default);
n.default = u;
cc._RF.pop();
...
var i = cc.director, a = i._getSceneUuid(e);
if (a) {
i.emit(cc.Director.EVENT_BEFORE_SCENE_LOADING, e);
...
this.loadCount++;
return [ 2, new Promise(function(o, i) {
cc.resources.loadDir(e, function(e, i) {
n.completeCount++;
o(t ? i : 1);
});
}) ];
...
var a = e("../../../code/manager/NodePoolMananger"), r = e("./NormalLevelBtn"), l = e("../../../code/manager/MyRoleDataManager"), s = e("./BossLevelBtn"), c = e("../../../code/Lib/Global"), u = cc._decorator, d = u.ccclass, p = u.property, f = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.levelNode = null;
...
var i = o + 1, u = l.default.instance.curLevel >= i, d = void 0;
if (i % 20 == 0) {
this.bossBtn = d = a.default.instance.pop("bossLevelBtn");
this.levelNode.addChild(d);
d.getComponent(s.default).init(u, i);
if (this.btnArr[n]) {
var p = this.btnArr[n];
p.removeFromParent();
...
d = a.default.instance.pop("normalLevelBtn");
this.levelNode.addChild(d);
this.btnArr[n] = d;
}
d.getComponent(r.default).init(u, i);
}
...
a.default.instance.push(this.bossBtn);
this.bossBtn = null;
}
};
...
var o = e("../../code/Lib/Global"), i = e("../../code/Lib/StringUtils"), a = e("../../code/manager/TableManager"), r = e("../../code/manager/MyRoleDataManager"), l = function() {
function e(e) {
...
var o = Number(this.table[t].basis_hp), i = Number(this.table[n].basis_hp), a = .1 * (e - this.getMaxLevel()) + 1;
a = (a = a < 1 ? 1 : a) > 8 ? 8 : a;
return ((i - o) * ((e - 1) % this.levelNumInOneChap / this.levelNumInOneChap) + o) * a;
};
...
e = e <= 1 ? 1 : e;
var t = this.getCurLevelIndex(e), n = this.getDataByLevel(e), r = i.default.instance.strToArr4(n.reward_level), l = t % 2, s = a.default.instance.connonTable.getBestTenUpgradeMoney(), c = new Map();
...
e = e <= 1 ? 1 : e;
var t = this.getDataByLevel(e), n = a.default.instance.connonTable.getBestTenUpgradeMoney(), o = new Map();
...
var a = e("../../../code/manager/UiAniManager"), r = e("../../../code/manager/PanelManager"), l = e("../../../code/Config/Config"), s = e("../../../code/manager/NodePoolMananger"), c = e("./MapItemPrefab"), u = e("../../../code/manager/MyRoleDataManager"), d = e("../../../code/manager/SoundManager"), p = e("../../../code/basecode/BasePanel"), f = cc._decorator, h = f.ccclass, g = f.property, y = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.nodeArr = [];
...
t._aniType = a.UiAniType.AlphaChange;
t.curIndex = 0;
t.touchId = -1;
return t;
}
...
t.prototype.openPanel = function() {
this.playUIAni(a.InOrOut.IN);
this.addEvent();
this.setPos(u.default.instance.curLevel - 1);
};
t.prototype.closePanel = function() {
this.playUIAni(a.InOrOut.OUT);
this.dleEvent();
};
t.prototype.panelIn = function() {};
t.prototype.panelOut = function() {
...
i([ g([ cc.Node ]) ], t.prototype, "nodeArr", void 0);
i([ g(cc.Node) ], t.prototype, "scenceParent", void 0);
i([ g(cc.Button) ], t.prototype, "closeButton", void 0);
i([ g({
type: [ cc.SpriteFrame ],
tooltip: "地图背景"
}) ], t.prototype, "mapResourceArr", void 0);
...
var a = e("../../../code/manager/MissionManger"), r = e("../../../code/manager/TableManager"), l = e("../../../code/Lib/DateUtils"), s = e("../../../code/Lib/Global"), c = e("./RewardItem"), u = e("../../../code/manager/SoundManager"), d = e("../../../code/manager/PanelManager"), p = e("../../../code/manager/MyRoleDataManager"), f = e("../../../code/manager/SDKManager"), h = cc._decorator, g = h.ccclass, y = h.property, m = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.missionNode = null;
...
if (e.isComplete && e.refreshTime - t < 0) {
this.missionData = e = a.default.instance.refreshMission(this.missionId);
this.missionId = e.id;
}
...
this.state = 1;
this.isInWait = !1;
this.missionData = a.default.instance.refreshMission(this.missionId);
this.missionId = this.missionData.id;
this.missionAni.play("missionItemMove");
};
t.prototype.completeMission = function() {
if (a.default.instance.checkMissionComplete(this.missionId)) {
...
this.missionData = a.default.instance.completeMission(this.missionId);
...
var i = e("../Lib/LocalStorage"), a = e("./TableManager"), r = e("../Lib/Global"), l = cc._decorator, s = l.ccclass, c = (l.property, 
function() {
function e() {
this.curMission = [];
this.itemCollectNum = 0;
var e = i.default.getItem("curMission", "[]");
this.curSpecilMission = JSON.parse(i.default.getItem("specialMission", "{}"));
...
if (!(n = a.default.instance.missionTable.getRandomMission())) return;
var t = this.normalMission(n);
this.curMission.push(t);
} else {
var n;
if (!(n = a.default.instance.missionTable.getRandomSpecialMission())) return;
...
this.curMission[n] = this.normalMission(a.default.instance.missionTable.getRandomMission());
this.saveMission();
...
e += "]";
i.default.saveItem("curMission", e);
i.default.saveItem("specialMission", JSON.stringify(this.curSpecilMission));
};
...
nextId: e.next_job,
totalPro: 1,
totalNumber: a.default.instance.missionTable.getSpecialTotal(e.type),
isCompleteAll: !1
};
};
...
this.curSpecilMission = this.specialMission(a.default.instance.missionTable.getData(t));
...
t.specialid = null;
t.missionScriptArr = [];
t._aniType = a.UiAniType.TopToDown;
...
for (e = 0; e < o; e++) {
var i = s.default.instance.curMission[e], a = this.missionScriptArr[e];
i ? a.init(i) : a.node.active = !1;
}
};
...
var o = e("../../code/manager/MyRoleDataManager"), i = e("../../code/Lib/Global"), a = e("../../code/Lib/StringUtils"), r = e("../../code/manager/MissionManger"), l = e("../../code/manager/TableManager"), s = function() {
function e(e) {
this.table = e;
}
e.prototype.getData = function(e) {
...
for (var e = 0 == o.default.instance.curLevel ? 1 : o.default.instance.curLevel, t = [], n = this.table.length, a = 0; a < n; a++) {
var l = this.table[a];
...
return i.default.arrRandom(t);
};
e.prototype.getRandomSpecialMission = function() {
var e = i.default.getServerWeek();
switch (e) {
case 1:
case 2:
e = 1;
...
for (var t = this.table.length, n = -1, o = [], a = 0; a < t; a++) {
var r = this.table[a];
...
return i.default.arrRandom(o);
};
e.prototype.getReward = function(e) {
for (var t = new Map(), n = this.table.length, o = 0; o < n; o++) {
var i = this.table[o];
if (i && i.id == e) for (var r = a.default.instance.strToArr3(i.reward), s = r.length, c = 0; c < s; c++) {
var u = r[c];
if (u) if (51e4 == u[0]) {
...
var i = this.spriteArr.length;
for (t = e; t < i; t++) if (this.spriteArr[t].node.parent) {
!0;
...
i([ l(cc.SpriteAtlas) ], t.prototype, "atlas", void 0);
i([ l(cc.Float) ], t.prototype, "startWidth", void 0);
return t = i([ r ], t);
}(cc.Component);
n.default = s;
cc._RF.pop();
...
var i = e("../Lib/LocalStorage"), a = e("./SDKManager"), r = e("../Config/Config"), l = e("./SoundManager"), s = e("../Lib/Secret"), c = e("../Lib/Global"), u = e("./TableManager"), d = e("./PanelManager"), p = e("./BallManager"), f = e("./EffectManager"), h = cc._decorator, g = h.ccclass, y = (h.property, 
function() {
function e() {
this.isFullScreen = !1;
this.fringeNum = 80;
...
void 0 === e && (e = null);
e = e || this.curCannonID;
var t = i.default.getItem("skillIntensifyLevel", "1");
return {
extraGun: Number(t),
lifeLevel: Number(t),
...
if (n) {
var o = i.default.getItem("skillIntensifyLevel");
return Number(o);
}
return 1;
};
...
this.curScore = 0;
this.gameState = 1;
a.default.instance.callJava("trackLevel", "(Ljava/lang/String;Ljava/lang/String;)V", "StartGame", t.instance.curLevel.toString());
a.default.instance.callJava("trackEvent", "(Ljava/lang/String;)V", "StartGame");
this.tempTimeBulletHit = 0;
};
...
i.default.saveItem("funnelObject", JSON.stringify(this.funnelObject));
};
...
i.default.saveItem("propObject", JSON.stringify(this.propObject));
}
};
...
this.pauseInMagnet(e);
};
e.prototype.pauseInMagnet = function(e, t) {
void 0 === t && (t = !1);
if (t) -1 != this.InMagnetNUB && clearTimeout(this.InMagnetNUB); else {
-1 != this.InMagnetNUB && clearTimeout(this.InMagnetNUB);
this.InMagnetNUB = setTimeout(this.InMagnetdelayed, 1e3 * e);
}
};
e.prototype.InMagnetdelayed = function() {
t.instance.isInMagnet--;
t.instance.isInMagnet <= 0 && (t.instance.isInMagnet = 0);
};
e.prototype.pauseHit = function(e, t) {
void 0 === t && (t = !1);
if (t) -1 != this.HitNUB && clearTimeout(this.HitNUB); else {
-1 != this.HitNUB && clearTimeout(this.HitNUB);
this.HitNUB = setTimeout(this.Hitdelayed, 1e3 * e);
}
};
...
e.prototype.pausefrozen = function(e, t) {
void 0 === t && (t = !1);
if (t) -1 != this.frozenNUB && this.frozenNUB; else {
-1 != this.frozenNUB && clearTimeout(this.frozenNUB);
this.frozenNUB = setTimeout(this.frozendelayed, 1e3 * e);
}
};
...
i.default.saveItem("skinObject", JSON.stringify(this.skinObject));
};
...
var e = Number(i.default.getItem("lastResetFreeVedioTimes", "0"));
if (this.isFreeVedio) {
if (c.default.getTime() > e) {
this.freeVedioTimes = 20;
i.default.saveItem("lastResetFreeVedioTimes", c.default.getTomorrowTime() + "");
i.default.saveItem("freeVedioTimes", this.freeVedioTimes + "");
}
}
};
...
i.default.saveItem("skillIntensifyLevel", "1");
i.default.saveItem("endlessMaxScore", "0");
i.default.saveItem("propObject", JSON.stringify(this.propObject));
i.default.saveItem("ConnonInfo", JSON.stringify(this.connonObject));
i.default.saveItem("funnelObject", JSON.stringify(this.funnelObject));
i.default.saveItem("skinObject", JSON.stringify(this.skinObject));
i.default.saveItem("Gold", this.Gold.toString());
i.default.saveItem("Diamond", this.Diamond.toString());
i.default.saveItem("Chip", this.Chip.toString());
i.default.saveItem("maxScore", this.maxScore.toString());
i.default.saveItem("curScenceID", this.curScenceID.toString());
i.default.saveItem("curCannonID", this.curCannonID.toString());
i.default.saveItem("curSkinID", this.curSkinID.toString());
i.default.saveItem("nextFreeUpgrade", this.nextFreeUpgrade.toString());
i.default.saveItem("isUseFreeUpgrade", this.isUseFreeUpgrade.toString());
i.default.saveItem("chooseFreeUpgrade", this.chooseFreeUpgrade.toString());
i.default.saveItem("curLevel", this.curLevel.toString());
i.default.saveItem("isRate", this.isRate.toString());
i.default.saveItem("soundState", l.default.soundState.toString());
i.default.saveItem("backSoundState", l.default.backSoundState.toString());
i.default.saveItem("effectSoundState", l.default.effectSoundState.toString());
i.default.saveItem("buyId", this.buyId.toString());
i.default.saveItem("specialConnon", this.specialConnon.toString());
i.default.saveItem("allGoldMore", this.allGoldMore.toString());
i.default.saveItem("isShack", this.isShack.toString());
i.default.saveItem("freeVedioTimes", this.freeVedioTimes.toString());
i.default.saveItem("isFreeVedio", this.isFreeVedio.toString());
i.default.saveItem("endlessLeftTimes", this.endlessLeftTimes.toString());
};
e.prototype.loadData = function() {
this.propObject = JSON.parse(i.default.getItem("propObject", "{}"));
this.connonObject = JSON.parse(i.default.getItem("ConnonInfo", "{}"));
this.funnelObject = JSON.parse(i.default.getItem("funnelObject", "{}"));
this.skinObject = JSON.parse(i.default.getItem("skinObject", "{}"));
this.Gold = i.default.getItem("Gold", "0");
this.Diamond = i.default.getItem("Diamond", "0");
this.Chip = i.default.getItem("Chip", "0");
this.maxScore = Number(i.default.getItem("maxScore", "0"));
this.curScenceID = Number(i.default.getItem("curScenceID", "20000"));
this.curCannonID = Number(i.default.getItem("curCannonID", "30000"));
this.curSkinID = Number(i.default.getItem("curSkinID", "600000"));
this.nextFreeUpgrade = Number(i.default.getItem("nextFreeUpgrade", "0"));
this.isUseFreeUpgrade = "true" == i.default.getItem("isUseFreeUpgrade", "false");
this.chooseFreeUpgrade = Number(i.default.getItem("chooseFreeUpgrade", "0"));
this.curLevel = Number(i.default.getItem("curLevel", "0"));
this.isRate = "true" == i.default.getItem("isRate", "false");
l.default.soundState = Number(i.default.getItem("soundState", "1"));
l.default.backSoundState = Number(i.default.getItem("backSoundState", "1"));
l.default.effectSoundState = Number(i.default.getItem("effectSoundState", "1"));
this.buyId = i.default.getItem("buyId", "");
this.specialConnon = i.default.getItem("specialConnon", "");
this.allGoldMore = Number(i.default.getItem("allGoldMore", "1"));
this.isShack = "true" == i.default.getItem("isShack", "true");
this.isFreeVedio = "true" == i.default.getItem("isFreeVedio", "false");
this.freeVedioTimes = Number(i.default.getItem("freeVedioTimes", "0"));
this.endlessLeftTimes = Number(i.default.getItem("endlessLeftTimes", "3"));
};
...
this.lastLoginTime = Number(i.default.getItem("lastLoginTime", "0"));
this.loginDays = Number(i.default.getItem("loginDays", "0"));
if (e > this.lastLoginTime) {
this.loginDays += 1;
this.lastLoginTime = c.default.getTomorrowTime();
i.default.saveItem("lastLoginTime", this.lastLoginTime.toString());
i.default.saveItem("loginDays", this.loginDays.toString());
}
return !1;
};
...
this.discountEndTime = Number(i.default.getItem("discountEndTime", "0"));
var n = this.discountEndTime - e;
if (n > this.discountExitTime) return 0;
if (n > 0) return 1;
if (3 != t && 6 != t && 0 != this.discountEndTime) return 0;
this.discountRefreshTime = Number(i.default.getItem("discountRefreshTime", "0"));
if (e < this.discountRefreshTime) return 0;
this.discountEndTime = e + this.discountExitTime;
i.default.saveItem("discountEndTime", this.discountEndTime + "");
i.default.saveItem("discountRefreshTime", c.default.getTomorrowTime() + "");
return 2;
};
...
a.default.instance.callJava("trackEventWithType", "(Ljava/lang/String;Ljava/lang/String;I)V", "GetGold", "gold", n);
break;

case r.CurrencyType.Diamond:
this.Diamond = this.Diamond + n;
n < 100 && a.default.instance.callJava("trackEventWithType", "(Ljava/lang/String;Ljava/lang/String;I)V", "GetDiamond", "diamond", n);
break;
...
if (isNaN(e)) {
e = this.Gold = Number(i.default.getItem("Gold", "10"));
...
if (isNaN(e)) {
e = this.Diamond = Number(i.default.getItem("Diamond", "0"));
...
if (isNaN(e)) {
e = this.Chip = Number(i.default.getItem("Chip", "0"));
...
var i = e[o];
if (i) {
var a = t.instance.getFunnelInfo(i.id);
if (!a) continue;
var l = a.phase * i.stage, s = u.default.instance.aircraftTable.countMoney(i.id, a.level);
if (!t.instance.currencuIsEnough(s) || a.level - 1 >= l || a.level - 1 >= i.level_max) continue;
return !0;
}
}
};
...
var a = e("./code/Lib/LocalStorage"), r = e("./code/manager/MyRoleDataManager"), l = e("./code/manager/PanelManager"), s = e("./code/manager/TableManager"), c = e(".//code/Lib/Global"), u = e("./code/manager/Advert_Manager"), d = e("./code/manager/SoundManager"), p = e("./code/manager/Umeng_Manager"), f = cc._decorator, h = f.ccclass, g = f.property, y = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.LevelValue = null;
...
this.setLabelString[1].string = GlobalFun.i18n.t("lable.10281").replace("%d", a.default.getItem("offLineLevel"));
} else {
this.setLabelString[0].string = GlobalFun.i18n.t("lable.10275");
this.setLabelString[1].string = GlobalFun.i18n.t("lable.10281").replace("%d", a.default.getItem("skillIntensifyLevel"));
}
...
this.offLineLevel = a.default.getItem(this.offOvBuffName);
if (!this.offLineLevel) {
this.offLineLevel = "1";
a.default.saveItem(this.offOvBuffName, this.offLineLevel);
}
...
(i = Math.floor(n / 10 - .005)) > o && (i = o);
this.nowUpgradeGold = e + t * (n - 10 * i);
} else {
...
} else cc.log("错误：程序不应该运行到这里，如果进入这里，就有整个代码就有逻辑错误！");
};
var n;
i([ g(cc.Label) ], t.prototype, "LevelValue", void 0);
i([ g(cc.Button) ], t.prototype, "videoUpgrade", void 0);
i([ g(cc.Button) ], t.prototype, "goldUpgrade", void 0);
i([ g(cc.Label) ], t.prototype, "upgradeGold", void 0);
i([ g(cc.Node) ], t.prototype, "tishi", void 0);
i([ g(cc.Animation) ], t.prototype, "effect", void 0);
i([ g(cc.Boolean) ], t.prototype, "isOffLineSkill", void 0);
i([ g(n) ], t.prototype, "LineSkil", void 0);
i([ g([ cc.Label ]) ], t.prototype, "setLabelString", void 0);
i([ g([ cc.Node ]) ], t.prototype, "fullLevel", void 0);
return t = n = i([ h ], t);
}(cc.Component);
n.default = y;
cc._RF.pop();
...
this.isguide = !1;
this.ear = a.default.getItem("earnings");
if (this.ear && "0" != this.ear) this.earnings = Number(this.ear); else {
var e = a.default.getItem("offLine");
if (!e) {
cc.log("还未离线过");
this.node.active = !1;
return;
...
this.offLineLevel = a.default.getItem("offLineLevel");
if ("" == this.offLineLevel) {
this.offLineLevel = "1";
a.default.saveItem("offLineLevel", this.offLineLevel);
}
...
a.default.saveItem("earnings", this.earnings.toString());
}
...
var i = d.default.instance.OffLineTable.getlength(), a = d.default.instance.OffLineTable.getRewardPrice(Number(o >= 10 * i ? 10 * i : o)), r = d.default.instance.OffLineTable.getRewardPrice_up(Number(o >= 10 * i ? 10 * i : o)), l = Math.floor(o / 10 - .005);
l > i && (l = i);
n += a + r * (o - 10 * l);
}
...
(i = o.getComponent(e)).openPanel.apply(i, n);
l.default.playSoundEffect(l.default.uiOpen);
this.openMap.set(e, i);
return [ 2, i ];
}
});
});
...
void 0 === t && (t = !1);
for (var n = [], o = 2; o < arguments.length; o++) n[o - 2] = arguments[o];
var i = this.openMap.get(e);
if (i) {
i.closePanel.apply(i, n);
...
var a = e("../../../code/manager/UiAniManager"), r = e("../../../code/manager/PanelManager"), l = e("../../../code/Config/Config"), s = e("../../../code/manager/MyRoleDataManager"), c = e("../MissionPanel/MissionItem"), u = e("../../../code/manager/MissionManger"), d = e("../../../code/manager/SoundManager"), p = e("../../../code/basecode/BasePanel"), f = cc._decorator, h = f.ccclass, g = f.property, y = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.backNode = null;
...
t.prototype.toTop = function() {
var e = a.default.random();
e = this.node.x < 375 ? -1 : 1;
this.curSpeed = cc.v2((1.5 * Math.random() + 2) * e, a.default.Random(-5, -10));
this.aSpeed = cc.v2(0, -.3);
};
t.prototype.setIcon = function() {
...
-1 == a.default.random() ? this.xiabiao = 5 : this.xiabiao = 0;
return this.xiabiao;
};
t.prototype.contactEffect = function() {
switch (this.propId) {
...
i([ b(cc.Sprite) ], t.prototype, "propIcon", void 0);
return t = i([ m ], t);
}(cc.Component);
n.default = v;
cc._RF.pop();
...
for (var t = [], n = this.table.length, a = 0; a < n; a++) {
var r = this.table[a];
...
return Number(i.default.arrRandom(t));
};
e.prototype.getInfo = function(e) {
for (var t = 0; t < this.table.length; t++) {
var n = this.table[t];
...
this.getMoreIndex(t);
for (var i = o.length - 1; i >= 0; i--) this.findObjects(e, {
node: o[i]
});
}
...
var t, n, o, i = this.objects;
e = e || this;
for (n = i.length - 1; n >= 0; n--) i[n].destroy ? i.splice(n, 1) : -1 === (t = this.getIndex(i[n])) ? this !== e && e.insert(i.splice(n, 1)[0]) : this.nodes.length && this.nodes[t].insert(i.splice(n, 1)[0]);
...
void 0 === t && (t = 1);
if (e) if (e instanceof Array) for (var n = 0, o = e.length; n < o; n++) this.insert(e[n]); else if (e instanceof Object && 0 == t) for (var i in e) this.insert(e[i]); else {
if (this.nodes.length) {
...
var a = this.objects;
this.objects.push(e);
if (a.length > this.maxObjects && this.level < this.maxLevels) {
null == this.nodes[0] && this.splite();
for (n = 0; n < a.length; ) {
var r;
if (-2 == (r = this.getIndex(a[n]))) return;
-1 != r && -2 != r ? this.nodes[r].insert(a.splice(n, 1)[0]) : n++;
}
}
}
};
...
var t = e.node, n = -1, o = this.bounds.x + this.bounds.width / 2, i = this.bounds.y + this.bounds.height / 2, a = t.y < i && t.y + t.height * (1 - t.anchorY) < i, r = t.y > i && t.y - t.height * (1 + t.anchorY) > i;
t.x < o && t.x + .5 * t.width < o ? a ? n = 1 : r && (n = 2) : t.x > o && t.x - .5 * t.width > o && (a ? n = 0 : r && (n = 3));
return n;
};
e.prototype.getMoreIndex = function(e) {
if (!e || !e.node) return -2;
var t = e.node, n = -1, o = this.bounds.x + this.bounds.width / 2, i = this.bounds.y + this.bounds.height / 2, a = t.y <= i && t.y + t.height * t.anchorY <= i, r = t.y >= i && t.y - t.height * t.anchorY >= i;
...
var n = this.bounds.x + this.bounds.width / 2, o = this.bounds.y + this.bounds.height / 2, i = [], a = e.y - o + .5 * e.height, r = o - e.y + .5 * e.height, l = e.x - n + .5 * e.width, s = n - e.x + .5 * e.width;
if (5 == t || 7 == t) {
var c = {
name: e.name,
height: a,
...
t.prototype.updateInfo = function() {
var e = c.default.instance.connonTable.getDataById(this.connonId), t = a.default.instance.getConnonLevel(this.type, this.connonId);
this.isUnlock = !(-1 == t);
this.lockNode.active = !this.isUnlock;
...
t.prototype.levelUpTap = function() {
if (this.isUnlock) if (a.default.instance.dleCurrency(this.upgradeMoney)) {
this.playSound();
...
r.default.gameUi.updataGold();
a.default.instance.attributeLevelUp(this.type, this.connonId);
...
var e = this;
if (a.default.instance.dleCurrency(this.unlockMoney, l.CurrencyType.Diamond)) {
...
a.default.instance.attributeLevelUp(this.type, this.connonId, 2);
...
t.goldMasonry = [];
t.setLabelString = [];
t._aniType = a.UiAniType.RefitShopPanelPanel;
t.unlockDiamond = 0;
t.isInit = !1;
t.connonGroup = {};
return t;
...
var n = e[t];
if (n) {
var o = r.default.instance.getConnonInfo(n.id), i = this.spriteAtlas.getSpriteFrame(n.image_cannon + (o ? r.default.instance.getSourceNum(o.mainGunLevel - 1) : "0")), a = this.spriteAtlas.getSpriteFrame(n.image_basis + "0"), l = this.spriteAtlas.getSpriteFrame("Gun_301000_" + (Number(n.id) - 301e3) % 5), c = cc.instantiate(this.connonShowPrefab);
this.connonGroup[Number(n.id)] = c;
c.getChildByName("connon").getComponent(cc.Sprite).spriteFrame = i;
c.getChildByName("wheel").getComponent(cc.Sprite).spriteFrame = a;
...
this.condition.active = !1;
this.consume.active = !1;
var n = s.default.instance.cannonUnlock.getType(this.chooseConnonID, !0), o = s.default.instance.cannonUnlock.getConsume(this.chooseConnonID, !0), i = s.default.instance.cannonUnlock.getMap(this.chooseConnonID, !0);
switch (n) {
case "1":
this.goldUnlockgoldTXT.string = h.default.setNum(o);
if (r.default.instance.curLevel >= Number(i)) {
this.condition.active = !1;
r.default.instance.Gold < Number(o) ? this.showButton(this.ButtonS[1]) : this.showButton([ this.ButtonS[1], this.ButtonS[3] ]);
} else {
this.condition.getChildByName("con").getComponent(cc.Label).string = "LV" + i;
...
var e = s.default.instance.connonTable.getDataById(this.chooseConnonID), t = this.connonPage.getCurrentPageIndex(), n = this.connonPage.getPages(), o = r.default.instance.getConnonInfo(e.id), i = this.spriteAtlas.getSpriteFrame(e.image_cannon + (o ? r.default.instance.getSourceNum(o.mainGunLevel - 1) : "0")), a = this.spriteAtlas.getSpriteFrame(e.image_basis + "0"), l = (o && -1 != o.extraGun && r.default.instance.getSourceNum(o.extraGun - 1), 
...
i([ _([ cc.Label ]) ], t.prototype, "setLabelString", void 0);
return t = i([ S ], t);
}(p.default);
n.default = P;
cc._RF.pop();
...
i([ m(cc.ProgressBar) ], t.prototype, "timePro", void 0);
i([ m(cc.Node) ], t.prototype, "resurgenceLable", void 0);
i([ m({
type: cc.Label,
tooltip: "复活钻石数量"
}) ], t.prototype, "diamondLable", void 0);
...
i([ m([ cc.Label ]) ], t.prototype, "setLabelString", void 0);
return t = i([ y ], t);
}(d.default);
n.default = b;
cc._RF.pop();
...
var a = e("../../../code/Lib/Global"), r = e("../../../code/manager/EffectManager"), l = e("../../../code/manager/PanelManager"), s = e("../../../code/Config/Config"), c = e("../../../code/manager/SoundManager"), u = e("../../../code/manager/MyRoleDataManager"), d = e("../../../code/manager/TableManager"), p = cc._decorator, f = p.ccclass, h = p.property, g = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.goldLabel = null;
...
for (var n = [ this.goldLabel, this.diamondLabel, this.chipLabel ], o = [ this.goldNode, this.diamondNode, this.chipNode ], i = 0, r = 0; r < 3; r++) {
var s = n[r], c = o[r];
if (e.has(51e4 + r)) {
i++;
s.string = a.default.setNum(e.get(51e4 + r)) + "";
"0" == s.string ? c.active = !1 : c.active = !0;
} else c.active = !1;
}
if (this.connonNode) {
this.connonNode.active = !1;
i < this.reward.size && this.reward.forEach(function(e, n) {
if (u.default.instance.isConnon(n) && t.connonNode) {
t.connonNode.active = !0;
var o = d.default.instance.connonTable.getScourceId(n, 4), i = o[0], a = o[1], r = o[2];
t.connon.spriteFrame = l.default.game.playerScript.connonAtlas.getSpriteFrame(i + "0");
t.wheel.spriteFrame = l.default.game.playerScript.connonAtlas.getSpriteFrame(r + "0");
t.sub.spriteFrame = l.default.game.playerScript.connonAtlas.getSpriteFrame(a + "0");
}
});
}
};
...
void 0 === e && (e = null);
void 0 === t && (t = 1);
var o = 0, i = [ this.goldIcon, this.diamondIcon, this.chipIcon ];
this.reward.forEach(function(a, l) {
if (u.default.instance.isConnon(l)) {
if (!n.connonNode) return;
r.default.instance.rewardFly(n.connonNode, l, a * (l == s.CurrencyType.Gold ? t : 1));
} else {
var c = l - 51e4;
i[c] && i[c].node && r.default.instance.rewardFly(i[c].node, l, a * (l == s.CurrencyType.Gold ? t : 1), null == e ? null : e[o]);
}
o++;
});
};
...
var n = this;
this.complete = t;
for (var o = [ this.goldLabel, this.diamondLabel, this.chipLabel ], i = [ this.goldNode, this.diamondNode, this.chipNode ], a = 0; a < 3; a++) {
var r = o[a];
1 == i[a].active && e.has(51e4 + a) && this.getTextTween(r, Number(this.reward.get(51e4 + a)) + Number(e.get(51e4 + a)), Number(this.reward.get(51e4 + a)), .01);
}
...
var o = Array(e), i = 0;
for (t = 0; t < n; t++) for (var a = arguments[t], r = 0, l = a.length; r < l; r++, 
i++) o[i] = a[r];
return o;
};
Object.defineProperty(n, "__esModule", {
...
var a = e("./MyRoleDataManager"), r = (e("../Lib/LocalStorage"), e("./PanelManager")), l = e("../Config/Config"), s = cc._decorator, c = s.ccclass, u = (s.property, 
function() {
function e() {}
t = e;
Object.defineProperty(e, "instance", {
...
if (1 == a.default.instance.gameState) {
a.default.instance.gameState = 4;
cc.director.getPhysicsManager().enabled = !1;
}
};
e.prototype.onResume = function() {};
e.prototype.phoneShack = function() {
a.default.instance.isShack && this.callJava("phoneShack", "()V");
};
e.prototype.phoneLongShack = function() {
a.default.instance.isShack && this.callJava("longPhoneShack", "()V");
};
...
for (var n, o, a = [], r = 2; r < arguments.length; r++) a[r - 2] = arguments[r];
var l = this.getClassName(e);
e = this.getmethodName(e);
if ("" === l) return "";
if (cc.sys.isNative) {
if (jsb) {
if (cc.sys.os === cc.sys.OS_ANDROID) return (n = jsb.reflection).callStaticMethod.apply(n, i([ l, e, t ], a));
cc.sys.os === cc.sys.OS_IOS && cc.error.apply(cc, i([ l, e ], a));
return (o = jsb.reflection).callStaticMethod.apply(o, i([ l, e ], a));
}
...
var o = e("../../code/Lib/Global"), i = function() {
function e(e) {
this.table = e;
}
...
for (var n = 0; n < this.table.length; n++) {
var o = this.table[n];
if (o && o.cannons_id && o.id == e) for (var i = o.cannons_id.split(";"), a = i.length, r = 0; r < a; r++) {
var l = i[r];
...
var a = e("../../code/basecode/BasePanel"), r = e("../../code/manager/UiAniManager"), l = e("../../code/manager/SoundManager"), s = e("../../code/basecode/CheckBox"), c = e("../../code/Lib/LocalStorage"), u = e("../../code/manager/MyRoleDataManager"), d = e("../../code/manager/PanelManager"), p = e("../../code/Config/Config"), f = cc._decorator, h = f.ccclass, g = f.property, y = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
...
i([ g(cc.Toggle) ], t.prototype, "backSoundToggle", void 0);
i([ g(cc.Toggle) ], t.prototype, "effectSoundToggle", void 0);
i([ g(cc.Toggle) ], t.prototype, "shackToggle", void 0);
i([ g(cc.Button) ], t.prototype, "leftButon", void 0);
i([ g(cc.Button) ], t.prototype, "rightButon", void 0);
i([ g(cc.Button) ], t.prototype, "closeBtn", void 0);
i([ g(cc.PageView) ], t.prototype, "languesPage", void 0);
i([ g(cc.Node) ], t.prototype, "languesLabel", void 0);
...
var a = e("../../../code/manager/SDKManager"), r = e("../../../code/Lib/Secret"), l = e("../../../code/Config/Config"), s = e("../../../code/manager/PanelManager"), c = e("../../../code/manager/TableManager"), u = e("../../../code/manager/MyRoleDataManager"), d = e("../../../code/Lib/LocalStorage"), p = e("../../../code/manager/EffectManager"), f = e("../../../code/Lib/Global"), h = cc._decorator, g = h.ccclass, y = h.property, m = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.buyBtn = null;
...
if (-1 == a.default.instance.getNetState()) return;
if (a.default.instance.checkUnConsumedGoods()) {
a.default.instance.reConsumeGood();
return;
}
s.default.instance.getExistPanel(l.PanelName.ShopPanel).curItem = this;
a.default.instance.callJava("trackPay", "(Ljava/lang/String;Ljava/lang/String;)V", "startPay", this.payId.toString());
r.default.setKeyValue("Buy");
a.default.instance.startPay(this.payId);
}
};
...
t.widgetNode1 = null;
t.itemScriptArr = [];
t._aniType = a.UiAniType.ShopPanel;
t.isInit = !1;
return t;
}
t.prototype.start = function() {
...
if (!this.isInit) {
this.isInit = !0;
for (var t = s.default.instance.shopTable.table, n = function(n, i) {
var a = t[n];
if (a) {
var r;
0 == a.type || 1 == a.type ? o.scheduleOnce(function() {
r = m.default.instance.pop(e.giftPrefab.name);
e.scroll.content.addChild(r);
r.getComponent(y.default).init(a.id);
r.getComponent(y.default).setLable();
e.itemScriptArr.push(r.getComponent(y.default));
}, .1 * n) : 2 == a.type || 3 == a.type ? o.scheduleOnce(function() {
r = m.default.instance.pop(e.shopPrefab.name);
e.scroll.content.addChild(r);
r.getComponent(g.default).init(a.id);
r.getComponent(g.default).setLable();
e.itemScriptArr.push(r.getComponent(g.default));
}, .1 * n) : 4 == a.type && p.default.instance.isHaveDiscount() && o.scheduleOnce(function() {
r = m.default.instance.pop(e.giftPrefab.name);
...
}, o = this, i = 0, a = t.length; i < a; i++) n(i);
}
};
t.prototype.openPanel = function(e) {
...
for (var n = s.default.instance.shopTable.getreward(Number(e)), o = n.length, i = 0; i < o; i++) p.default.instance.addCurrency(n[i][1], n[i][0]);
var a = s.default.instance.shopTable.getIncome(Number(e));
0 != a && (p.default.instance.allGoldMore = (1 == p.default.instance.allGoldMore ? 0 : p.default.instance.allGoldMore) + a);
...
var o = e("../../code/manager/TableManager"), i = function() {
function e(e) {
this.table = e;
}
e.prototype.getData = function(e) {
...
var i = this.table[n];
if (i && e == i.id) {
0 != Number(i.coins) && t.push([ 51e4, Math.ceil(.001 * Number(i.coins) * o.default.instance.connonTable.getBestTenUpgradeMoney()) ]);
0 != Number(i.gems) && t.push([ 510001, Number(i.gems) ]);
0 != Number(i.chips) && t.push([ 510002, Number(i.chips) ]);
break;
}
}
return t;
...
this.playerScript.init(a.default.instance.curCannonID);
this.playerScript.setConnonSkin(a.default.instance.curCannonID);
this.playerScript.setBullet();
this.playerScript.showType = !0;
this.playerScript.startShoot();
0 == e && this.playerScript.funnelShow(a.default.instance.getRandomFunnel());
};
...
i([ s(cc.Node) ], t.prototype, "connonNode", void 0);
return t = i([ l ], t);
}(cc.Component);
n.default = c;
cc._RF.pop();
...
var a = e("../../../code/manager/MyRoleDataManager"), r = e("../../../code/manager/TableManager"), l = e("../../../code/Lib/LocalStorage"), s = e("../../../code/manager/PanelManager"), c = e("../../../code/Config/Config"), u = e("../../../code/manager/SDKManager"), d = e("../../../code/manager/Advert_Manager"), p = e("../../../code/manager/Umeng_Manager"), f = cc._decorator, h = f.ccclass, g = f.property, y = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
...
if (a.default.instance.getSkin(this.skinId)) {
this.conditionNode.active = !1;
this.isUnlock = !0;
if (this.skinId == a.default.instance.curSkinID) {
this.click();
return this.index;
}
} else {
...
a.default.instance.addSkin(this.skinId);
this.isUnlock = !0;
this.conditionNode.active = !1;
this.click();
};
t.prototype.click = function() {
if (this.isUnlock) {
a.default.instance.curSkinID = this.skinId;
...
a.default.instance.addAdsTime(this.skinId, 1) >= t ? this.unlock() : this.setConditionShow(1, t);
}.bind(this), function() {}.bind(this));
} else if (2 == this.unlockType) {
var e = r.default.instance.skinTable.getQuantity(this.skinId);
if (a.default.instance.dleCurrency(Number(e), c.CurrencyType.Diamond)) {
...
var o = a.default.instance.addAdsTime(this.skinId, 0);
this.scheduleOnce(function() {
...
} else if (3 == e) if (a.default.instance.curLevel >= t) {
a.default.instance.addSkin(this.skinId);
this.isUnlock = !0;
this.conditionNode.active = !1;
} else {
...
var i = this.itemArr[o].getComponent(u.default).init(d.default.instance.skinTable.table[o]);
i && (n = i);
}
...
var i = this.itemArr[o].getComponent(u.default);
if (i.skinId == Number(t)) {
i.unlock();
return;
}
}
...
var a = e("../../code/manager/BallManager"), r = cc._decorator, l = r.ccclass, s = (r.property, 
function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
...
t.prototype.isCollided = function() {
var e = a.default.instance.curBallArr;
for (var t in e) {
var n = a.default.instance.curBallArr[t];
...
var a = e("../../code/manager/NodePoolMananger"), r = e("../../code/manager/PanelManager"), l = cc._decorator, s = l.ccclass, c = l.property, u = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.ani = null;
...
this.node.active = !1;
this.node.removeFromParent();
a.default.instance.push(this.node);
};
i([ c(cc.Animation) ], t.prototype, "ani", void 0);
return t = i([ s ], t);
}(cc.Component);
n.default = u;
cc._RF.pop();
...
if (t) return n;
for (var o = n.length, i = 0; i < o; i++) if (n[i].length < 1) {
n.splice(i, 1);
i--;
o = n.length;
...
if (!e) return "";
if (e.length < 1) return "";
for (var t = (e = ";" == e.charAt(e.length - 1) ? e.substr(0, e.length - 1) : e).split(";"), n = {}, o = [], i = 0; i < t.length; i++) {
var a = t[i];
n[a] || (n[a] = 0);
n[a]++;
}
...
for (var n = e.instance.strToArr2(t), o = {}, i = [], a = 0; a < n.length; a++) {
var r = n[a].id;
o[r] ? o[r] += n[a].num : o[r] = n[a].num;
}
for (var l in o) i.push([ l, o[l] ]);
return i;
};
e.prototype.strToArr2 = function(e, t) {
void 0 === t && (t = !1);
if (!e) return [];
for (var n = (e = ";" == e.charAt(e.length - 1) ? e.substr(0, e.length - 1) : e).split(";"), o = [], i = n.length, a = 0; a < i; a++) if (n[a].length > 2) {
var r = n[a].split(":");
if (t) {
l = new Object({
id: Number(r[0]),
...
if (!e) return [];
for (var t = (e = ";" == e.charAt(e.length - 1) ? e.substr(0, e.length - 1) : e).split(";"), n = [], o = t.length, i = 0; i < o; i++) if (t[i].length > 2) {
var a = t[i].split(":"), r = [ Number(a[0]), Number(a[1]) ];
n.push(r);
}
return n;
};
...
if (!e) return [];
for (var t = (e = ";" == e.charAt(e.length - 1) ? e.substr(0, e.length - 1) : e).split(";"), n = [], o = t.length, i = 0; i < o; i++) if (t[i].length > 2) {
var a = t[i].split(":"), r = [ Number(a[0]), Number(a[1]), Number(a[2]) ];
n.push(r);
}
return n;
};
...
if (!e) return [];
for (var t = (e = ";" == e.charAt(e.length - 1) ? e.substr(0, e.length - 1) : e).split(";"), n = [], o = t.length, i = 0; i < o; i++) if (t[i].length > 2) {
for (var a = t[i].split(":"), r = a.length, l = [], s = 0; s < r; s++) l.push(Number(a[s]));
n.push(l);
}
return n;
};
...
void 0 === n && (n = ";");
if (!e) return [];
for (var o = (e = e.charAt(e.length - 1) == n ? e.substr(0, e.length - 1) : e).split(n), i = [], a = o.length, r = 0; r < a; r++) if (o[r].length > 2) {
...
var a = e("./ConnonBase"), r = e("../../code/manager/MyRoleDataManager"), l = e("../../code/manager/SoundManager"), s = e("../../code/manager/NodePoolMananger"), c = e("../../code/Lib/Global"), u = e("../../code/manager/TableManager"), d = e("../../code/manager/PanelManager"), p = e("../../code/Lib/LocalStorage"), f = cc._decorator, h = f.ccclass, g = (f.property, 
function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
...
this.setBulletPos(o, 10 * Math.floor((e - 1) / 2) + n, -1);
for (var i = 1; i < e; i++) {
this.setBulletPos(o + 10 * i, 10 * (Math.floor((e - 1) / 2) - i), 1);
this.setBulletPos(o + 10 * i, 10 * (Math.floor((e - 1) / 2) - i), -1);
}
} else for (t = 13, n = -5, o = 10 * -(Math.floor((e - 1) / 2) + 1) + t, i = 0; i < e; i++) {
this.setBulletPos(o + 10 * i + 5, 10 * (Math.floor((e - 1) / 2) + 1 - i) + n, 1);
this.setBulletPos(o + 10 * i + 5, 10 * (Math.floor((e - 1) / 2) + 1 - i) + n, -1);
}
}
};
...
o.active = !0;
var i = c.default.exactSub(this.bulletHit, Math.floor(this.bulletHit));
this.lessHit = c.default.exactAdd([ this.lessHit, i ]);
if (this.lessHit >= 1) {
...
this.scenceTable = new i.default(this.table.scence);
this.connonTable = new a.default(this.table.connon);
...
var a = e("./CircleLifeProgressBar"), r = cc._decorator, l = r.ccclass, s = r.property, c = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.progressBar = null;
...
i([ s(a.default) ], t.prototype, "progressBar", void 0);
return t = i([ l ], t);
}(cc.Component);
n.default = c;
cc._RF.pop();
...
var a = e("./code/Lib/LocalStorage"), r = cc._decorator, l = r.ccclass, s = (r.property, 
function(e) {
o(t, e);
function t() {
return null !== e && e.apply(this, arguments) || this;
...
for (var n = 0, o = this.pool[e], i = o.length, a = 0; a < i; a++) {
var r = o[a];
n += r[1] - r[0];
}
...
var i = e("./SDKManager"), a = cc._decorator, r = a.ccclass, l = (a.property, function() {
function e() {}
t = e;
Object.defineProperty(e, "instance", {
get: function() {
...
i.default.instance.callJava("onEvent", "(Ljava/lang/String;)V", e);
};
e.prototype.putPointlevel = function(e, t, n, o, a) {
i.default.instance.callJava("onEventObject", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V", e, t.toString(), n.toString(), o.toString(), a.toString());
};
e.prototype.putPoint2 = function(e, t) {
i.default.instance.callJava("onEventValue", "(Ljava/lang/String;Ljava/lang/String;)V", e, t);
};
e.prototype.putPoint_startLevel = function(e) {
i.default.instance.callJava("startLevel", "(Ljava/lang/String;)V", "level_" + e);
};
e.prototype.putPoint_finishLevel = function(e) {
i.default.instance.callJava("finishLevel", "(Ljava/lang/String;)V", "level_" + e);
};
e.prototype.putPoint_failLevel = function(e) {
i.default.instance.callJava("failLevel", "(Ljava/lang/String;)V", "level_" + e);
};
var t;
return e = t = o([ r ], e);
}());
...
var a = e("../../../code/basecode/BasePanel"), r = e("../../../code/manager/UiAniManager"), l = e("../../../code/manager/PanelManager"), s = e("../../../code/Config/Config"), c = e("../../../code/ads/AdsGroupPlatformTool"), u = e("../../../code/manager/SDKManager"), d = cc._decorator, p = d.ccclass, f = d.property, h = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.videoPlayer = null;
...
this.level = a.default.instance.getPropLevel(this.propId);
if (a.default.instance.curLevel >= e.unlock) {
this.isUnlock = !0;
this.levelNode.active = !0;
...
a.default.instance.propLevelUp(this.obj);
r.default.gameUi.updataGold();
this.updateInfo();
...
var a = e("../../../code/manager/UiAniManager"), r = e("../../../code/manager/PanelManager"), l = e("../../../code/Config/Config"), s = e("../../../code/manager/TableManager"), c = e("../../../code/manager/SoundManager"), u = e("./WorkItem"), d = e("../../../code/manager/NodePoolMananger"), p = e("../../../code/basecode/BasePanel"), f = cc._decorator, h = f.ccclass, g = f.property, y = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.nameLable = null;
...
t.showNode = null;
t.itemArr = [];
t._aniType = a.UiAniType.AircraftPanel;
return t;
}
t.prototype.onLoad = function() {
...
var o = e[n];
if (o) {
var i = cc.instantiate(this.workPrefab);
i.setScale(1.5, 1.5);
this.itemNode.addChild(i);
i.setPosition(0, -300, 0);
var a = i.getComponent(u.default);
a.init(o.id, this.iconAtlas.getSpriteFrame(o.icon), e);
this.itemArr.push(a);
}
}
};
...
}, i = this, a = 0; a < n; a++) o(a); else {
var r = this.itemNode.children.length;
for (a = 0; a < r; a++) this.itemNode.children[a].active = !1;
}
};
t.prototype.openPanel = function() {
this.addEvent();
...
function i(e, t, n) {
var i, a;
return null != n && e ? i = o((a = e.split(u))[r(t, n)] || a[0]) : i = e, i;
}
function a(e) {
var t = n(p);
return t[e] || t.en;
...
o = e), "string" == typeof n && (t = c(t), o = l(o = i(n, this.currentLocale, t.smart_count), t)), 
o;
...
i([ l(cc.Animation) ], t.prototype, "ani", void 0);
return t = i([ r ], t);
}(cc.Component);
n.default = s;
cc._RF.pop();
...
i([ l(cc.Node) ], t.prototype, "tishi", void 0);
return t = i([ r ], t);
}(cc.Component);
n.default = s;
cc._RF.pop();

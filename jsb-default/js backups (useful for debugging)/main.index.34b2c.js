...
n.Adver_Type = void 0;
var i, r = e("./SDKManager"), l = e("./PanelManager"), s = e("../Lib/LocalStorage"), c = e("./Umeng_Manager"), u = cc._decorator, d = u.ccclass, p = (u.property, 
function(e) {
o(t, e);
function t() {
...
t.isskip = !1;
t.MaskCallBack = null;
t.istaiwan = "tw" == s.default.getItem("language", "zh");
return t;
}
n = t;
Object.defineProperty(t, "instance", {
...
void 0 === n && (n = null);
void 0 === o && (o = 15);
if (this.istaiwan) t(); else if (cc.sys.os === cc.sys.OS_ANDROID || cc.sys.os === cc.sys.OS_IOS) {
c.default.instance.putPoint(c.Point_EventID.advert_Click_num);
this.MaskCallBack = n;
...
c.default.instance.putPoint(c.Point_EventID.advert_play_num);
break;
...
c.default.instance.putPoint(c.Point_EventID.advert_Click_Fail_num);
break;

case "onVideoAdClose":
this.VideoCallBack(e);
c.default.instance.putPoint(c.Point_EventID.advert_Click_Succ_num);
}
};
var n;
return t = n = a([ d ], t);
...
h.default.instance.checkCanGuide(10001, 1) && h.default.instance.startGuide(10001);
this.updateInfo();
};
...
e.scheduleOnce(function() {
h.default.instance.checkCanGuide(10001, 2) && h.default.instance.startGuide(10001);
}, 4);
}, 4);
}));
...
if (!(o <= 0)) {
var l = c.default.instance.connonTable.getBestTenUpgradeMoney();
...
var l = e("../../code/basecode/EasyGetCompleteClass"), s = e("../../code/manager/NodePoolMananger"), c = e("../../code/manager/BallManager"), u = e("../../code/manager/MissionManger"), d = e("../../code/manager/PanelManager"), p = e("../../code/manager/MyRoleDataManager"), f = e("../../code/manager/SDKManager"), h = e("../../code/manager/SoundManager"), g = e("../../code/Lib/Global"), y = e("../../code/manager/EffectManager"), m = e("../game/Game"), b = e("../../../Prefab/CircleLifeProgressBar/CircleLifeProgressBar"), v = cc._decorator, S = v.ccclass, _ = v.property, P = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.jumpHeight = 0;
...
cc.tween(this.iconProgressBar).to(.3, {
progress: this.curLife / this.totalLife
}).start();
this.iconProgressBar2.setProgress(this.curLife / this.totalLife);
if (this.curLife <= 0) {
this.isInit = !1;
...
a([ _(cc.Integer) ], t.prototype, "jumpHeight", void 0);
a([ _(cc.Integer) ], t.prototype, "size", void 0);
a([ _(cc.Sprite) ], t.prototype, "icon", void 0);
a([ _(cc.Sprite) ], t.prototype, "icon_up", void 0);
a([ _(cc.Node) ], t.prototype, "myLable", void 0);
a([ _(cc.Float) ], t.prototype, "radius", void 0);
a([ _(cc.Node) ], t.prototype, "quan", void 0);
a([ _(b.default) ], t.prototype, "iconProgressBar2", void 0);
return t = a([ S ], t);
}(l.default);
n.default = P;
cc._RF.pop();
...
t.prototype.setPicture = function(e, t, n, o, a) {
void 0 === a && (a = !1);
this.Times = t;
...
a([ l(cc.Mask) ], t.prototype, "mask", void 0);
a([ l(cc.Sprite) ], t.prototype, "life_bar", void 0);
return t = a([ r ], t);
}(cc.Component);
n.default = s;
cc._RF.pop();
...
e.prototype.getRewardPrice = function(e) {
e > 10 * this.table.length && (e = 10 * this.table.length);
var t = Math.floor(e / 10) + 301e3, n = this.getDataById(t);
...
var e, t = Number(c.default.instance.curScore), n = Number(h.default.getItem("endlessMaxScore")), o = d.default.instance.connonTable.getBestTenUpgradeMoney();
n <= 0 || t >= n ? e = Math.floor(.5 * o) : t < .5 * n ? e = Math.floor(.2 * o) : t >= .5 * n && t < n && (e = Math.floor(o * t / n * .4));
...
if (s.default.instance.curLevel <= 0) {
...
this.btnTishi();
this.schedule(function() {
if (s.default.instance.curLevel > 15) if (y.default.instance.checkCanGuide(10003, 0) || y.default.instance.checkCanGuide(10003, 1) || !y.default.instance.getEndlessState(10003)) {
s.default.instance.gameState = 8;
this.endlessBtn.interactable = !0;
this.endlessBtn.node.opacity = 255;
y.default.instance.startGuide(10003);
} else s.default.instance.gameState = 0; else s.default.instance.gameState = 0;
if (s.default.instance.isFromComplete) {
s.default.instance.isFromComplete = !1;
if (6 == s.default.instance.curLevel) if (y.default.instance.checkCanGuide(10001, 0) || y.default.instance.checkCanGuide(10001, 1) || y.default.instance.checkCanGuide(10001, 2) || !y.default.instance.getEndlessState(10001)) {
s.default.instance.gameState = 8;
...
if (11 == s.default.instance.curLevel) if (y.default.instance.checkCanGuide(10002, 0) || !y.default.instance.getEndlessState(10002)) {
s.default.instance.gameState = 8;
...
if (8 != s.default.instance.gameType) {
this.HurdleIsOpen && this.OpenCloseHurdle();
...
a([ O([ cc.Animation ]) ], t.prototype, "uiInAni", void 0);
a([ O([ cc.Animation ]) ], t.prototype, "uiOutAni", void 0);
a([ O(cc.Animation) ], t.prototype, "handMoveAni", void 0);
a([ O(cc.Node) ], t.prototype, "scoreLable", void 0);
a([ O(cc.Label) ], t.prototype, "startLab", void 0);
a([ O(cc.Sprite) ], t.prototype, "handSprite", void 0);
a([ O(cc.Node) ], t.prototype, "levelCompleteNode", void 0);
a([ O(cc.Sprite) ], t.prototype, "backGroud", void 0);
a([ O(cc.Label) ], t.prototype, "maxScoreLable", void 0);
a([ O({
type: cc.Label,
tooltip: "游戏币lable"
}) ], t.prototype, "goldLable", void 0);
...
a([ O(cc.Animation) ], t.prototype, "goldLableAni", void 0);
a([ O(cc.Sprite) ], t.prototype, "goldImg", void 0);
a([ O(cc.Animation) ], t.prototype, "backgroundShackAni", void 0);
a([ O(cc.Animation) ], t.prototype, "blackAni", void 0);
a([ O(cc.Node) ], t.prototype, "middleNode", void 0);
a([ O([ cc.Prefab ]) ], t.prototype, "effectPrefabArr", void 0);
a([ O(cc.Node) ], t.prototype, "effectNode", void 0);
a([ O(cc.Layout) ], t.prototype, "goldLayout", void 0);
a([ O({
type: cc.Label,
tooltip: "游戏币lable"
...
a([ O(cc.SpriteFrame) ], t.prototype, "singleColor", void 0);
a([ O(cc.Node) ], t.prototype, "maskNode", void 0);
a([ O(cc.Label) ], t.prototype, "curLevel", void 0);
a([ O(cc.Label) ], t.prototype, "nextLevel", void 0);
a([ O(cc.ProgressBar) ], t.prototype, "pro", void 0);
a([ O({
type: cc.Node,
tooltip: "进度条节点"
}) ], t.prototype, "proNode", void 0);
a([ O(cc.Node) ], t.prototype, "maxscoreLayout", void 0);
a([ O(cc.Label) ], t.prototype, "levelLable", void 0);
a([ O({
type: cc.Button,
tooltip: "设置按钮"
...
a([ O([ cc.Node ]) ], t.prototype, "uiInNodes", void 0);
a([ O(cc.Button) ], t.prototype, "openLeftSideHurdle", void 0);
a([ O(A.default) ], t.prototype, "EndlessManager", void 0);
a([ O({
type: cc.Button,
tooltip: "强化技能按钮"
...
a([ O(cc.Label) ], t.prototype, "proTxt", void 0);
a([ O(N.default) ], t.prototype, "OfflineEarnings", void 0);
a([ O({
type: [ cc.SpriteFrame ],
tooltip: "buff icon资源"
...
if (d.default.gameUi.HurdleIsOpen) d.default.gameUi.OpenCloseHurdle(); else if (this.touchId == e.getID()) if (-1 != this.lastMoveX) {
...
this.guideStep++;
var t = i.default.instance.getExistPanel(r.PanelName.RefitShopPanel);
t.setCurrentPage(1);
...
void 0 === t && (t = r.CurrencyType.Gold);
d.default.gameUi.OffLineSkill.switchCalculate(e);
d.default.gameUi.intensifySkill.switchCalculate(e);
...
t.prototype.switchCalculate = function(e) {
void 0 === e && (e = 0);
var t, n, o = Number(this.offLineLevel);
if (this.isOffLineSkill) {
t = s.default.instance.OffLineTable.getRewardPrice(Number(o));
n = s.default.instance.OffLineTable.getRewardPrice_up(Number(o));
var a = Math.floor(o / 10 - .005);
this.nowUpgradeGold = t + n * (o - 10 * a);
} else {
t = s.default.instance.cannonGrowUp.getRewardPrice(Number(o));
n = s.default.instance.cannonGrowUp.getRewardPrice_up(Number(o));
a = Math.floor(o / 10 - .005);
this.nowUpgradeGold = t + n * (o - 10 * a);
}
if (r.default.instance.Gold + e > this.nowUpgradeGold) {
this.tishi.active = !0;
...
i.default.saveItem(this.offOvBuffName, this.offLineLevel);
this.LevelValue.string = "等级." + this.offLineLevel;
this.switchCalculate();
}.bind(this));
};
...
i.default.saveItem("isNowGuidAccomplish", "1");
i.default.saveItem("EndlessIsRunOutOf", "6");
i.default.saveItem("Endless", "3");
...
this.node.active = !1;
if (l.default.instance.curLevel >= 0 && (h.default.instance.checkCanGuide(10003, 0) || h.default.instance.checkCanGuide(10003, 1) || !h.default.instance.getEndlessState(10003))) {
...
n += d.default.instance.OffLineTable.getRewardPrice(Number(o)) + d.default.instance.OffLineTable.getRewardPrice_up(Number(o)) * (o - 10 * Math.floor(o / 10 - .005));
}
...
t / 60 > 8 && (t = 480);
return Math.floor((n * i / 1e3 + a * e) * t / 60);
};
a([ m({
type: cc.Label,
tooltip: "金币显示Label"
...
g.default.instance.addBuffShow(500004, 8, this.BuffPrefab, c.default.gameUi.buffIconAtlas[this.propId - 5e5], GlobalFun.i18n.t("lable.10264"));
...
var u = c.getChildByName("mb").getComponent(cc.Sprite);
u.spriteFrame = t > 3 ? this.paoMengMan[3] : this.paoMengMan[t];
r.default.instance.checkConnonUnlocked(Number(n.id)) ? u.node.opacity = 0 : u.node.opacity = 255;
...
this.setLabelString[7].string = GlobalFun.i18n.t("lable.10291");
...
this.connonGroup[this.chooseConnonID].getChildByName("mb").opacity = 0;
...
this.connonGroup[this.chooseConnonID].getChildByName("mb").opacity = 255;
this.condition.active = !1;
this.consume.active = !1;
...
if (r.default.instance.curLevel >= a) {
this.condition.active = !1;
...
if (r.default.instance.curLevel >= e) {
...
this.NotUnlockHint.getComponentInChildren(cc.Label).string = GlobalFun.i18n.t("lable.10296");
cc.tween(this.NotUnlockHint).to(1, {
opacity: 255
}).to(1, {
opacity: 0
...
if (r.default.instance.curLevel >= e) m.default.instance.show_Ad(m.Adver_Type.ReWardVideo_Adv, function(e) {
r.default.instance.addConnon(this.chooseConnonID);
this.showButton(this.ButtonS[0]);
d.default.gameUi.HaveUnlock.isHaveUnlock();
this.connonGroup[this.chooseConnonID].getChildByName("mb").opacity = 0;
...
s.default.instance.cannonUnlock.getMap(this.chooseConnonID, !0);
this.NotUnlockHint.getComponentInChildren(cc.Label).string = GlobalFun.i18n.t("lable.10296");
cc.tween(this.NotUnlockHint).to(1, {
opacity: 255
}).to(1, {
...
t.prototype.setLable = function() {
this.resurgenceLable.getComponentInChildren(cc.Label).string = GlobalFun.i18n.t("lable.10183");
...
default:
return "";
} else if (cc.sys.os === cc.sys.OS_IOS) return "";
};
...
this.scheduleOnce(function() {
h.default.instance.checkCanGuide(10003, 1) && h.default.instance.startGuide(10003);
}, 1);
this.playUIAni(r.InOrOut.IN);
this.setLable();
this.addEvent();

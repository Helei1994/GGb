window.__require = function e(i, n, t) {
function o(r, d) {
if (!n[r]) {
if (!i[r]) {
var s = r.split("/");
...
languageText: [ function(e, i, n) {
"use strict";
cc._RF.push(i, "a5aaeP4ECVGNL25gVXLyvrv", "languageText");
...
ja: "お会いできてうれしいです。何かお手伝いすることがありますか？",
ko: "안녕! 무슨 도움이 필요해?"
}, {
id: "10099",
cn: "暴风雨",
...
id: "10115",
cn: "帮我找到那些螺丝钉，我会给你意想不到的好处！",
tw: "幫我找到那些螺絲釘，我會給你意想不到的好處！",
...
ja: "そのボルトを見つけてもらったら、思い掛けない褒美を与えるよ",
...
ja: "暗いワークショップの中に灯りがあるように願っている",
ko: "어두운 작업실에 더 많은 불빛이 있어야 해."
}, {
id: "10117",
cn: "有灯光的照耀，才是我喜欢的工作方式！",
tw: "有燈光的照耀，才是我喜歡的工作方式！",
...
ja: "バッテリーを捨ててはいけない、環境汚染になる",
ko: "배터리는 환경을 오염시키니 함부로 내버리지 말고."
}, {
id: "10121",
cn: "共同保护环境，不要乱扔电池污染环境！",
tw: "共同保護環境，不要亂扔電池污染環境！",
...
ja: "共に環境を守ろう、バッテリーを捨て環境を汚染してはいけない",
...
ja: "ヘイ！週末一杯どうですか？",
ko: "여보게! 주말에 나가서 한잔 할까?"
}, {
id: "10123",
cn: "啤酒、音乐和好玩的游戏，还有什么比这更快乐？",
tw: "啤酒、音樂和好玩的遊戲，還有什麼比這更快樂？",
...
id: "10202",
cn: "足够的芯片开启下一个飞行器，而且还有大量硬币可以用！",
tw: "足夠的晶片開啟下一個飛行器，而且還有大量硬幣可以用！",
...
id: "10217",
cn: "你已经有足够的芯片可以开启下一个无人机宝箱！",
tw: "你已經有足夠的晶片可以開啟下一個無人機寶箱！",
...
id: "10256",
cn: "更多硬币，更多宝石，更多芯片，让您度过一个愉快的圣诞节。",
tw: "更多硬幣，更多寶石，更多晶片，讓您度過一個愉快的耶誕節。",
...
ja: "より多くの硬貨、より多くの宝石、より多くの破片は、幸せなクリスマスを過すことを許可した。",

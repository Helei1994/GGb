...
n.Adver_Type = void 0;
var a, i = e("./SDKManager"), r = e("./PanelManager"), l = cc._decorator, s = l.ccclass, c = (l.property, 
function() {
function e() {
this.current_advert_type = a.ReWardVideo_Adv;
...
e.prototype.getCurrentAdvType = function() {
return this.current_advert_type;
};
e.prototype.get_isskip = function() {
...
e.prototype.show_Ad = function(e, t, n) {
...
i.default.instance.callJava("showAdvert", "(Ljava/lang/String;)V", this.current_advert_type);
};
e.prototype.videocallback = function(e) {
cc.error("视频回调：" + e);
switch (e) {
...
case "onVideoAdError":
r.default.gameUi.showTishi(GlobalFun.i18n.t("lable.10251"));
r.default.gameUi.openMask();
break;

case "onVideoAdClose":
this.VideoCallBack && !this.get_isskip() && this.VideoCallBack(e);
}
};
var t;
return e = t = o([ s ], e);
...
var i = e("../../../code/manager/MyRoleDataManager"), r = e("../../../code/manager/PanelManager"), l = e("../../../code/Lib/Global"), s = e("../../../code/manager/TableManager"), c = e("../../../code/Config/Config"), u = e("../../../code/manager/SoundManager"), d = e("../LatticeProgress"), p = cc._decorator, f = p.ccclass, h = p.property, g = function(e) {
o(t, e);
function t() {
...
i.init(o.id, this.iconAtlas.getSpriteFrame(o.icon));
this.itemArr.push(i);
}
}
};
...
h.default.instance.checkCanGuide(10002, 1) && h.default.instance.startGuide(10002);
this.updateInfo();
};
...
var e = this, t = c.default.instance.aircraftTable.getRondam();
...
this.itemArr[n].init(this.randomId, this.iconAtlas.getSpriteFrame(c.default.instance.aircraftTable.getSource(this.randomId)));
break;
}
...
this.goldNumArr = [];
var l = s.default.Random(1, 2);
r.default.game.isGameComplete() && (l = 5);
1 == i.default.instance.gameType && (l = 0);
for (var c = 0; c < l; c++) {
var p = a.default.instance.pop("coinPrefab");
p && !p.parent && this.physicsNode.addChild(p);
p.active = !0;
p.x = t;
p.y = n;
p.ECScript.init(Math.floor(o / l));
p.ECScript.toTop();
}
var f = d.default.instance.curSpecilMission;
if (f && 1 != i.default.instance.gameType && !f.isCompleteAll && s.default.Random(0, 100) <= 10 && f.pro < f.quest) {
var h = a.default.instance.pop("propPrefab"), g = f.collectPropId;
this.physicsNode.addChild(h);
var y = h.getComponent(u.default);
h.x = t;
h.y = n;
y.init(g, this.BuffPrefab, this.icons);
y.toTop();
}
...
if (1 == i.default.instance.gameType) return !1;
...
var l = e("../../code/basecode/EasyGetCompleteClass"), s = e("../../code/manager/NodePoolMananger"), c = e("../../code/manager/BallManager"), u = e("../../code/manager/MissionManger"), d = e("../../code/manager/PanelManager"), p = e("../../code/manager/MyRoleDataManager"), f = e("../../code/manager/SDKManager"), h = e("../../code/manager/SoundManager"), g = e("../../code/Lib/Global"), y = e("../../code/manager/EffectManager"), m = e("../game/Game"), b = cc._decorator, v = b.ccclass, S = b.property, P = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.jumpHeight = 0;
...
t.exp_Colors = [ [ 148, 100, 243 ], [ 248, 229, 17 ], [ 6, 175, 181 ], [ 249, 182, 43 ] ];
t.c_index = 0;
...
this.setStartColor2();
this.myLable.active = !1;
if (2 != d.default.gameUi.exp_type && 0 != d.default.gameUi.exp_type) {
this.icon.spriteFrame = d.default.game.ballSpriteAtlas.getSpriteFrame(this.expression_1[Math.floor(Math.random() * this.expression_1.length)]);
...
t.prototype.killlifeNum = function(e) {
if (this.isInit) {
...
this.frozenEffect.width = this.frozenEffect.height = 2 * this.radius / 300 * 320;
return [ 2 ];
}
});
});
...
a([ S(cc.Integer) ], t.prototype, "jumpHeight", void 0);
a([ S(cc.Integer) ], t.prototype, "size", void 0);
a([ S(cc.Sprite) ], t.prototype, "icon", void 0);
a([ S(cc.Sprite) ], t.prototype, "icon_up", void 0);
a([ S(cc.Node) ], t.prototype, "myLable", void 0);
a([ S(Number) ], t.prototype, "radius", void 0);
return t = a([ v ], t);
}(l.default);
n.default = P;
cc._RF.pop();
...
var i = e("./BuffManager"), r = cc._decorator, l = r.ccclass, s = r.property, c = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.buffHint = null;
...
t.prototype.setPicture = function(e, t, n, o) {
this.Times = t;
this.buffID = n;
this.shade.node.anchorY = .5;
this.currentTime = 0;
this.buffHint.spriteFrame = e;
this.basement.spriteFrame = e;
this.shade.spriteFrame = e;
this.Describe.string = o;
this.callback = function() {
this.shade.node.anchorY = this.currentTime / this.Times + .5;
...
a([ s(cc.Sprite) ], t.prototype, "buffHint", void 0);
a([ s(cc.Sprite) ], t.prototype, "basement", void 0);
a([ s(cc.Mask) ], t.prototype, "shade", void 0);
a([ s(cc.Label) ], t.prototype, "Describe", void 0);
return t = a([ l ], t);
}(cc.Component);
n.default = c;
cc._RF.pop();
...
var o = e("./BuffHint"), a = e("./code/manager/TableManager"), i = e("./src/game/GameUI"), r = function() {
function e() {
this.gobj = {};
}
Object.defineProperty(e, "instance", {
...
e.prototype.addBuffShow = function(t, n, i, r, l) {
if (this.gobj[t]) this.gobj[t].updateTime(n); else {
var s = cc.instantiate(i);
e.GameUILiving.buffShow.addChild(s);
s.setPosition(0, 0);
var c = r.getSpriteFrame(a.default.instance.propTable.getIcon(t)), u = s.getComponent(o.default);
this.gobj[t] = u;
u.setPicture(c, n, t, l);
}
};
return e;
}();
...
var i = e("./BulletBase"), r = e("../../code/manager/PanelManager"), l = e("../../code/manager/BallManager"), s = e("../../code/manager/MyRoleDataManager"), c = cc._decorator, u = c.ccclass, d = c.property, p = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.attackImg = null;
...
var s = i.radius - Math.sqrt(Math.pow(i.radius, 2) - Math.pow(i.node.x - this.node.x, 2)), c = i.node.y - this.node.y - .5 * i.node.height + s;
c = c <= 0 ? 0 : c;
if (Math.min(c, o) == c) {
o = c;
n = i;
...
t.prototype.setIcon = function(e) {};
a([ d(cc.Sprite) ], t.prototype, "attackImg", void 0);
return t = a([ u ], t);
}(i.default);
n.default = p;
cc._RF.pop();
...
for (var t = 20 * Math.floor(e / 10) + 901e3, n = 0; n < this.table.length; n++) {
var o = this.table[n];
...
this.xiaYiGuan.node.active = !1;
var t = 0;
t = Number(this.curLevel.string) >= 5 ? 5 : 3;
this.xiayiGuanLabel = this.xiaYiGuan.node.getComponentInChildren(cc.Label);
this.scheduleOnce(function() {
e.xiaYiGuan.node.active = !0;
u.default.instance.checkGameState([ 5 ]) ? e.xiayiGuanLabel.string = "下一关" : e.xiayiGuanLabel.string = "重玩";
}, t);
...
this.curLevelWanChengDu.string = "完成";
this.xiayiGuanLabel.string = "下一关";
this.curLevel.string = "第" + (u.default.instance.curLevel - 1) + "关";
this.nextLevel.string = u.default.instance.curLevel + "";
u.default.instance.isFromComplete = !0;
} else {
this.curLevelWanChengDu.string = "未完成";
this.xiayiGuanLabel.string = "重玩";
u.default.instance.isFromComplete = !1;
this.curLevel.string = "第" + u.default.instance.curLevel + "关";
this.nextLevel.string = u.default.instance.curLevel + 1 + "";
}
var e = new Map();
e.set(s.CurrencyType.Gold, u.default.instance.curGold);
u.default.instance.curGold = 0;
u.default.instance.curDiamond > 0 && e.set(s.CurrencyType.Diamond, u.default.instance.curDiamond);
this.rewardPrefab.getComponent(p.default).init(e);
if (u.default.instance.curDiamond < 2 || h.default.instance.checkCanGuide(10002, 0)) {
y.default.instance.callJava("trackEvent", "(Ljava/lang/String;)V", "GameCompleteRewardShow");
this.adsScenceId = "GameComplete";
this.moreRewardMap = e;
this.guideReward(e);
this.rewardPrefab.getComponent(p.default).init(e);
} else {
this.moreRewardMap = e;
...
!u.default.instance.checkGameState([ 5 ]) || 5 != u.default.instance.curLevel && 10 != u.default.instance.curLevel || u.default.instance.isRate || l.default.instance.openPanel(s.PanelName.FiveStarPanel, l.default.gameUi.middleNode);
this.adsBtn.node.on("click", this.adsBtnTap, this);
};
...
u.default.instance.addCurrency(5 * e, t);
});
this.gold.string = l.default.gameUi.goldLable.string;
this.masonry.string = l.default.gameUi.diamondLable.string;
...
h.default.instance.checkCanGuide(10001, 0) ? e.set(s.CurrencyType.Gold, e.get(s.CurrencyType.Gold) + 500) : h.default.instance.checkCanGuide(10002, 0) && e.set(s.CurrencyType.Diamond, 50);
};
t.prototype.showTapContinue = function() {};
t.prototype.goGame = function() {
this.xiaYiGuan.interactable = !1;
if (Number(this.curLevel.string) >= 5) b.default.instance.show_Ad(b.Adver_Type.CanCloseVideo_Adv, function(e) {
this.xiaYiGuan.interactable = !0;
this.moreRewardMap.forEach(function(e, t) {
u.default.instance.addCurrency(e, t);
});
this.scheduleOnce(this.beBlack, this.nuber);
}.bind(this)); else {
this.moreRewardMap.forEach(function(e, t) {
...
e.LaserCut = "bulletLaserCutPrefab";
...
var o = e("../../code/manager/MyRoleDataManager"), a = e("../../code/Config/Config"), i = function() {
function e(e) {
this.table = e;
}
...
e.prototype.getRewardPrice = function(e) {
e > 20 * this.table.length && (e = 20 * this.table.length);
var t = Math.floor(e / 20) + 301e3, n = this.getDataById(t);
...
var e = this.getBestConnon();
return Math.pow(e.c_price_b, 10) * e.c_price;
};
...
var l = e("../../code/manager/NodePoolMananger"), s = e("../../code/manager/MyRoleDataManager"), c = e("../../code/manager/TableManager"), u = e("../../code/Lib/LocalStorage"), d = e("../../code/manager/SoundManager"), p = e("./ConnonBase"), f = e("../../code/Lib/Global"), h = e("../../code/Config/Config"), g = e("../../code/manager/PanelManager"), y = e("../../code/manager/EffectManager"), m = e("../../code/manager/SDKManager"), b = cc._decorator, v = b.ccclass, S = b.property, P = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.bulletPrefab = [];
...
void 0 === e && (e = -1);
var t = Number(u.default.getItem("skillIntensifyLevel")), n = c.default.instance.cannonGrowUp.getDataById(t), o = c.default.instance.connonTable.getDataById(this.connonId), a = c.default.instance.cannonGrowUp.getLine();
if (-1 == e) this.maxLife = this.life = Number(o.armor_basis) + Number(n.armor_basis) + Number(n.armor_up_b) * (t - 10 * a); else if (0 == e) this.life = this.maxLife; else {
...
var e = Number(u.default.getItem("skillIntensifyLevel")), t = c.default.instance.connonTable.getDataById(this.connonId), n = c.default.instance.cannonGrowUp.getDataById(e), o = c.default.instance.cannonGrowUp.getLine();
this.goldMore = f.default.accMul(t.coins, .01);
this.mainGunHit = Number(t.c_att) + Number(n.c_att) + Number(n.c_att_b) * (e - 10 * o);
...
var e = cc.sequence(cc.fadeTo(.6, 100), cc.delayTime(5.4), cc.repeat(cc.sequence(cc.fadeTo(.5, 255), cc.fadeTo(.5, 100)), 2), cc.fadeIn(.5));
this.invincibleEndTime = f.default.getTime() + this.invincibleTime + 3e3;
this.node.stopActionByTag(1001);
this.node.runAction(e).setTag(1001);
};
...
var e = cc.repeatForever(cc.sequence(cc.fadeTo(.6, 100), cc.fadeTo(.6, 255)));
this.node.runAction(e);
this.invincibleEndTime = f.default.getTime() + this.invincibleTime;
var t = function() {
this.node.stopAction(e);
var t = cc.fadeIn(.1);
...
this.connonId = e;
var t = c.default.instance.connonTable.getScourceId(e, 4), n = t[0], o = t[1], a = t[2], i = s.default.instance.getConnonInfo(this.connonId);
this.connonSprite.spriteFrame = this.connonAtlas.getSpriteFrame(n + s.default.instance.getSourceNum(i.mainGunLevel - 1));
this.wheelSprite.spriteFrame = this.connonAtlas.getSpriteFrame(a + "0");
this.subConnonScript.setConnonIcon(-1 == i.extraGun ? null : this.connonAtlas.getSpriteFrame(o + s.default.instance.getSourceNum(i.extraGun - 1)));
};
...
a([ S([ cc.Prefab ]) ], t.prototype, "bulletPrefab", void 0);
a([ S(cc.Sprite) ], t.prototype, "wheelSprite", void 0);
a([ S(cc.SpriteAtlas) ], t.prototype, "connonAtlas", void 0);
a([ S(cc.Sprite) ], t.prototype, "fire", void 0);
a([ S(cc.Sprite) ], t.prototype, "subConnon", void 0);
a([ S(cc.Node) ], t.prototype, "funnelLeftNode", void 0);
a([ S(cc.Node) ], t.prototype, "funnelRightNode", void 0);
a([ S(cc.Animation) ], t.prototype, "invincibleAin", void 0);
a([ S(cc.Integer) ], t.prototype, "invincibleTime", void 0);
a([ S(cc.Integer) ], t.prototype, "maxSpeed", void 0);
a([ S(cc.Integer) ], t.prototype, "aSpeed", void 0);
a([ S({
type: [ cc.Prefab ],
tooltip: "副炮预制体"
...
n.EffectName = void 0;
var i = e("./LoadManager"), r = e("./NodePoolMananger"), l = e("../../src/prefab/FlyRewardPrefab"), s = function() {
function e() {
...
(c = r.default.instance.pop("flyRewardPrefab")).getComponent(l.default).init(e[a], t[a], n[a], o);
} else {
var i = void 0;
if (0 == n) return;
i = n <= 10 ? Number(n) : n <= 100 ? Math.floor(Number(n) / 10) + 20 : n <= 1e3 ? Math.floor(Number(n) / 100) + 30 : n <= 1e4 ? Math.floor(Number(n) / 1e3) + 40 : 50;
for (var s = 0; s < i; s++) {
var c = r.default.instance.pop("flyRewardPrefab"), u = Math.random(), d = u > .5 ? 30 * Math.random() : 30 * -Math.random(), p = u > .5 ? 30 * Math.random() : 30 * -Math.random(), f = new cc.Node();
(f = e).position = cc.v3(e.x + d, e.y + p);
c.getComponent(l.default).init(f, t, n, o);
}
}
};
return e;
...
var i = e("../../../code/basecode/BasePanel"), r = e("../../../code/manager/UiAniManager"), l = e("../../../code/manager/PanelManager"), s = e("../../../code/Config/Config"), c = e("../../../code/manager/MyRoleDataManager"), u = e("../../../code/manager/BallManager"), d = e("../../../code/manager/TableManager"), p = e("../../../code/Lib/Global"), f = e("../../../code/manager/MissionManger"), h = e("../../../code/manager/BoxManager"), g = e("../../../code/manager/SoundManager"), y = e("../../../code/Lib/LocalStorage"), m = cc._decorator, b = m.ccclass, v = m.property, S = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.panelNode = null;
...
t.prototype.onLoad = function() {
this.firstEndless = Number(y.default.getItem("FirstEndless", "0"));
};
t.prototype.openPanel = function() {
this.isInBlack = !1;
if (c.default.instance.maxScore < c.default.instance.curScore) {
c.default.instance.maxScore = c.default.instance.curScore;
y.default.saveItem("maxScore", c.default.instance.maxScore + "");
}
this.scoreLabel.string = "Score: " + p.default.setNum(c.default.instance.curScore);
this.playUIAni(r.InOrOut.IN);
this.addEvent();
f.default.instance.maxMissionNum(2, c.default.instance.curScore);
f.default.instance.saveMission();
this.scoreLabel.node.zIndex = 2;
this.boxNode.zIndex = 1;
this.boxSprite.node.scale = 0;
g.default.stopBackGroudMusic();
this.rewardCount();
};
t.prototype.closePanel = function() {
this.playUIAni(r.InOrOut.OUT);
...
l.default.game.playerScript.outFunnel();
l.default.game.playerScript.clearEfect();
if (this.boxNode.active) {
this.boxOutAni.stop("boxBigSmall");
this.boxOutAni.playAdditive("boxOut");
this.boxOutAni.once("stop", function() {
var t = cc.sequence(cc.scaleTo(.3, 1.1), cc.scaleTo(.1, 1), cc.delayTime(p.default.Random(1, 3))).repeatForever();
e.boxSprite.node.runAction(t);
});
}
};
t.prototype.panelOut = function() {
...
t.prototype.addEvent = function() {
this.okButton.node.on("click", this.closeBtnTap, this);
};
t.prototype.dleEvent = function() {
this.okButton.node.off("click", this.closeBtnTap, this);
};
t.prototype.beBlack = function() {
this.dleEvent();
this.panelNode.y = 1691;
...
var e = u.default.instance.getBallHp(), t = c.default.instance.curCannonID, n = d.default.instance.connonTable.getDataById(t), o = c.default.instance.getConnonInfo(t), a = Math.floor((o.mainGunLevel - 1) / 4) + 1;
a = a > 5 ? 5 : a;
Math.floor((o.extraGun - 1) / 5);
var i = e / (Number(n.c_att_b) * o.mainGunLevel * a * 10) / 4;
if ((i < .7 || u.default.instance.ballOutTimes < 20) && 0 != this.firstEndless) {
this.goldNode.active = !0;
this.boxNode.active = !1;
var r = this.getGoldPro(i);
this.downNode.y = 172;
this.goldRewardNum = Math.ceil(d.default.instance.connonTable.getBestTenUpgradeMoney() * r * .01);
this.goldLabel.string = this.goldRewardNum + "";
c.default.instance.addCurrency(this.goldRewardNum, s.CurrencyType.Gold);
this.fullLabel.node.active = !1;
} else {
this.downNode.y = 14;
this.goldNode.active = !1;
this.boxNode.active = !0;
var p = this.countBoxLevel(i);
if (0 == this.firstEndless) {
this.firstEndless = 1;
p = s.BoxLevel.GoldBox;
y.default.saveItem("FirstEndless", "1");
}
if (h.default.instance.addBox(p)) {
this.boxSprite.spriteFrame = l.default.gameUi.boxAtlas.getSpriteFrame("baoxiang" + (p - 7e5 + 1));
this.fullLabel.node.active = !1;
} else {
this.boxSprite.spriteFrame = l.default.gameUi.boxAtlas.getSpriteFrame("baoxiang_man");
this.fullLabel.node.active = !0;
this.fullLabel.string = GlobalFun.i18n.t("lable.10250");
}
}
};
t.prototype.countBoxLevel = function(e) {
var t, n = p.default.Random(0, 99);
n < 1 ? t = s.BoxLevel.LegendBox : e > 1.5 ? t = n < 25 ? s.BoxLevel.ArgentumBox : n < 50 ? s.BoxLevel.GoldBox : n < 75 ? s.BoxLevel.DiamondBox : s.BoxLevel.LegendBox : e <= 1.5 && e > 1.2 ? n < 33 ? t = s.BoxLevel.ArgentumBox : n < 66 ? t = s.BoxLevel.GoldBox : n < 100 && (t = s.BoxLevel.DiamondBox) : e <= 1.2 && e > 1 ? n < 50 ? t = s.BoxLevel.ArgentumBox : n < 100 && (t = s.BoxLevel.GoldBox) : t = s.BoxLevel.ArgentumBox;
return t;
};
t.prototype.toTop = function() {
this.scoreLabel.node.zIndex = 1;
this.boxNode.zIndex = 2;
};
t.prototype.getGoldPro = function(e) {
return e < .1 ? .01 : (10 * e - 1) / 6 * .5;
};
a([ v({
type: cc.Node,
tooltip: "界面节点"
...
var o = n.split("/"), a = t.toLocaleDateString().split("/");
this.compareDate(a, o) && i.default.saveItem("Endless", "3");
this.updateVideo();
};
...
0 == this.nowEndlessNumber ? this.video.active = !0 : this.video.active = !1;
};
t.prototype.compareDate = function(e, t) {
return !(e[0] < t[0]) && (e[0] > t[0] || !(e[1] < t[1]) && (e[1] > t[1] || !(e[2] <= t[2]) && (e[2] > t[2] || void 0)));
};
...
t.prototype.fly = function(e, t) {
var n = this;
void 0 === t && (t = null);
if (d.default.instance.isConnon(this.rewadrType)) {
this.connonNode.active = !0;
this.icon.node.active = !1;
var o = u.default.instance.connonTable.getScourceId(this.rewadrType, 4), a = o[0], f = o[1], h = o[2];
this.connon.spriteFrame = r.default.game.playerScript.connonAtlas.getSpriteFrame(a + "0");
this.wheel.spriteFrame = r.default.game.playerScript.connonAtlas.getSpriteFrame(h + "0");
this.sub.spriteFrame = r.default.game.playerScript.connonAtlas.getSpriteFrame(f + "0");
var g = r.default.gameUi.downNode.y - 759;
r.default.gameUi.node.addChild(this.node);
var y = p.default.convertNodePosToTargetNodePos(e, this.node), m = this.rewadrType - 51e4;
this.icon.spriteFrame = this.iconArr[m];
this.node.setPosition(y);
var b = cc.sequence(cc.moveTo(.5, cc.v2(-270, g)), cc.callFunc(function() {
s.default.instance.playEffect(s.EffectName.RewardFlyBoom, n.node, cc.v2(0, 0), function() {
n.node.stopAction(b);
n.node.removeFromParent();
l.default.instance.push(n.node);
r.default.instance.openPanel(i.PanelName.RefitShopPanel, r.default.gameUi.middleNode, n.rewadrType);
});
}));
...
g = void 0;
g = null == t ? r.default.gameUi.highTopUiNode.y - 32 : t.convertToWorldSpaceAR(t.position).y - 690;
r.default.gameUi.node.addChild(this.node);
var v = e.parent.convertToWorldSpaceAR(e.position);
y = this.node.parent.convertToNodeSpaceAR(v), m = this.rewadrType - 51e4;
this.icon.spriteFrame = this.iconArr[m];
this.icon.node.setContentSize(48, 48);
this.node.setPosition(y);
var S = cc.sequence(cc.moveTo(1, cc.v2(this.arr[m], g)), cc.callFunc(function() {
r.default.gameUi.updataGold();
if (n.rewadrType == i.CurrencyType.Gold) {
var e = "";
d.default.instance.allGoldMore > 1 && (e = "(x" + d.default.instance.allGoldMore + ")");
r.default.gameUi.showToast(n.num + "", e, cc.v2(-235.1, -32.7), null == t ? r.default.gameUi.highTopUiNode : t);
c.default.playSoundEffect(c.default.getCoinEnd);
r.default.gameUi.getTextTween(null == t ? r.default.gameUi.goldLable : t.getComponent(cc.Label), d.default.instance.Gold, d.default.instance.Gold - n.num, .01);
} else if (n.rewadrType == i.CurrencyType.Diamond) {
r.default.gameUi.showToast(n.num + "", "", cc.v2(-11.3, -32.7), null == t ? r.default.gameUi.highTopUiNode : t);
c.default.playSoundEffect(c.default.getDiamod);
r.default.gameUi.getTextTween(null == t ? r.default.gameUi.goldLable : t.getComponent(cc.Label), d.default.instance.Diamond, d.default.instance.Diamond - n.num, .01);
}
n.node.stopAction(S);
n.node.removeFromParent();
l.default.instance.push(n.node);
...
t.prototype.setShoot = function() {
if (this.bulletType == d.BulletType.BulletLaser) this.laserShoot(); else if (this.bulletType == d.BulletType.LaserCut) {
this.shootTemp = 1;
this.schedule(this.laserCutShoot, this.shootTemp, cc.macro.REPEAT_FOREVER);
} else if (this.bulletType == d.BulletType.LifeShield) ; else {
...
this.showType || this.scheduleOnce(this.funnelOut, .001 * (this.endTime - t));
};
t.prototype.dleLife = function(e) {
this.leftLife -= e;
...
s.default.instance.push(this.effect);
}
this.connonSprite.spriteFrame = null;
h.default.instance.playEffect(h.EffectName.FunnelConnonBoom, this.node, cc.v2(0, 0), function() {
e.isAni = !1;
e.node.removeFromParent();
s.default.instance.push(e.node);
}, this.funnelId + "BoomClip", 1);
};
a([ m({
type: cc.SpriteAtlas,
tooltip: "炮资源集"
...
t > 0 ? this.disCountLabel.string = P.default.instance.getFormatBySecond(t / 1e3, 1) : this.discountShow();
}
};
t.prototype.addEvent = function() {
var e = this;
...
this.goldBtn.node.on("click", this.shopBtnTAp.bind(this, h.CurrencyType.Gold), this);
this.goldBtn.node.on("click", function() {
e.HurdleIsOpen && e.OpenCloseHurdle();
}, this);
this.diamondBtn.node.on("click", this.shopBtnTAp.bind(this, h.CurrencyType.Diamond), this);
this.diamondBtn.node.on("click", function() {
e.HurdleIsOpen && e.OpenCloseHurdle();
}, this);
this.chipBtn.node.on("click", this.shopBtnTAp, this);
...
this.maxscoreLayout.active = !0;
this.levelLable.node.active = !0;
this.handMoveAni.setCurrentTime(1, "levelScoreChange");
this.levelLable.node.opacity = 255;
...
this.btnTishi();
this.schedule(function() {
y.default.instance.checkCanGuide(10001, 0) ? y.default.instance.startGuide(10001) : y.default.instance.checkCanGuide(10002, 0) ? y.default.instance.startGuide(10002) : y.default.instance.checkCanGuide(10003, 0) ? y.default.instance.startGuide(10003) : y.default.instance.checkCanGuide(10005, 0) ? y.default.instance.startGuide(10005) : !1;
s.default.instance.isFromComplete ? s.default.instance.isFromComplete = !1 : s.default.instance.gameState = 0;
this.handMoveAni.playAdditive("handMove");
this.handMoveAni.playAdditive("levelScoreChange");
}, .5, 0);
};
...
if (a = this.effectPrefabArr[s.default.instance.curScenceID - 2e4]) {
this.curEffect = cc.instantiate(a);
this.effectNode.addChild(this.curEffect);
}
return [ 2 ];
}
});
...
var t = cc.moveTo(.25, 375, 0), n = cc.moveTo(.25, -375, 0), o = cc.moveTo(.25, 120, -1100);
...
_.default.instance.cancelWaitAdsReady();
};
...
this.HurdleIsOpen && this.OpenCloseHurdle();
if (0 == this.EndlessManager.nowEndlessNumber) T.default.instance.show_Ad(T.Adver_Type.ReWardVideo_Adv, function(e) {
this.EndlessManager.useOnceEndless(1);
...
s % 4 == 0 && f.default.playSoundEffect(f.default.fightReward);
s++;
...
a([ A([ cc.Animation ]) ], t.prototype, "uiInAni", void 0);
a([ A([ cc.Animation ]) ], t.prototype, "uiOutAni", void 0);
a([ A(cc.Animation) ], t.prototype, "handMoveAni", void 0);
a([ A(cc.Node) ], t.prototype, "scoreLable", void 0);
a([ A(cc.Label) ], t.prototype, "startLab", void 0);
a([ A(cc.Sprite) ], t.prototype, "handSprite", void 0);
a([ A(cc.Node) ], t.prototype, "levelCompleteNode", void 0);
a([ A(cc.Sprite) ], t.prototype, "backGroud", void 0);
a([ A(cc.Label) ], t.prototype, "maxScoreLable", void 0);
a([ A({
type: cc.Label,
tooltip: "游戏币lable"
}) ], t.prototype, "goldLable", void 0);
...
a([ A(cc.Animation) ], t.prototype, "goldLableAni", void 0);
a([ A(cc.Sprite) ], t.prototype, "goldImg", void 0);
a([ A(cc.Animation) ], t.prototype, "backgroundShackAni", void 0);
a([ A(cc.Animation) ], t.prototype, "blackAni", void 0);
a([ A(cc.Node) ], t.prototype, "middleNode", void 0);
a([ A([ cc.Prefab ]) ], t.prototype, "effectPrefabArr", void 0);
a([ A(cc.Node) ], t.prototype, "effectNode", void 0);
a([ A(cc.Layout) ], t.prototype, "goldLayout", void 0);
a([ A({
type: cc.Label,
tooltip: "游戏币lable"
...
a([ A(cc.SpriteFrame) ], t.prototype, "singleColor", void 0);
a([ A(cc.Node) ], t.prototype, "maskNode", void 0);
a([ A(cc.Label) ], t.prototype, "curLevel", void 0);
a([ A(cc.Label) ], t.prototype, "nextLevel", void 0);
a([ A(cc.ProgressBar) ], t.prototype, "pro", void 0);
a([ A({
type: cc.Node,
tooltip: "进度条节点"
}) ], t.prototype, "proNode", void 0);
a([ A(cc.Node) ], t.prototype, "maxscoreLayout", void 0);
a([ A(cc.Label) ], t.prototype, "levelLable", void 0);
a([ A({
type: cc.Button,
tooltip: "设置按钮"
...
a([ A([ cc.Node ]) ], t.prototype, "uiInNodes", void 0);
a([ A(cc.Button) ], t.prototype, "openLeftSideHurdle", void 0);
a([ A(L.default) ], t.prototype, "EndlessManager", void 0);
a([ A({
type: cc.Button,
tooltip: "强化技能按钮"
...
for (var t in L.default.instance.gobj) L.default.instance.gobj[t].updateTime(0);
this.changePhysicsEnabled(!1, !0);
...
} else 1 == u.default.instance.gameType && d.default.instance.openPanel(g.PanelName.CompletePanel, d.default.gameUi.middleNode);
} else {
...
t.prototype.onResurgenceTap = function() {
...
d.default.instance.getExistPanel(g.PanelName.PausePanel).touchStart();
...
if (this.touchId == e.getID()) if (-1 != this.lastMoveX) {
...
return [ 4, P.default.instance.playEffect(this.boomPrefab.name, this.bulletNode, e, function() {
i.active = !1;
}, a, o) ];
...
return [ 4, P.default.instance.playEffect(this.smokePrefab.name, this.bulletNode, e, function() {
o.active = !1;
}, "smoke" + t, n) ];
...
void 0 === e && (e = null);
var t = c.default.instance.pop(this.completeEffect.name);
d.default.gameUi.middleNode.addChild(t);
var n = t.getComponent(cc.Animation);
this.scheduleOnce(function() {
d.default.gameUi.uiInAni[0].play("uiIn0");
}, 1);
n.once("stop", function() {
u.default.instance.isSlowAction = !1;
e();
t.removeFromParent();
c.default.instance.push(t);
});
n.play("completeEffect");
};
t.prototype.playFrozen = function() {
return i(this, void 0, void 0, function() {
return r(this, function(e) {
...
a.getComponent(_.default).init(5 * (l + 1) * e.playerScript.mainGunHit);
...
a([ N(cc.Node) ], t.prototype, "ballNode", void 0);
a([ N(cc.Node) ], t.prototype, "bulletNode", void 0);
a([ N(cc.Node) ], t.prototype, "Player", void 0);
a([ N(cc.Node) ], t.prototype, "wall", void 0);
a([ N(cc.Node) ], t.prototype, "frozen", void 0);
a([ N([ cc.Prefab ]) ], t.prototype, "ballPreArr", void 0);
a([ N(cc.Prefab) ], t.prototype, "coinPre", void 0);
a([ N(cc.Prefab) ], t.prototype, "connonPrefab", void 0);
a([ N(cc.Prefab) ], t.prototype, "boomPrefab", void 0);
a([ N(cc.Prefab) ], t.prototype, "funnulBommPrefab", void 0);
a([ N(cc.Prefab) ], t.prototype, "smokePrefab", void 0);
a([ N(cc.Prefab) ], t.prototype, "bloodPrefab", void 0);
a([ N(cc.Prefab) ], t.prototype, "coinNumPrefab", void 0);
a([ N(cc.Prefab) ], t.prototype, "completeEffect", void 0);
a([ N(cc.Prefab) ], t.prototype, "propPrefab", void 0);
a([ N({
type: cc.Prefab,
tooltip: "炮展示预制体"
...
n.GuideType = void 0;
var a, i = e("./PanelManager"), r = e("../Config/Config"), l = e("./MyRoleDataManager"), s = e("./TableManager"), c = e("../../src/ui/RefitShopPanel/RefitItem"), u = e("../Lib/LocalStorage"), d = e("./MissionManger"), p = e("../../src/ui/MissionPanel/MissionItem"), f = cc._decorator, h = f.ccclass, g = (f.property, 
function() {
function e() {
this.guideStep = 0;
this.isInGuide = 0;
...
if (10001 == e) {
if ((!this.guideHistory[e] && 2 == l.default.instance.curLevel || this.isInGuide == e) && 1 == l.default.instance.getattributeLevel(l.default.instance.curCannonID) && this.guideStep == t) return !0;
} else if (10002 == e) {
if ((!this.guideHistory[e] && 3 == l.default.instance.curLevel || this.isInGuide == e) && this.guideStep == t) return !0;
} else if (10003 == e) {
if ((!this.guideHistory[e] && d.default.instance.getCompleteMission(0) || this.isInGuide == e) && this.guideStep == t) return !0;
} else if (10004 == e) {
if (this.isInGuide == e && this.guideStep == t) return !0;
} else if (10005 == e && (!this.guideHistory[e] && l.default.instance.curLevel > 9 || this.isInGuide == e) && this.guideStep == t) return !0;
return !1;
};
...
i.default.instance.openPanel(r.PanelName.GuidePanel, i.default.gameUi.node, i.default.gameUi.aircraftBtn.node, e, "click", a.ClickTarget, s.default.instance.guideTable.getWord(10002, 0));
} else if (1 == this.guideStep) {
this.guideStep++;
...
t.getComponent(p.default).completeBtn.node);
i.default.instance.openPanel(r.PanelName.GuidePanel, i.default.gameUi.node, n, e, "click", a.ClickTarget, -1, {
width: t.width,
height: t.height
});
...
this.guideStep++;
var e = i.default.gameUi.missionBtn.node.parent.convertToWorldSpaceAR(i.default.gameUi.missionBtn.node.position);
i.default.instance.openPanel(r.PanelName.GuidePanel, i.default.gameUi.node, i.default.gameUi.missionBtn.node, e, "click", a.ClickTarget, d.default.instance.curSpecilMission.missionStartDes);
} else if (1 == this.guideStep) {
this.guideStep++;
...
this.guideHistory[10005] = !0;
this.isInGuide = 10005;
if (0 == this.guideStep) {
u.default.saveItem("guideHistory", JSON.stringify(this.guideHistory));
this.guideStep++;
var e = i.default.gameUi.endlessBtn.node.parent.convertToWorldSpaceAR(i.default.gameUi.endlessBtn.node.position);
i.default.instance.openPanel(r.PanelName.GuidePanel, i.default.gameUi.node, i.default.gameUi.endlessBtn.node, e, "click", a.ClickTarget, -1);
}
};
var t;
return e = t = o([ h ], e);
...
var i = e("../../code/basecode/BasePanel"), r = e("../../code/manager/UiAniManager"), l = e("../../code/manager/PanelManager"), s = e("../../code/Config/Config"), c = e("../../code/manager/GuideManager"), u = cc._decorator, d = u.ccclass, p = u.property, f = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.showNode = null;
...
this.showNode.on(cc.Node.EventType.TOUCH_END, this.onShowTouchStart, this);
};
t.prototype.dleEvent = function() {
this.node.off(cc.Node.EventType.TOUCH_START, this.onNodeTouchStart, this);
this.showNode.off(cc.Node.EventType.TOUCH_END, this.onShowTouchStart, this);
};
...
var l = e("../code/manager/LoadManager"), s = e("../code/Lib/LocalStorage"), c = e("../code/manager/TableManager"), u = e("../code/manager/MyRoleDataManager"), d = e("../code/Config/Config"), p = e("../code/manager/SDKManager"), f = e("../code/ads/AdsGroupController"), h = e("../code/manager/UiAniManager"), g = cc._decorator, y = g.ccclass, m = g.property, b = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.loadLable = null;
...
a([ m(cc.Label) ], t.prototype, "loadLable", void 0);
a([ m(cc.Animation) ], t.prototype, "loadAni", void 0);
return t = a([ y ], t);
}(cc.Component);
n.default = b;
cc._RF.pop();
...
var i = e("../../../code/manager/MissionManger"), r = e("../../../code/manager/TableManager"), l = e("../../../code/Lib/DateUtils"), s = e("../../../code/Lib/Global"), c = e("./RewardItem"), u = e("../../../code/manager/SoundManager"), d = e("../../../code/manager/PanelManager"), p = e("../../../code/manager/MyRoleDataManager"), f = e("../../../code/manager/GuideManager"), h = e("../../../code/manager/SDKManager"), g = cc._decorator, y = g.ccclass, m = g.property, b = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.missionNode = null;
...
f.default.instance.checkCanGuide(10003, 0) && f.default.instance.setGuideState(10003, !0);
h.default.instance.callJava("trackEvent", "(Ljava/lang/String;)V", "NormalMissionComplete");
this.state = 0;
...
var i = e("../../../code/manager/UiAniManager"), r = e("../../../code/basecode/BasePanel"), l = e("../../../code/manager/TableManager"), s = e("../../../code/manager/MissionManger"), c = e("../../../code/manager/PanelManager"), u = e("../../../code/Config/Config"), d = e("../../../code/manager/MyRoleDataManager"), p = e("./RewardItem"), f = e("../../../code/manager/SoundManager"), h = e("../../../code/manager/GuideManager"), g = e("../../../code/manager/SDKManager"), y = e("../../../code/Lib/Global"), m = e("../../../code/Lib/DateUtils"), b = cc._decorator, v = b.ccclass, S = b.property, P = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.nameLabel = null;
...
this.leftTimeLabel.string = GlobalFun.i18n.t("lable.10004") + m.default.instance.getFormatBySecond((s.default.instance.curSpecilMission.refreshTime - e) / 1e3, 5);
}
};
t.prototype.openPanel = function() {
this.updateInfo();
...
this.specialNameLabel.string = "(" + e.totalPro + "/" + e.totalNumber + ")" + GlobalFun.i18n.t("lable." + e.nameId);
this.specialInfoLabel.string = GlobalFun.i18n.t("lable." + e.decId);
...
if (e.pro >= e.quest && !e.isCompleteAll) this.missioncompleteNode.active = !0; else if (e.pro < e.quest && !e.isCompleteAll) this.missioncompleteNode.active = !1; else if (e.isCompleteAll) {
this.missionCompleteNode.active = !0;
this.missionShowNode.active = !1;
}
};
...
this.rewardNode.getComponent(p.default).rewardFly();
...
var u = r[c];
if (u) if (51e4 == u[0]) {
var d = l.default.instance.connonTable.getBestTenUpgradeMoney();
...
a([ l(Number) ], t.prototype, "startWidth", void 0);
return t = a([ r ], t);
}(cc.Component);
n.default = s;
cc._RF.pop();
...
void 0 === e && (e = null);
e = e || this.curCannonID;
if (0 == t.instance.curLevel) return {
mainGunLevel: 12,
extraGun: 9,
lifeLevel: 1
};
var n = a.default.getItem("skillIntensifyLevel");
return {
extraGun: Number(n),
lifeLevel: Number(n),
mainGunLevel: Number(n)
};
};
...
var i = e("./code/Lib/LocalStorage"), r = e("./code/manager/MyRoleDataManager"), l = e("./code/manager/PanelManager"), s = e("./code/manager/TableManager"), c = e(".//code/Lib/Global"), u = e("./code/manager/Advert_Manager"), d = cc._decorator, p = d.ccclass, f = d.property, h = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.LevelValue = null;
...
this.LevelValue.string = this.offLineLevel;
...
this.nowUpgradeGold = e + t * n * (n - 1);
} else {
e = s.default.instance.connonTable.getRewardPrice(Number(n));
t = s.default.instance.connonTable.getRewardPrice_up(Number(n));
this.nowUpgradeGold = e + t * n * (n - 1);
}
...
var n;
a([ f(cc.Label) ], t.prototype, "LevelValue", void 0);
a([ f(cc.Button) ], t.prototype, "videoUpgrade", void 0);
a([ f(cc.Button) ], t.prototype, "goldUpgrade", void 0);
a([ f(cc.Label) ], t.prototype, "upgradeGold", void 0);
a([ f(cc.Node) ], t.prototype, "tishi", void 0);
a([ f(cc.Animation) ], t.prototype, "animation", void 0);
a([ f(Boolean) ], t.prototype, "isOffLineSkill", void 0);
a([ f(n) ], t.prototype, "LineSkil", void 0);
return t = n = a([ p ], t);
}(cc.Component);
n.default = h;
cc._RF.pop();
...
e > 10 * this.table.length && (e = 10 * this.table.length);
var t = Math.floor(e / 10) + 1 + 1e6, n = this.getDataById(t);
...
var i = e("./code/Lib/LocalStorage"), r = e("./code/Lib/Global"), l = e("./code/manager/MyRoleDataManager"), s = e("./src/game/GameUI"), c = e("./src/ui/MissionPanel/RewardItem"), u = e("./code/Config/Config"), d = e("./code/manager/TableManager"), p = e("./code/manager/Advert_Manager"), f = cc._decorator, h = f.ccclass, g = f.property, y = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.label = null;
...
t.prototype.start = function() {
var e = i.default.getItem("earnings");
if (e && "0" != e) this.earnings = Number(e); else {
var t = i.default.getItem("offLine");
if (!t) {
cc.log("还未离线过");
this.node.active = !1;
return;
}
var n = r.default.getTime() - Number(t);
this.timeMinute = 167e-7 * n;
...
for (var n = 0, o = e; o < e + 10; o++) {
n += d.default.instance.OffLineTable.getRewardPrice(Number(o)) + d.default.instance.OffLineTable.getRewardPrice_up(Number(o)) * o * (o - 1);
}
var a = d.default.instance.OffLineTable.getRewardCardinalNumber(Number(e)), i = d.default.instance.OffLineTable.getRewardMultiple(Number(e));
t / 60 > 8 && (t = 480);
return Math.floor(n * t / 60 * i / 1e3 + a * e);
};
a([ g({
type: [ cc.Label ],
tooltip: "金币显示Label"
...
t.prototype.setIcon = function() {
this.propIcon.spriteFrame = c.default.gameUi.iconAtlas.getSpriteFrame(l.default.instance.propTable.getIcon(this.propId));
};
t.prototype.contactEffect = function() {
switch (this.propId) {
case 5e5:
...
g.default.instance.addBuffShow(500001, 5 + 5 * t, this.BuffPrefab, this.icons, "U型吸铁");
...
g.default.instance.addBuffShow(500003, 5 + 5 * t, this.BuffPrefab, this.icons, "火力全开");
...
g.default.instance.addBuffShow(500004, 8, this.BuffPrefab, this.icons, "僚机就位");
...
if (-1 == i.default.random()) {
c.default.game.changePhysicsEnabled(!1, !1);
s.default.instance.frozen(6);
g.default.instance.addBuffShow(5e5, 6, this.BuffPrefab, this.icons, "冰封");
h.default.instance.allBallFrozen();
} else {
c.default.game.playerScript.propInvincible();
g.default.instance.addBuffShow(500005, 8, this.BuffPrefab, this.icons, "无敌");
}
break;
...
var n = e[t];
if (n) {
var o = r.default.instance.getConnonInfo(n.id), a = this.spriteAtlas.getSpriteFrame(n.image_cannon + (o ? r.default.instance.getSourceNum(o.mainGunLevel - 1) : "0")), i = this.spriteAtlas.getSpriteFrame(n.image_basis + "0"), l = this.spriteAtlas.getSpriteFrame(n.image_machine + (o && -1 != o.extraGun ? r.default.instance.getSourceNum(o.mainGunLevel - 1) : "0")), c = cc.instantiate(this.connonShowPrefab);
...
this.init();
f.default.instance.checkCanGuide(10001, 1) && f.default.instance.startGuide(10001);
...
this.ButtonS[2].node.on("click", this.watchVideo, this);
this.ButtonS[3].node.on("click", this.NotUnlock, this);
...
this.ButtonS[2].node.off("click", this.watchVideo, this);
this.ButtonS[3].node.off("click", this.NotUnlock, this);
...
var n = s.default.instance.cannonUnlock.getType(this.chooseConnonID, !0), o = s.default.instance.cannonUnlock.getConsume(this.chooseConnonID, !0), a = s.default.instance.cannonUnlock.getMap(this.chooseConnonID, !0), i = void 0;
switch (n) {
case "1":
this.showButton(this.ButtonS[1]);
...
var l = cc.find("Background/condition", i.node);
if (r.default.instance.curLevel > 20 * (a - 202e3)) l.opacity = 0; else {
l.getChildByName("con").getComponent(cc.Label).string = "LV" + 20 * (a - 202e3);
l.opacity = 255;
}
...
this.spriteAtlas.getSpriteFrame(e.image_machine + (o && -1 != o.extraGun ? r.default.instance.getSourceNum(o.extraGun - 1) : "0"))), c = n[t];
c.getChildByName("connon").getComponent(cc.Sprite).spriteFrame = a;
c.getChildByName("wheel").getComponent(cc.Sprite).spriteFrame = i;
c.getChildByName("sub").getComponent(cc.Sprite).spriteFrame = l;
};
...
var e = s.default.instance.cannonUnlock.getMap(this.chooseConnonID, !0), t = cc.find("Background/hint", this.ButtonS[1].node);
if (r.default.instance.curLevel > 20 * (e - 202e3)) if (r.default.instance.dleCurrency(Number(this.goldUnlockgoldTXT.string))) {
d.default.gameUi.updataGold();
r.default.instance.addConnon(this.chooseConnonID);
this.showButton(this.ButtonS[0]);
} else cc.tween(this.goldUnlockHint).to(1, {
opacity: 255
}).to(1, {
opacity: 0
}).start(); else {
t.getComponentInChildren(cc.Label).string = "当前关卡条件不足";
cc.tween(t).to(1, {
opacity: 255
}).to(1, {
opacity: 0
...
var e = s.default.instance.cannonUnlock.getMap(this.chooseConnonID, !0), t = cc.find("Background/hint", this.ButtonS[4].node);
if (r.default.instance.curLevel > 20 * (e - 202e3)) m.default.instance.show_Ad(m.Adver_Type.ReWardVideo_Adv, function(e) {
...
var e = s.default.instance.cannonUnlock.getMap(this.chooseConnonID, !0), t = cc.find("Background/hint", this.ButtonS[5].node);
if (r.default.instance.curLevel > 20 * (e - 202e3)) {
var n = cc.find("Background/gold", this.ButtonS[5].node).getComponent(cc.Label);
if (r.default.instance.dleCurrency(Number(n.string), u.CurrencyType.Diamond)) {
d.default.gameUi.updataGold();
r.default.instance.addConnon(this.chooseConnonID);
this.showButton(this.ButtonS[0]);
} else cc.tween(t).to(1, {
opacity: 255
}).to(1, {
opacity: 0
}).start();
...
}) ], t.prototype, "goldUnlockHint", void 0);
a([ S({
type: [ cc.Node ],
tooltip: "条件不足按钮提示"
...
e("../../code/Config/Config")), u = e("../../code/manager/SoundManager"), d = e("../../code/basecode/BasePanel"), p = e("../../code/manager/UiAniManager"), f = e("../../code/manager/Advert_Manager"), h = cc._decorator, g = h.ccclass, y = h.property, m = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.timePro = null;
...
this.resurgenceLable.node.active = !1;
...
this.resurgenceLable.node.active = !0;
this.scheduleOnce(function() {
e.resurgenceLable.node.active = !1;
}, 2);
}
return [ 2 ];
});
...
t.prototype.setLable = function() {
this.resurgenceLable.string = GlobalFun.i18n.t("lable.10183");
};
a([ y(cc.ProgressBar) ], t.prototype, "timePro", void 0);
a([ y(cc.Label) ], t.prototype, "resurgenceLable", void 0);
a([ y({
type: cc.Label,
tooltip: "复活钻石数量"
}) ], t.prototype, "diamondLable", void 0);
...
r.default.instance.rewardFly(n.connonNode, l, i * t, e[o]);
} else {
var s = l - 51e4;
a[s] && a[s].node && r.default.instance.rewardFly(a[s].node, l, i * t, e[o]);
}
o++;
});
};
...
if (cc.sys.os === cc.sys.OS_IOS) return (o = jsb.reflection).callStaticMethod.apply(o, a([ l, e, t ], i));
...
var i = e("../../../code/manager/MyRoleDataManager"), r = e("../../../code/manager/TableManager"), l = e("../../../code/Lib/LocalStorage"), s = e("../../../code/manager/PanelManager"), c = e("../../../code/Config/Config"), u = e("../../../code/ads/AdsGroupController"), d = e("../../../code/manager/SDKManager"), p = cc._decorator, f = p.ccclass, h = p.property, g = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
...
d.default.instance.callJava("trackEventWithType", "(Ljava/lang/String;Ljava/lang/String;I)V", "SkinUnlock", this.skinId.toString(), 1);
...
if (1 == this.unlockType) if (i.default.instance.checkIsHaveFreeVedioTimes(!0)) {
var e = r.default.instance.skinTable.getQuantity(this.skinId);
i.default.instance.addAdsTime(this.skinId, 1) >= e ? this.unlock() : this.setConditionShow(1, e);
} else u.default.instance.waitAdsReady("UnlockSkin", function() {
s.default.gameUi.openMask();
u.default.instance.showAds("UnlockSkin", function(e, t) {
var n = r.default.instance.skinTable.getQuantity(this.skinId), o = i.default.instance.addAdsTime(this.skinId, 1);
t && o >= n ? this.unlock() : this.setConditionShow(1, n);
}.bind(this));
}, function() {
s.default.gameUi.openMask(!0);
u.default.instance.loadAds("UnlockSkin", !0);
}, this, 120, function() {
s.default.gameUi.showTishi(GlobalFun.i18n.t("lable.10251"));
s.default.gameUi.openMask();
}, this, 0, 0); else if (2 == this.unlockType) {
var t = r.default.instance.skinTable.getQuantity(this.skinId);
if (i.default.instance.dleCurrency(Number(t), c.CurrencyType.Diamond)) {
s.default.gameUi.updataGold(c.CurrencyType.Diamond);
this.unlock();
} else s.default.instance.openPanel(c.PanelName.GoShopPanel, s.default.gameUi.middleNode, c.CurrencyType.Diamond);
}
};
...
var i = e("../../../code/basecode/BasePanel"), r = e("../../../code/manager/UiAniManager"), l = e("../../../code/manager/PanelManager"), s = e("../../../code/Config/Config"), c = e("../../../code/manager/MyRoleDataManager"), u = e("./SkinItem"), d = e("../../../code/manager/TableManager"), p = e("../../../code/manager/SDKManager"), f = cc._decorator, h = f.ccclass, g = f.property, y = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.closeButton = null;
...
t.prototype.openPanel = function() {
var e = l.default.gameUi.EndlessManager.nowEndlessNumber;
this.challengeDescribe.string = 0 == e ? "挑战次数已用尽，继续战斗将无法获得收益！" : "剩余挑战次数：" + e;
this.playUIAni(r.InOrOut.IN);
this.setLable();
this.addEvent();
...
if (0 != l.default.gameUi.EndlessManager.nowEndlessNumber) {
this.closePanel();
...
t.prototype.onLoad = function() {};
t.prototype.setShoot = function() {
var e = Number(p.default.getItem("skillIntensifyLevel")), t = u.default.instance.connonTable.getDataById(this.connonId), n = u.default.instance.cannonGrowUp.getDataById(e), o = u.default.instance.cannonGrowUp.getLine();
d.default.game.playerScript.extraGunHit = this.bulletHit = Number(t.m_att) + Number(n.m_att) + Number(n.m_att_b) * (e - 10 * o);
...
var i = e("./code/Lib/LocalStorage"), r = e("./code/manager/MyRoleDataManager"), l = e("./code/Config/Config"), s = cc._decorator, c = s.ccclass, u = (s.property, 
function(e) {
o(t, e);
function t() {
return null !== e && e.apply(this, arguments) || this;
...
cc.log("加钱了");
r.default.instance.addCurrency(1e3, l.CurrencyType.Gold);
r.default.instance.addCurrency(15, l.CurrencyType.Diamond);
r.default.instance.addCurrency(0, l.CurrencyType.Diamond);
};
...
t.prototype.setLable = function() {
this.nameLable.string = GlobalFun.i18n.t("lable.10257");
};
t.prototype.updateInfo = function() {
...
this.bool ? this.node.color = cc.color(255, 255, 255, 255) : this.node.color = cc.color(200, 255, 255, 255);
this.bool = !this.bool;
};
return t = a([ r ], t);
}(cc.Component));
...
}, {}, [ "BuffHint", "BuffManager", "CannonGrowUp", "CannonUnlock", "EndlessManagement", "LookAdvertising", "OffLineSkill", "OffLineTable", "OfflineEarnings", "Test", "Config", "ColorMaterial", "DateUtils", "Global", "GlobalFun", "LocalStorage", "QuadTree", "Secret", "ShaderUtils", "ShaderUtils1", "StringUtils", "TimeCount", "colorChange", "AdsGroupController", "AdsGroupPlatformTool", "AdsQueue", "AdsSetAndScene", "AdsUnit", "BasePanel", "CheckBox", "EasyGetCompleteClass", "MyLable", "Advert_Manager", "BallManager", "BoxManager", "EffectManager", "GuideManager", "HttpManager", "LoadManager", "MissionManger", "MyRoleDataManager", "NodePoolMananger", "PanelManager", "SDKManager", "SoundManager", "TableManager", "UiAniManager", "Lancher", "Connon", "ConnonBase", "FunnelConnon", "Game", "GameUI", "SubConnon", "BallPrefab", "BoxPrefab", "BulletBase", "BulletBoom", "BulletFollow", "BulletLaser", "BulletLaserCut", "BulletPrefab", "BulletThrough", "CoinPrefab", "FlyRewardPrefab", "PropPrefab", "ShowPrefab", "SpeciaLaser", "SpeedLowPrefab", "prefab90014", "AircraftTable", "BoxTable", "BulletTable", "ConnonTable", "GuideTable", "MapLevelTable", "MissionTable", "PropTable", "ScenceTable", "ShopTable", "SkinTable", "WorkShopTable", "AircraftItem", "AircraftPanel", "BoxOpenPanel", "CompletePanel", "EndlessCompletePanel", "CompleteRewardPanel", "FiveStarPanel", "FreeConnonItem", "GoShopPanel", "GuidePanel", "LatticeProgress", "ListView", "BossLevelBtn", "MapItemPrefab", "MapPanel", "NormalLevelBtn", "MissionItem", "MissionPanel", "RewardItem", "PausePanel", "RefitItem", "RefitShopPanel", "ResurgenceUi", "SetPanel", "GiftItem", "ShopItem", "ShopPanel", "SkinItem", "SkinPanel", "VideoPanel", "WorkItem", "WorkShopPanel", "tishi", "use_v2.0.x_cc.Toggle_event", "LanguageData", "LocalizedLabel", "LocalizedSprite", "SpriteFrameSet", "polyglot.min" ]);
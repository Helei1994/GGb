...
if ("90001" == t || "90002" == t) {
if (null == (a = this.backGroud.node.getChildByName("90005prefab"))) {
i = cc.instantiate(this.effectPrefabArr[0]);
this.backGroud.node.addChild(i);
(a = this.backGroud.node.getChildByName("90005prefab")).setPosition(a.x, a.y - 25);
}
this.schedule(function() {
a.getComponent(cc.Animation).play();
}, 20);
} else {
if (null == (l = this.backGroud.node.getChildByName("90006prefab"))) {
c = cc.instantiate(this.effectPrefabArr[1]);
this.backGroud.node.addChild(c);
l = this.backGroud.node.getChildByName("90006prefab");
}
this.schedule(function() {
l.getComponent(cc.Animation).play();
}, 20);
}
return [ 2 ];
}

...
var i = e("../../../code/manager/MyRoleDataManager"), r = e("../../../code/manager/PanelManager"), l = e("../../../code/Lib/Global"), s = e("../../../code/manager/TableManager"), c = e("../../../code/Config/Config"), u = e("../../../code/manager/SoundManager"), d = e("../LatticeProgress"), p = e("../../../code/manager/Umeng_Manager"), f = e("../../../code/manager/GuideManager"), h = e("../../../code/manager/New_HttpManager"), g = cc._decorator, y = g.ccclass, m = g.property, b = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.infoBtn = null;
...
var i = e("../../../code/basecode/BasePanel"), r = e("../../../code/manager/UiAniManager"), l = e("../../../code/manager/PanelManager"), s = e("../../../code/Config/Config"), c = e("../../../code/manager/TableManager"), u = e("../../../code/manager/MyRoleDataManager"), d = e("../../../code/manager/SoundManager"), p = e("../../../code/manager/NodePoolMananger"), f = e("../../prefab/ShowPrefab"), h = e("../../../code/manager/GuideManager"), g = e("../../../code/Lib/Global"), y = e("../../../code/manager/EffectManager"), m = e("../../../code/manager/SDKManager"), b = e("../../../code/manager/Umeng_Manager"), v = e("../../../code/manager/New_HttpManager"), S = cc._decorator, _ = S.ccclass, P = S.property, M = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.nameLable = null;
...
7 != u.default.instance.curLevel && 12 != u.default.instance.curLevel || u.default.instance.isRate || l.default.instance.openPanel(s.PanelName.FiveStarPanel, l.default.gameUi.middleNode);
} else {
this.cut(!1);
...
this.node.setPosition(b);
var M = t ? cc.v2(t.position.x - 105, t.y) : cc.v2(this.arr[v], m), C = cc.sequence(cc.delayTime(.2), cc.moveTo(.5, M), cc.callFunc(function() {
r.default.gameUi.updataGold();
...
this.HurdleIsOpen && this.OpenCloseHurdle();
y.default.instance.get_isInGuide() && A.default.instance.putPoint(A.Point_EventID.ClickButton_endlessBtn);
...
if (8 != s.default.instance.gameState) {
y.default.instance.get_isInGuide() && A.default.instance.putPoint(A.Point_EventID.ClickButton_aircraftBtn);
...
y.default.instance.register();
y.default.instance.Advert_On_Off();
this.gameConfig();
this.loadAni.play();
};
...
var i = e("../../../code/manager/MissionManger"), r = e("../../../code/manager/TableManager"), l = e("../../../code/Lib/DateUtils"), s = e("../../../code/Lib/Global"), c = e("./RewardItem"), u = e("../../../code/manager/SoundManager"), d = e("../../../code/manager/PanelManager"), p = e("../../../code/manager/MyRoleDataManager"), f = e("../../../code/manager/SDKManager"), h = e("../../../code/manager/New_HttpManager"), g = e("../../../code/Config/Config"), y = cc._decorator, m = y.ccclass, b = y.property, v = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.missionNode = null;
...
var i = e("../../../code/manager/UiAniManager"), r = e("../../../code/basecode/BasePanel"), l = e("../../../code/manager/TableManager"), s = e("../../../code/manager/MissionManger"), c = e("../../../code/manager/PanelManager"), u = e("../../../code/Config/Config"), d = e("../../../code/manager/MyRoleDataManager"), p = e("./RewardItem"), f = e("../../../code/manager/SoundManager"), h = e("../../../code/manager/GuideManager"), g = e("../../../code/manager/SDKManager"), y = e("../../../code/Lib/Global"), m = e("../../../code/Lib/DateUtils"), b = e("../../../code/manager/New_HttpManager"), v = cc._decorator, S = v.ccclass, _ = v.property, P = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.nameLabel = null;
...
"" === this.userid ? r.default.instance.isNative || this.post("user/register", "idfa=" + r.default.instance.getDeviceId() + "&channel=" + c.default.instance.DisChannel + "&system=" + c.default.instance.OS_Channel, function(e) {
var t = JSON.parse(this.response);
...
this.post("user/login", "uid=" + this.userid, function(e) {
var t = JSON.parse(this.response);
n.instance.showerror(t);
...
var n;
a([ y(cc.Label) ], t.prototype, "LevelValue", void 0);
a([ y(cc.Button) ], t.prototype, "videoUpgrade", void 0);
a([ y(cc.Button) ], t.prototype, "goldUpgrade", void 0);
a([ y(cc.Label) ], t.prototype, "upgradeGold", void 0);
a([ y(cc.Node) ], t.prototype, "tishi", void 0);
a([ y(cc.Animation) ], t.prototype, "effect", void 0);
a([ y(cc.Boolean) ], t.prototype, "isOffLineSkill", void 0);
a([ y(n) ], t.prototype, "LineSkil", void 0);
a([ y([ cc.Label ]) ], t.prototype, "setLabelString", void 0);
a([ y([ cc.Node ]) ], t.prototype, "fullLevel", void 0);
a([ y(cc.RichText) ], t.prototype, "setRichTextString", void 0);
return t = n = a([ g ], t);
}(cc.Component);
n.default = m;
cc._RF.pop();
...
this.isguide = !1;
i.default.saveItem("curLevel", "16");
...
e("../../code/Config/Config")), u = e("../../code/manager/SoundManager"), d = e("../../code/basecode/BasePanel"), p = e("../../code/manager/UiAniManager"), f = e("../../code/manager/Advert_Manager"), h = e("../../code/manager/Umeng_Manager"), g = e("../../code/manager/New_HttpManager"), y = cc._decorator, m = y.ccclass, b = y.property, v = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.timePro = null;
...
var i = e("../../code/basecode/BasePanel"), r = e("../../code/manager/UiAniManager"), l = e("../../code/manager/SoundManager"), s = e("../../code/basecode/CheckBox"), c = e("../../code/Lib/LocalStorage"), u = e("../../code/manager/MyRoleDataManager"), d = e("../../code/manager/PanelManager"), p = e("../../code/Config/Config"), f = e("../../code/manager/New_HttpManager"), h = cc._decorator, g = h.ccclass, y = h.property, m = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
...
a([ y(cc.Toggle) ], t.prototype, "backSoundToggle", void 0);
a([ y(cc.Toggle) ], t.prototype, "effectSoundToggle", void 0);
a([ y(cc.Toggle) ], t.prototype, "shackToggle", void 0);
a([ y(cc.Button) ], t.prototype, "leftButon", void 0);
a([ y(cc.Button) ], t.prototype, "rightButon", void 0);
a([ y(cc.Button) ], t.prototype, "closeBtn", void 0);
a([ y(cc.PageView) ], t.prototype, "languesPage", void 0);
a([ y(cc.Node) ], t.prototype, "languesLabel", void 0);
...
var i = e("../../../code/basecode/BasePanel"), r = e("../../../code/manager/UiAniManager"), l = e("../../../code/manager/PanelManager"), s = e("../../../code/Config/Config"), c = e("../../../code/manager/MyRoleDataManager"), u = e("./SkinItem"), d = e("../../../code/manager/TableManager"), p = e("../../../code/manager/SDKManager"), f = e("../../../code/Lib/LocalStorage"), h = e("../../../code/manager/GuideManager"), g = e("../../../code/manager/Umeng_Manager"), y = e("../../../code/manager/New_HttpManager"), m = cc._decorator, b = m.ccclass, v = m.property, S = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.closeButton = null;
...
h.default.instance.get_isInGuide() ? y.default.instance.putPoint("4") : y.default.instance.putPoint("15");
};
t.prototype.openPanel = function() {
...
y.default.instance.putPoint("5");
} else y.default.instance.putPoint("16");
this.closePanel();

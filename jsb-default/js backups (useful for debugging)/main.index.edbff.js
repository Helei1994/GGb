...
var i = e("../manager/LoadManager"), r = e("./AdsSetAndScene"), l = e("./AdsGroupPlatformTool"), s = e("./AdsQueue"), c = e("./AdsUnit"), u = e("../manager/SDKManager"), d = e("../Lib/LocalStorage"), p = e("../Lib/Global"), f = e("../manager/PanelManager"), h = cc._decorator, g = h.ccclass, m = (h.property, 
function(e) {
o(t, e);
function t() {
...
var g = u.idName.split(",")[0], m = u.state;
...
n.Adver_Type = void 0;
var i, r = e("./SDKManager"), l = e("./PanelManager"), s = e("./Umeng_Manager"), c = e("../Lib/Global"), u = e("./MyRoleDataManager"), d = e("../Config/Config"), p = cc._decorator, f = p.ccclass, h = (p.property, 
function(e) {
o(t, e);
function t() {
...
void 0 === n && (n = null);
void 0 === o && (o = 30);
if (cc.sys.os === cc.sys.OS_ANDROID || cc.sys.os === cc.sys.OS_IOS) if (u.default.instance.isopenAdvert && !d.default.isTouTiaoChannel) {
...
var i = e("../../../code/manager/MyRoleDataManager"), r = e("../../../code/manager/PanelManager"), l = e("../../../code/Lib/Global"), s = e("../../../code/manager/TableManager"), c = e("../../../code/Config/Config"), u = e("../../../code/manager/SoundManager"), d = e("../LatticeProgress"), p = e("../../../code/manager/Umeng_Manager"), f = e("../../../code/manager/GuideManager"), h = e("../../../code/manager/New_HttpManager"), g = cc._decorator, m = g.ccclass, y = g.property, b = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.infoBtn = null;
...
if (f.default.instance.get_isInGuide()) {
p.default.instance.putPoint(p.Point_EventID.ClickButton_propertBtn);
h.default.instance.putPoint("3");
}
...
h.default.instance.putPintGun2Level(this.funnelId.toString(), i.default.instance.funnelObject[this.funnelId].level.toString(), this.upgradeMoney.toString());
} else {
var e = this.node.parent.parent.parent.parent.parent.getChildByName("hint"), t = "<color=#ff564f>%x</color>".replace("%x", GlobalFun.i18n.t("lable.10299")), n = "<color=#ff564f>%c</color>".replace("%c", GlobalFun.i18n.t("lable.10300"));
e.getComponentInChildren(cc.RichText).string = GlobalFun.i18n.t("lable.10292").replace("%a", t).replace("%b", n);
e.opacity = 255;
...
"../../../code/manager/New_HttpManager": "New_HttpManager",
...
var i = e("../../../code/basecode/BasePanel"), r = e("../../../code/manager/UiAniManager"), l = e("../../../code/manager/PanelManager"), s = e("../../../code/Config/Config"), c = e("../../../code/manager/TableManager"), u = e("../../../code/manager/MyRoleDataManager"), d = e("../../../code/manager/SoundManager"), p = e("../../../code/manager/NodePoolMananger"), f = e("../../prefab/ShowPrefab"), h = e("../../../code/manager/GuideManager"), g = e("../../../code/Lib/Global"), m = e("../../../code/manager/EffectManager"), y = e("../../../code/manager/SDKManager"), b = e("../../../code/manager/Umeng_Manager"), v = e("../../../code/manager/New_HttpManager"), S = cc._decorator, _ = S.ccclass, P = S.property, M = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.nameLable = null;
...
h.default.instance.get_isInGuide() ? v.default.instance.putPoint("1") : v.default.instance.putPoint("11");
};
...
null == this.vv2 && (this.vv2 = this.showNode.position);
this.showNode.setPosition(this.vv2.x, this.vv2.y - 20);
...
if (h.default.instance.get_isInGuide()) {
v.default.instance.putPoint("2");
b.default.instance.putPoint(b.Point_EventID.ClickButton_openBoxBtn);
} else v.default.instance.putPoint("12");
var t = c.default.instance.aircraftTable.getRondam();
y.default.instance.callJava("trackEventWithType", "(Ljava/lang/String;Ljava/lang/String;I)V", "UnlockAircraft", t.toString(), 1);
...
var o = "<color=#ff564f>%x</color>".replace("%x", GlobalFun.i18n.t("lable.10299")), a = "<color=#ff564f>%c</color>".replace("%c", GlobalFun.i18n.t("lable.10300"));
this.tishiKuang.getComponentInChildren(cc.RichText).string = GlobalFun.i18n.t("lable.10291").replace("%a", o).replace("%b", a);
...
m.default.instance.playEffect(m.EffectName.SubGunUnlockEffect, r, cc.v2(0, 0));
e.updateInfo();
e.effectComplete();
}));
...
var m = a.default.instance.pop("propPrefab"), y = g.collectPropId;
this.physicsNode.addChild(m);
var b = m.getComponent(u.default);
m.x = t;
m.y = n;
b.init(y, this.BuffPrefab, this.icons, !0);
b.toTop();
}
...
var l = e("../../code/basecode/EasyGetCompleteClass"), s = e("../../code/manager/NodePoolMananger"), c = e("../../code/manager/BallManager"), u = e("../../code/manager/MissionManger"), d = e("../../code/manager/PanelManager"), p = e("../../code/manager/MyRoleDataManager"), f = e("../../code/manager/SDKManager"), h = e("../../code/manager/SoundManager"), g = e("../../code/Lib/Global"), m = e("../../code/manager/EffectManager"), y = e("../game/Game"), b = e("../../../Prefab/CircleLifeProgressBar/CircleLifeProgressBar"), v = e("../../code/Config/Config"), S = cc._decorator, _ = S.ccclass, P = S.property, M = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.jumpHeight = 0;
...
e = this;
return [ 4, m.default.instance.playLoopEffect(m.EffectName.BallFrozenEffect, this.node, cc.v2(0, 0), "ballFrozenShowEffect") ];
...
var t = cc.find("Canvas").getComponent(y.default);
...
var i = e("../../../code/basecode/BasePanel"), r = e("../../../code/manager/UiAniManager"), l = e("../../../code/manager/PanelManager"), s = e("../../../code/Config/Config"), c = e("../../../code/manager/MissionManger"), u = e("../../../code/manager/MyRoleDataManager"), d = e("../../../code/manager/SoundManager"), p = e("../MissionPanel/RewardItem"), f = e("../../../code/manager/TableManager"), h = e("../../../code/manager/GuideManager"), g = e("../../../code/ads/AdsGroupController"), m = e("../../../code/manager/SDKManager"), y = e("../../../code/Lib/TimeCount"), b = e("../../../code/manager/Advert_Manager"), v = e("../../../code/manager/Umeng_Manager"), S = e("../../../code/Lib/LocalStorage"), _ = e("../../../code/manager/New_HttpManager"), P = cc._decorator, M = P.ccclass, C = P.property, L = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.rewardPrefab = null;
...
c.default.instance.maxMissionNum(4, Math.round(.001 * y.default.instance.getTimeCount("inGameTime")));
...
t.set(s.CurrencyType.Gold, u.default.instance.curGold);
this.xiaYiGuan.node.opacity = 0;
this.nameLable.node.opacity = 255;
var n = 0;
n = Number(this.curLevel.string) >= 5 ? 5 : 3;
...
u.default.instance.DisChannel == s.PubChannel.ChannelTaiWan && (7 != u.default.instance.curLevel && 12 != u.default.instance.curLevel || u.default.instance.isRate || l.default.instance.openPanel(s.PanelName.FiveStarPanel, l.default.gameUi.middleNode));
0 == Number(S.default.getItem("isFirst", "0")) && S.default.saveItem("isFirst", "1");
} else {
l.default.gameUi.isPass = !1;
var o = Number(S.default.getItem("FailTime", "0"));
if (0 == o && 0 != Number(S.default.getItem("weaponIntensifyGuide", "1"))) {
t.set(s.CurrencyType.Gold, 600);
this.xiaYiGuan.interactable = !0;
this.xiaYiGuan.node.opacity = 255;
this.adsBtn.node.active = !1;
}
1 == o && 0 != Number(S.default.getItem("isaircraftGuide", "1")) && t.set(s.CurrencyType.Diamond, 50);
S.default.saveItem("FailTime", (o + 1).toString());
this.cut(!1);
...
this.rewardPrefab.getComponent(p.default).init(t);
if (u.default.instance.curDiamond < 2 || h.default.instance.checkCanGuide(10001, 0)) {
m.default.instance.callJava("trackEvent", "(Ljava/lang/String;)V", "GameCompleteRewardShow");
this.adsScenceId = "GameComplete";
this.moreRewardMap = t;
this.guideReward(t);
this.rewardPrefab.getComponent(p.default).init(t);
} else {
this.moreRewardMap = t;
this.adsScenceId = "DoubleDiamond";
m.default.instance.callJava("trackEvent", "(Ljava/lang/String;)V", "DoubleDiamondRewardShow");
}
};
...
this.panelOut();
if (1 == Number(S.default.getItem("isFirst", "0"))) {
S.default.saveItem("isFirst", "2");
l.default.game.immediateCombat();
} else l.default.gameUi.playUiInAni();
};
...
_.default.instance.putPointAdvertisement("8");
...
_.default.instance.putPointAdvertResult("1", "8");
_.default.instance.putPointLevel(u.default.instance.curLevel.toString(), l.default.game.totalResurgenceTimes.toString(), l.default.game.wacthAdvTimes.toString(), (5 * this.moreRewardMap.get(s.CurrencyType.Gold)).toString(), u.default.instance.checkGameState([ 5 ]) ? "1" : "0", l.default.game.Diamodnum.toString());
}.bind(this), function() {
this.isInBlack = !1;
this.adsBtn.interactable = !0;
this.xiaYiGuan.interactable = !0;
_.default.instance.putPointAdvertResult("0", "8");
}.bind(this));
}
};
...
this.xiaYiGuan.interactable = !1;
this.adsBtn.interactable = !1;
this.moreRewardMap.forEach(function(n, o) {
u.default.instance.addCurrency(n, o);
n <= 0 && t++;
t >= 2 && e.scheduleOnce(e.beBlack, 0);
});
if (u.default.instance.checkGameState([ 5 ])) {
v.default.instance.putPoint2(v.Point_EventID.levelComplate_num, "完成关卡(领取了奖励):" + u.default.instance.curLevel.toString());
_.default.instance.putPoint("20");
} else _.default.instance.putPoint("21");
_.default.instance.putPointLevel(u.default.instance.curLevel.toString(), l.default.game.totalResurgenceTimes.toString(), l.default.game.wacthAdvTimes.toString(), this.moreRewardMap.get(s.CurrencyType.Gold) + "", u.default.instance.checkGameState([ 5 ]) ? "1" : "0", l.default.game.Diamodnum.toString());
this.scheduleOnce(this.beBlack, this.nuber);
this.rewardPrefab.getComponent(p.default).init(this.moreRewardMap);
...
n.PropType = n.BoxLevel = n.CurrencyType = n.RoleAttribute = n.FunnelType = n.BulletType = n.FunnelConnonDirection = n.PanelName = n.SelfEvent = n.IosClassName = n.JavaClassName = n.PubChannel = void 0;
var a = cc._decorator, i = a.ccclass, r = (a.property, function() {
function e() {}
e.Verison = "2.3";
e.APKChannel = "Apk";
e.AndroidChannel = "android";
e.IOSChannel = "ios";
e.OtherChannel = "other";
e.isTouTiaoChannel = !1;
e.isNormalPlayType = !0;
e.isTryPlay = !1;
return e = o([ i ], e);
}());
n.default = r;
...
e.UmengSDKManager = "Um_SDK_Manager";
...
var l = e("../../code/manager/NodePoolMananger"), s = e("../../code/manager/MyRoleDataManager"), c = e("../../code/manager/TableManager"), u = e("../../code/Lib/LocalStorage"), d = e("../../code/manager/SoundManager"), p = e("./ConnonBase"), f = e("../../code/Lib/Global"), h = e("../../code/Config/Config"), g = e("../../code/manager/PanelManager"), m = e("../../code/manager/EffectManager"), y = e("../../code/manager/SDKManager"), b = e("../../BuffManager"), v = cc._decorator, S = v.ccclass, _ = v.property, P = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.bulletPrefab = [];
...
switch (n.label) {
case 0:
return this.effectMap.has(e) ? [ 2 ] : [ 4, m.default.instance.playLoopEffect(e, this.node, cc.v2(0, 0)) ];
...
this.cancelShoot();
} else y.default.instance.phoneShack();
...
y.default.instance.putPoint(y.Point_EventID.endlessReward_Click_num);
b.default.instance.putPointAdvertisement("6");
...
this.rewardPrefab.getComponent(m.default).init(this.moreRewardMap);
this.rewardPrefab.getComponent(m.default).rewardFly([ this.goldTarget, this.masonryTarget ], 5);
this.scheduleOnce(this.beBlack, this.nuber);
b.default.instance.putPointAdvertResult("1", "6");
l.default.game.wacthAdvTimes++;
b.default.instance.putPointEndlessLevel(l.default.game.totalResurgenceTimes.toString(), l.default.game.wacthAdvTimes.toString(), 5 * this.moreRewardMap.get(s.CurrencyType.Gold) + "", "1", l.default.game.Diamodnum.toString(), this.moreRewardMap.get(s.CurrencyType.Diamond) + "");
}.bind(this), function() {
this.isInBlack = !1;
this.adsBtn.interactable = !0;
this.xiaYiGuan.interactable = !0;
b.default.instance.putPointAdvertResult("0", "6");
}.bind(this));
} else {
this.isInBlack = !0;
this.adsBtn.interactable = !1;
...
this.rewardPrefab.getComponent(m.default).init(this.moreRewardMap);
this.rewardPrefab.getComponent(m.default).rewardFly([ this.goldTarget, this.masonryTarget ]);
this.scheduleOnce(this.beBlack, this.nuber);
b.default.instance.putPointEndlessLevel(l.default.game.totalResurgenceTimes.toString(), l.default.game.wacthAdvTimes.toString(), this.moreRewardMap.get(s.CurrencyType.Gold) + "", "1", l.default.game.Diamodnum.toString(), this.moreRewardMap.get(s.CurrencyType.Diamond) + "");
}
};
t.prototype.beBlack = function() {
this.adsBtn.interactable = !0;
...
var i = e("./code/Lib/LocalStorage"), r = e("./code/Lib/Global"), l = cc._decorator, s = l.ccclass, c = l.property, u = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.video = null;
...
a([ c(cc.Node) ], t.prototype, "video", void 0);
a([ c(cc.Label) ], t.prototype, "cishu", void 0);
return t = a([ s ], t);
}(cc.Component);
n.default = u;
cc._RF.pop();
...
var i = e("../../code/manager/SDKManager"), r = e("../../code/manager/MyRoleDataManager"), l = e("../../code/Lib/LocalStorage"), s = e("../../code/manager/SoundManager"), c = e("../../code/basecode/BasePanel"), u = e("../../code/manager/PanelManager"), d = e("../../code/manager/UiAniManager"), p = e("../../code/Config/Config"), f = cc._decorator, h = f.ccclass, g = f.property, m = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.nameLable = null;
...
t.prototype.setLable = function() {
this.nameLable.string = GlobalFun.i18n.t("lable.10302");
this.infoLable.string = GlobalFun.i18n.t("lable.10303");
this.questionLable.string = GlobalFun.i18n.t("lable.10228");
this.rateLabel.string = GlobalFun.i18n.t("lable.10304");
this.rateLabelShadow.string = GlobalFun.i18n.t("lable.10304");
this.endLabel.string = GlobalFun.i18n.t("lable.10305");
this.endLabelShadow.string = GlobalFun.i18n.t("lable.10305");
};
t.prototype.closeBtnTap = function() {
...
var i = e("../../code/Config/Config"), r = e("../../code/manager/PanelManager"), l = e("../../code/manager/NodePoolMananger"), s = e("../../code/manager/EffectManager"), c = e("../../code/manager/SoundManager"), u = e("../../code/manager/TableManager"), d = e("../../code/manager/MyRoleDataManager"), p = e("../../code/Lib/Global"), f = cc._decorator, h = f.ccclass, g = f.property, m = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.icon = null;
...
var f = u.default.instance.connonTable.getScourceId(this.rewadrType, 4), h = f[0], g = f[1], m = f[2];
this.connon.spriteFrame = r.default.game.playerScript.connonAtlas.getSpriteFrame(h + "0");
this.wheel.spriteFrame = r.default.game.playerScript.connonAtlas.getSpriteFrame(m + "0");
this.sub.spriteFrame = r.default.game.playerScript.connonAtlas.getSpriteFrame(g + "0");
var y = r.default.gameUi.downNode.y - 759;
...
var S = cc.sequence(cc.moveTo(.5, cc.v2(-270, y)), cc.callFunc(function() {
...
y = r.default.gameUi.highTopUiNode.y - 32;
...
this.node.setPosition(b);
var M = t ? cc.v2(t.position.x - 105, t.y) : cc.v2(this.arr[v], y), C = cc.sequence(cc.delayTime(.2), cc.moveTo(.5, M), cc.callFunc(function() {
r.default.gameUi.updataGold();
...
var l = e("./ConnonBase"), s = e("../../code/manager/NodePoolMananger"), c = e("../../code/manager/PanelManager"), u = e("../../code/Lib/Global"), d = e("../../code/Config/Config"), p = e("../../code/manager/TableManager"), f = e("../../code/manager/MyRoleDataManager"), h = e("../../code/manager/EffectManager"), g = cc._decorator, m = g.ccclass, y = g.property, b = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.connonAtlas = null;
...
var l = e("../../code/manager/PanelManager"), s = e("../../code/manager/MyRoleDataManager"), c = e("../../code/manager/MissionManger"), u = e("../../code/manager/LoadManager"), d = e("../../code/Lib/LocalStorage"), p = e("../../code/manager/SDKManager"), f = e("../../code/manager/SoundManager"), h = e("../../code/Config/Config"), g = e("../../code/Lib/Global"), m = e("../../code/manager/GuideManager"), y = e("../../code/manager/EffectManager"), b = e("../../code/manager/NodePoolMananger"), v = e("../../code/manager/TableManager"), S = e("../../code/manager/BallManager"), _ = e("../../code/Lib/DateUtils"), P = e("../../code/ads/AdsGroupController"), M = e("../../OffLineSkill"), C = e("../../code/manager/Advert_Manager"), L = e("../../OfflineEarnings"), T = e("../../IsHaveUnlock"), N = e("../../EndlessManagement"), A = e("../../code/manager/Umeng_Manager"), I = e("../../code/manager/New_HttpManager"), w = e("./Connon"), B = e("../../BuffManager"), k = cc._decorator, O = k.ccclass, R = k.property, G = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.uiInAni = [];
...
var e;
return r(this, function(t) {
this.version.string = "V:" + p.default.instance.getVserion();
this.uid.string = "U:" + d.default.getItem("userid", "");
s.default.instance.curLevel >= 3 && (this.shou.active = !1);
if ((e = Number(d.default.getItem("FailTime", "0"))) >= 1) {
...
if (this.discountShow(0)) c.default.instance.init(); else if (m.default.instance.checkCanGuide(10005, 0)) {
this.downNode.getComponent(cc.Widget).updateAlignment();
m.default.instance.startGuide(10005);
} else if (c.default.instance.init() && s.default.instance.curLevel > 1) {
this.downNode.getComponent(cc.Widget).updateAlignment();
m.default.instance.startGuide(10004);
}
};
t.prototype.update = function() {
...
t > 0 ? this.disCountLabel.string = _.default.instance.getFormatBySecond(t / 1e3, 1) : this.discountShow();
}
};
t.prototype.addEvent = function() {
var e = this;
...
I.default.instance.putPoint("10");
}
};
...
t.prototype.immediateCombat = function() {
...
this.exp_type = h.default.isNormalPlayType ? 4 : s.default.instance.curLevel % 5 == 0 ? 4 : 0;
if (1 == s.default.instance.curLevel) {
l.default.game.playerScript.propInvincible();
B.default.instance.addBuffShow(5e5, 10, l.default.game.BuffPrefab, this.buffIconAtlas[0], GlobalFun.i18n.t("lable.10269"));
}
}
this.playStartAni();
this.scoreLable.getComponent("MyLable").string = "0";
...
g.default.error("GameUI:动画uiIn调用了");
cc.tween(this.uiInNodes[0]).to(.5, {
position: cc.v3(this.uiInNodes[0].x - 300, this.uiInNodes[0].y)
}).start();
cc.tween(this.uiInNodes[1]).to(.5, {
...
this.schedule(function() {
s.default.instance.curLevel >= 3 && (this.shou.active = !1);
var e = Number(d.default.getItem("FailTime", "0"));
if (!this.isPass) if (1 == e) {
if (m.default.instance.checkCanGuide(10006, 0)) {
this.isguide = !0;
this.offlineAndSkillsParent.opacity = 255;
this.offlineAndSkillsS[0].active = !0;
this.offlineAndSkillsS[1].active = !0;
m.default.instance.startGuide(10006);
}
} else if (2 == e && (m.default.instance.checkCanGuide(10001, 0) || m.default.instance.checkCanGuide(10001, 1) || m.default.instance.checkCanGuide(10001, 2) || !m.default.instance.getEndlessState(10001))) {
this.isguide = !0;
l.default.gameUi.aircraftBtn.interactable = !0;
l.default.gameUi.aircraftBtn.node.opacity = 255;
this.scheduleOnce(function() {
m.default.instance.startGuide(10001);
}, 1);
}
if (s.default.instance.curLevel >= 11 && (m.default.instance.checkCanGuide(10002, 0) || !m.default.instance.getEndlessState(10002))) {
this.isguide = !0;
l.default.gameUi.refitBtn.interactable = !0;
l.default.gameUi.refitBtn.node.opacity = 255;
this.scheduleOnce(function() {
m.default.instance.startGuide(10002);
}, 1);
}
if (s.default.instance.curLevel >= 16 && (m.default.instance.checkCanGuide(10003, 0) || m.default.instance.checkCanGuide(10003, 1) || !m.default.instance.getEndlessState(10003))) {
this.isguide = !0;
this.endlessBtn.interactable = !0;
this.endlessBtn.node.opacity = 255;
m.default.instance.startGuide(10003);
}
s.default.instance.isFromComplete && (s.default.instance.isFromComplete = !1);
...
a = function() {
p.prefab90005.getComponent(cc.Animation).play();
};
i = function() {
p.prefab90006.getComponent(cc.Animation).play();
};
if ("90001" == t || "90002" == t) {
if (null == this.prefab90005) {
l = cc.instantiate(this.effectPrefabArr[0]);
this.backGroud.node.addChild(l);
this.prefab90005 = this.backGroud.node.getChildByName("90005prefab");
this.prefab90005.setPosition(this.prefab90005.x, this.prefab90005.y - 25);
}
this.unschedule(a);
if (null != this.prefab90006) {
this.prefab90006.destroy();
this.prefab90006 = null;
}
this.schedule(a, 20, Number.MAX_VALUE, 0);
} else {
if (null == this.prefab90006) {
c = cc.instantiate(this.effectPrefabArr[1]);
this.backGroud.node.addChild(c);
this.prefab90006 = this.backGroud.node.getChildByName("90006prefab");
}
this.unschedule(i);
if (null != this.prefab90005) {
this.prefab90005.destroy();
this.prefab90005 = null;
}
this.schedule(i, 20, Number.MAX_VALUE, 0);
}
return [ 2 ];
}
});
...
P.default.instance.cancelWaitAdsReady();
};
...
y.default.instance.playEffect(y.EffectName.BlickEffect, this.currencyIcon[e], cc.v2(0, 0), null, [ "blinkChip", "blinkDiamond", "blinkGold" ][e]);
...
this.HurdleIsOpen && this.OpenCloseHurdle();
m.default.instance.get_isInGuide() && A.default.instance.putPoint(A.Point_EventID.ClickButton_endlessBtn);
if (Number(d.default.getItem("Endless")) <= 0) {
A.default.instance.putPoint(A.Point_EventID.endless_Click_num);
I.default.instance.putPointAdvertisement("4");
C.default.instance.show_Ad(C.Adver_Type.ReWardVideo_Adv, function(e) {
...
I.default.instance.putPointAdvertResult("1", "4");
}.bind(this), function() {
I.default.instance.putPointAdvertResult("0", "4");
}.bind(this));
} else {
f.default.playSoundEffect(f.default.btnSound);
l.default.instance.openPanel(h.PanelName.SkinPanel, this.middleNode);
...
if (8 != s.default.instance.gameState) {
m.default.instance.get_isInGuide() && A.default.instance.putPoint(A.Point_EventID.ClickButton_aircraftBtn);
...
a([ R([ cc.Animation ]) ], t.prototype, "uiInAni", void 0);
a([ R([ cc.Animation ]) ], t.prototype, "uiOutAni", void 0);
a([ R(cc.Animation) ], t.prototype, "handMoveAni", void 0);
a([ R(cc.Node) ], t.prototype, "scoreLable", void 0);
a([ R(cc.Label) ], t.prototype, "startLab", void 0);
a([ R(cc.Sprite) ], t.prototype, "handSprite", void 0);
a([ R(cc.Node) ], t.prototype, "levelCompleteNode", void 0);
a([ R(cc.Sprite) ], t.prototype, "backGroud", void 0);
a([ R(cc.Label) ], t.prototype, "maxScoreLable", void 0);
a([ R({
type: cc.Label,
tooltip: "游戏币lable"
}) ], t.prototype, "goldLable", void 0);
...
a([ R(cc.Animation) ], t.prototype, "goldLableAni", void 0);
a([ R(cc.Sprite) ], t.prototype, "goldImg", void 0);
a([ R(cc.Animation) ], t.prototype, "backgroundShackAni", void 0);
a([ R(cc.Animation) ], t.prototype, "blackAni", void 0);
a([ R(cc.Node) ], t.prototype, "middleNode", void 0);
a([ R([ cc.Prefab ]) ], t.prototype, "effectPrefabArr", void 0);
a([ R(cc.Node) ], t.prototype, "effectNode", void 0);
a([ R(cc.Layout) ], t.prototype, "goldLayout", void 0);
a([ R({
type: cc.Label,
tooltip: "游戏币lable"
...
a([ R(cc.SpriteFrame) ], t.prototype, "singleColor", void 0);
a([ R(cc.Node) ], t.prototype, "maskNode", void 0);
a([ R(cc.Label) ], t.prototype, "curLevel", void 0);
a([ R(cc.Label) ], t.prototype, "nextLevel", void 0);
a([ R(cc.ProgressBar) ], t.prototype, "pro", void 0);
a([ R({
type: cc.Node,
tooltip: "进度条节点"
}) ], t.prototype, "proNode", void 0);
a([ R(cc.Node) ], t.prototype, "maxscoreLayout", void 0);
a([ R(cc.Label) ], t.prototype, "levelLable", void 0);
a([ R({
type: cc.Button,
tooltip: "设置按钮"
...
a([ R([ cc.Node ]) ], t.prototype, "uiInNodes", void 0);
a([ R(cc.Button) ], t.prototype, "openLeftSideHurdle", void 0);
a([ R(N.default) ], t.prototype, "EndlessManager", void 0);
a([ R({
type: cc.Button,
tooltip: "强化技能按钮"
...
a([ R(cc.Label) ], t.prototype, "proTxt", void 0);
a([ R(L.default) ], t.prototype, "OfflineEarnings", void 0);
a([ R({
type: [ cc.SpriteFrame ],
tooltip: "buff icon资源"
...
a([ R(cc.Label) ], t.prototype, "version", void 0);
a([ R(cc.Label) ], t.prototype, "uid", void 0);
return t = a([ O ], t);
}(cc.Component);
n.default = G;
cc._RF.pop();
...
var l = e("../../code/basecode/EasyGetCompleteClass"), s = e("../../code/manager/BallManager"), c = e("../../code/manager/NodePoolMananger"), u = e("../../code/manager/MyRoleDataManager"), d = e("../../code/manager/PanelManager"), p = e("../../code/manager/MissionManger"), f = e("../../code/manager/TableManager"), h = e("../../code/manager/SDKManager"), g = e("../../code/Config/Config"), m = e("../../code/manager/SoundManager"), y = e("./Connon"), b = e("../../code/Lib/Global"), v = e("../../code/Lib/TimeCount"), S = e("../../code/Lib/LocalStorage"), _ = e("../../code/manager/EffectManager"), P = e("../prefab/SpeciaLaser"), M = e("../prefab/SpeedLowPrefab"), C = e("../../BuffManager"), L = e("../../code/manager/Umeng_Manager"), T = e("../../code/manager/New_HttpManager"), N = cc._decorator, A = N.ccclass, I = N.property, w = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.bulletPrefabArr = [];
...
if (g.default.isTryPlay) {
n = Number(S.default.getItem("PlayTime", "0"));
o = Date.now();
b.default.error("time:", o);
a = o / 864e5;
b.default.error("days:", a);
if (0 == n) S.default.saveItem("PlayTime", a.toString()); else {
b.default.error("playtime - days =", (a - n).toString());
a - n > 30 && cc.game.end();
}
}
return [ 2 ];
...
C.default.instance.removeAllBuff();
u.default.instance.InMagnetdelayed();
v.default.instance.startCount("inGameTime");
var e = b.default.arrRandom(m.default.bgmArr);
m.default.playBackGroudMusic(e);
this.playerScript.speedTemp = 1;
this.playerScript.speedLowCount = 0;
this.playerScript.setBullet();
this.changePhysicsEnabled(!0, !0);
d.default.gameUi.immediateCombat();
this.playerScript.init(u.default.instance.curCannonID);
this.playerScript.reLife();
var t = f.default.instance.scenceTable.getBallIcon(u.default.instance.curScenceID);
...
L.default.instance.putPoint_startLevel(String(u.default.instance.curLevel));
T.default.instance.putPoint("19");
...
this.totalResurgenceTimes = 0;
this.wacthAdvTimes = 0;
this.Diamodnum = 0;
...
u.default.instance.magnetProp(3);
for (e in C.default.instance.gobj) C.default.instance.gobj[e].updateTime(0);
this.playerScript.stopPropInvincible();
this.canclFrozen();
v.default.instance.endCount("inGameTime");
...
m.default.stopBackGroudMusic();
m.default.playSoundEffect(m.default.win);
...
void 0 === e && (e = !1);
m.default.setvolumeNum(1);
e || this.resurgenceTimes++;
this.totalResurgenceTimes++;
this.playerScript.reLife();
...
if (d.default.gameUi.HurdleIsOpen) d.default.gameUi.OpenCloseHurdle(); else {
cc.log("state:" + u.default.instance.gameState);
if (8 != u.default.instance.gameState) {
...
u.default.instance.gameState = 1;
this.changePhysicsEnabled(!0, !1);
C.default.instance.resumeAllBuff();
}
...
this.isInPaused = !0;
C.default.instance.pauseAllBuff();
}
this.playerScript.cancelShoot();
...
a([ I(cc.Node) ], t.prototype, "ballNode", void 0);
a([ I(cc.Node) ], t.prototype, "bulletNode", void 0);
a([ I(cc.Node) ], t.prototype, "Player", void 0);
a([ I(cc.Node) ], t.prototype, "wall", void 0);
a([ I(cc.Node) ], t.prototype, "frozen", void 0);
a([ I([ cc.Prefab ]) ], t.prototype, "ballPreArr", void 0);
a([ I(cc.Prefab) ], t.prototype, "coinPre", void 0);
a([ I(cc.Prefab) ], t.prototype, "connonPrefab", void 0);
a([ I(cc.Prefab) ], t.prototype, "boomPrefab", void 0);
a([ I(cc.Prefab) ], t.prototype, "funnulBommPrefab", void 0);
a([ I(cc.Prefab) ], t.prototype, "smokePrefab", void 0);
a([ I(cc.Prefab) ], t.prototype, "bloodPrefab", void 0);
a([ I(cc.Prefab) ], t.prototype, "coinNumPrefab", void 0);
a([ I(cc.Prefab) ], t.prototype, "completeEffect", void 0);
a([ I(cc.Prefab) ], t.prototype, "propPrefab", void 0);
a([ I({
type: cc.Prefab,
tooltip: "炮展示预制体"
...
var i = e("../../../code/Lib/Global"), r = e("../../../code/manager/TableManager"), l = e("../../../code/manager/SDKManager"), s = e("../../../code/Config/Config"), c = e("../../../code/Lib/Secret"), u = e("../../../code/manager/PanelManager"), d = e("../../../code/manager/EffectManager"), p = e("../../../code/Lib/DateUtils"), f = e("../../../code/manager/MyRoleDataManager"), h = cc._decorator, g = h.ccclass, m = h.property, y = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.nameLabel = null;
...
n.GuideType = void 0;
var a, i = e("../../src/ui/AircraftPanel/AircraftItem"), r = e("../../src/ui/MissionPanel/MissionItem"), l = e("../../src/ui/RefitShopPanel/RefitItem"), s = e("../Config/Config"), c = e("../Lib/LocalStorage"), u = e("./MissionManger"), d = e("./MyRoleDataManager"), p = e("./PanelManager"), f = e("./TableManager"), h = cc._decorator, g = h.ccclass, m = (h.property, 
function() {
function e() {
this.guideStep = 0;
this.isInGuide = 0;
...
this.guideHistory = {};
this.time = .5;
this.guideHistory = JSON.parse(c.default.getItem("guideHistory", "{}"));
}
t = e;
Object.defineProperty(e, "instance", {
get: function() {
...
if (!this.isInGuide) {
this.curGuideId = e;
this.maxStep = f.default.instance.guideTable.getStep(e);
this.guideStep = 0;
}
switch (e) {
case 10001:
...
case 10001:
c.default.saveItem("isaircraftGuide", "0");
break;

case 10002:
c.default.saveItem("isvideoUnlock", "0");
break;

case 10003:
c.default.saveItem("isNowGuidAccomplish", "0");
break;

case 10006:
c.default.saveItem("weaponIntensifyGuide", "0");
}
10003 != this.curGuideId && (d.default.instance.gameState = 0);
this.isInGuide = 0;
this.guideStep = 0;
this.maxStep = 0;
this.curGuideId = 0;
...
switch (e) {
case 10001:
cc.log(this.guideHistory[e]);
cc.log(2 == Number(c.default.getItem("FailTime", "0")));
cc.log(this.isInGuide == e);
cc.log(this.guideStep == t);
if ((!this.guideHistory[e] && 2 == Number(c.default.getItem("FailTime", "0")) || this.isInGuide == e) && this.guideStep == t) return !0;
break;

case 10002:
if ((!this.guideHistory[e] && 11 == d.default.instance.curLevel || this.isInGuide == e) && this.guideStep == t) return !0;
break;

case 10003:
if ((!this.guideHistory[e] && d.default.instance.curLevel > 15 || this.isInGuide == e) && this.guideStep == t) return !0;
break;
...
case 10006:
if ((!this.guideHistory[e] && 1 == Number(c.default.getItem("FailTime", "0")) || this.isInGuide == e) && this.guideStep == t) return !0;
}
return !1;
};
e.prototype.setGuideState = function(e, t) {
this.guideHistory[e] = t;
c.default.saveItem("guideHistory", JSON.stringify(this.guideHistory));
};
...
c.default.saveItem("guideHistory", JSON.stringify(this.guideHistory));
this.guideStep++;
var e = p.default.gameUi.refitBtn.node.parent.convertToWorldSpaceAR(p.default.gameUi.refitBtn.node.position);
p.default.instance.openPanel(s.PanelName.GuidePanel, p.default.gameUi.node, p.default.gameUi.refitBtn.node, e, "click", a.ClickTarget, f.default.instance.guideTable.getWord(10001, 0));
} else if (1 == this.guideStep) {
this.guideStep++;
var t = p.default.instance.getExistPanel(s.PanelName.RefitShopPanel).itemNodeArr[1], n = (e = t.parent.convertToWorldSpaceAR(t.position), 
t.getComponent(l.default).levelUpBtn.node);
p.default.instance.openPanel(s.PanelName.GuidePanel, p.default.gameUi.node, n, e, "click", a.ClickTarget, -1, {
width: t.width,
height: t.height
});
}
};
e.prototype.weaponIntensifyGuide = function() {
c.default.saveItem("weaponIntensifyGuide", "1");
this.guideHistory[10006] = !0;
this.isInGuide = 10006;
if (0 == this.guideStep) {
c.default.saveItem("guideHistory", JSON.stringify(this.guideHistory));
this.guideStep++;
p.default.gameUi.isIntensifyGuid = !0;
c.default.saveItem("BtTime", "2");
var e = p.default.gameUi.offlineAndSkillsS[1].parent.convertToWorldSpaceAR(p.default.gameUi.offlineAndSkillsS[1].position);
p.default.instance.openPanel(s.PanelName.GuidePanel, p.default.gameUi.node, p.default.gameUi.offlineAndSkillsS[1], e, "click", a.ClickTarget, f.default.instance.guideTable.getWord(10006, 1));
}
};
e.prototype.aircraftGuide = function() {
c.default.saveItem("isaircraftGuide", "1");
this.guideHistory[10001] = !0;
this.isInGuide = 10001;
if (0 == this.guideStep) {
c.default.saveItem("guideHistory", JSON.stringify(this.guideHistory));
this.guideStep++;
var e = p.default.gameUi.aircraftBtn.node.parent.convertToWorldSpaceAR(p.default.gameUi.aircraftBtn.node.position);
p.default.instance.openPanel(s.PanelName.GuidePanel, p.default.gameUi.node, p.default.gameUi.aircraftBtn.node, e, "click", a.ClickTarget, f.default.instance.guideTable.getWord(10001, 1));
} else if (1 == this.guideStep) {
this.guideStep++;
var t = p.default.instance.getExistPanel(s.PanelName.AircraftPanel).openGiftNode, n = (e = t.parent.convertToWorldSpaceAR(t.position), 
p.default.instance.getExistPanel(s.PanelName.AircraftPanel).openBtn.node);
p.default.instance.openPanel(s.PanelName.GuidePanel, p.default.gameUi.node, n, e, "click", a.ClickTarget, -1, {
width: t.width,
height: t.height
});
...
this.guideStep++;
var o = p.default.instance.getExistPanel(s.PanelName.AircraftPanel).openGiftNode.parent.children[4];
e = o.parent.convertToWorldSpaceAR(o.position), n = o.getComponent(i.default).levelUpBtn.node;
p.default.instance.openPanel(s.PanelName.GuidePanel, p.default.gameUi.node, n, e, "click", a.ClickTarget, f.default.instance.guideTable.getWord(10001, 3), {
width: o.width,
height: o.height
});
}
...
c.default.saveItem("isvideoUnlock", "1");
...
this.guideStep++;
var e = p.default.gameUi.refitBtn.node.parent.convertToWorldSpaceAR(p.default.gameUi.refitBtn.node.position);
p.default.instance.openPanel(s.PanelName.GuidePanel, p.default.gameUi.node, p.default.gameUi.refitBtn.node, e, "click", a.ClickTarget, f.default.instance.guideTable.getWord(10002, 1));
} else if (1 == this.guideStep) {
this.guideStep++;
p.default.instance.getExistPanel(s.PanelName.RefitShopPanel).setCurrentPage(1);
this.endGuide();
}
};
...
c.default.saveItem("guideHistory", JSON.stringify(this.guideHistory));
this.guideStep++;
var e = p.default.gameUi.missionBtn.node.parent.convertToWorldSpaceAR(p.default.gameUi.missionBtn.node.position);
p.default.instance.openPanel(s.PanelName.GuidePanel, p.default.gameUi.node, p.default.gameUi.missionBtn.node, e, "click", a.ClickTarget, f.default.instance.guideTable.getWord(10003, 0));
} else if (1 == this.guideStep) {
this.guideStep++;
var t = p.default.instance.getExistPanel(s.PanelName.MissionPanel).getCompleteNode(), n = (e = t.parent.convertToWorldSpaceAR(t.position), 
t.getComponent(r.default).completeBtn.node);
p.default.instance.openPanel(s.PanelName.GuidePanel, p.default.gameUi.node, n, e, "click", a.ClickTarget, -1, {
width: t.width,
height: t.height
});
...
this.guideStep++;
var e = p.default.gameUi.missionBtn.node.parent.convertToWorldSpaceAR(p.default.gameUi.missionBtn.node.position);
p.default.instance.openPanel(s.PanelName.GuidePanel, p.default.gameUi.node, p.default.gameUi.missionBtn.node, e, "click", a.ClickTarget, u.default.instance.curSpecilMission.missionStartDes);
} else if (1 == this.guideStep) {
this.guideStep++;
var t = p.default.instance.getExistPanel(s.PanelName.MissionPanel).completeBtn.node, n = (e = t.parent.convertToWorldSpaceAR(t.position), 
p.default.instance.getExistPanel(s.PanelName.MissionPanel).completeBtn.node);
p.default.instance.openPanel(s.PanelName.GuidePanel, p.default.gameUi.node, n, e, "click", a.ClickAny, -1, {
width: t.width + 10,
height: t.height + 10
}, function() {
...
switch (e) {
case 10001:
t = Number(c.default.getItem("isaircraftGuide", "1"));
break;

case 10002:
t = Number(c.default.getItem("isvideoUnlock", "1"));
break;

case 10003:
t = Number(c.default.getItem("isNowGuidAccomplish", "1"));
break;

case 10006:
t = Number(c.default.getItem("weaponIntensifyGuide", "1"));
}
return 0 == t;
};
e.prototype.endlessGuide = function() {
c.default.saveItem("isNowGuidAccomplish", "1");
this.guideHistory[10003] = !0;
this.isInGuide = 10003;
if (0 == this.guideStep) {
p.default.gameUi.endlessBtn.interactable = !1;
c.default.saveItem("guideHistory", JSON.stringify(this.guideHistory));
this.guideStep++;
var e = p.default.gameUi.endlessBtn.node.parent.convertToWorldSpaceAR(p.default.gameUi.endlessBtn.node.position);
p.default.instance.openPanel(s.PanelName.GuidePanel, p.default.gameUi.node, p.default.gameUi.endlessBtn.node, e, "click", a.ClickTarget, f.default.instance.guideTable.getWord(10003, 1));
} else if (1 == this.guideStep) {
this.guideStep++;
var t = p.default.instance.getExistPanel(s.PanelName.SkinPanel).startBtn.node;
e = t.parent.convertToWorldSpaceAR(t.position);
p.default.instance.openPanel(s.PanelName.GuidePanel, p.default.gameUi.node, t, e, "click", a.ClickTarget, f.default.instance.guideTable.getWord(10003, 2), {
width: t.width,
height: t.height
});
}
...
if (!l.default.gameUi.isIntensifyGuid) {
...
t.prototype.update = function() {};
t.prototype.start = function() {
p.default.instance.SetChannel(d.PubChannel.ChannelTaiWan);
m.default.instance.register();
m.default.instance.Advert_On_Off();
this.gameConfig();
this.loadAni.play();
};
...
switch (e.label) {
case 0:
"0" == s.default.getItem("PlayTime", "0") && s.default.saveItem("PlayTime", "0");
...
"false" == s.default.getItem("isopenAdvert", "true") && (u.default.instance.isopenAdvert = !1);
...
e = e ? this.getLanguage(e, t) : d.default.isTouTiaoChannel ? "cn" : "tw";
...
a([ v(cc.Label) ], t.prototype, "loadLable", void 0);
a([ v(cc.Animation) ], t.prototype, "loadAni", void 0);
return t = a([ b ], t);
}(cc.Component);
n.default = S;
cc._RF.pop();
...
var i = e("../../../code/manager/UiAniManager"), r = e("../../../code/manager/PanelManager"), l = e("../../../code/Config/Config"), s = e("../../../code/manager/NodePoolMananger"), c = e("./MapItemPrefab"), u = e("../../../code/manager/MyRoleDataManager"), d = e("../../../code/manager/SoundManager"), p = e("../../../code/basecode/BasePanel"), f = cc._decorator, h = f.ccclass, g = f.property, m = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.nodeArr = [];
...
var i = e("../../../code/manager/MissionManger"), r = e("../../../code/manager/TableManager"), l = e("../../../code/Lib/DateUtils"), s = e("../../../code/Lib/Global"), c = e("./RewardItem"), u = e("../../../code/manager/SoundManager"), d = e("../../../code/manager/PanelManager"), p = e("../../../code/manager/MyRoleDataManager"), f = e("../../../code/manager/SDKManager"), h = e("../../../code/manager/New_HttpManager"), g = e("../../../code/Config/Config"), m = cc._decorator, y = m.ccclass, b = m.property, v = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.missionNode = null;
...
var e = r.default.instance.missionTable.getReward(this.missionId);
e.forEach(function(e, t) {
p.default.instance.addCurrency(e, t);
});
this.missionAni.play("missionItemMove");
h.default.instance.putPoint("9");
h.default.instance.putPintMession(e.get(g.CurrencyType.Gold).toString(), this.missionData.id.toString(), e.get(g.CurrencyType.Diamond).toString(), "1", this.missionData.decId.toString());
}
};
...
var i = e("../../../code/manager/UiAniManager"), r = e("../../../code/basecode/BasePanel"), l = e("../../../code/manager/TableManager"), s = e("../../../code/manager/MissionManger"), c = e("../../../code/manager/PanelManager"), u = e("../../../code/Config/Config"), d = e("../../../code/manager/MyRoleDataManager"), p = e("./RewardItem"), f = e("../../../code/manager/SoundManager"), h = e("../../../code/manager/GuideManager"), g = e("../../../code/manager/SDKManager"), m = e("../../../code/Lib/Global"), y = e("../../../code/Lib/DateUtils"), b = e("../../../code/manager/New_HttpManager"), v = cc._decorator, S = v.ccclass, _ = v.property, P = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.nameLabel = null;
...
b.default.instance.putPoint("8");
};
t.prototype.update = function() {
if (this.isHaveSpecialMission) {
var e = m.default.getTime();
this.leftTimeLabel.string = GlobalFun.i18n.t("lable.10004") + y.default.instance.getFormatBySecond((s.default.instance.curSpecilMission.refreshTime - e) / 1e3, 1);
}
};
t.prototype.openPanel = function() {
this.updateInfo();
...
f.default.playSoundEffect(f.default.btnSound);
var e = s.default.instance.completeSpecial(), t = l.default.instance.missionTable.getReward(e);
...
b.default.instance.putPintMession(t.get(u.CurrencyType.Gold).toString(), s.default.instance.curSpecilMission.id.toString(), t.get(u.CurrencyType.Diamond).toString(), "2", s.default.instance.curSpecilMission.decId.toString());
}
};
t.prototype.okBtnTap = function() {
f.default.playSoundEffect(f.default.btnSound);
...
var a = e("../Lib/LocalStorage"), i = e("./SDKManager"), r = e("../Config/Config"), l = e("./SoundManager"), s = e("../Lib/Secret"), c = e("../Lib/Global"), u = e("./TableManager"), d = e("./PanelManager"), p = e("./BallManager"), f = e("./EffectManager"), h = cc._decorator, g = h.ccclass, m = (h.property, 
function() {
function e() {
this.isopenAdvert = !0;
this.isFullScreen = !1;
...
a.default.saveItem("DateTime", c.default.getTodayTime().toString());
a.default.saveItem("offLine", c.default.getTime().toString());
a.default.saveItem("earnings", "0");
a.default.saveItem("offLineLevel", "1");
...
New_HttpManager: [ function(e, t, n) {
"use strict";
cc._RF.push(t, "7f519hEyhpDbJfO9bUz46Pj", "New_HttpManager");
var o = this && this.__extends || function() {
var e = function(t, n) {
return (e = Object.setPrototypeOf || {
__proto__: []
...
var i = e("./PanelManager"), r = e("./SDKManager"), l = e("../Lib/LocalStorage"), s = e("../Lib/Global"), c = e("./MyRoleDataManager"), u = e("../Config/Config"), d = cc._decorator, p = d.ccclass, f = (d.property, 
function(e) {
o(t, e);
function t() {
var t = e.call(this) || this;
t.outTimeFun = null;
t.posturl = "http://game.tentons.cn/api/";
t.userid = "";
t.userid = l.default.getItem("userid", "");
t.request = new XMLHttpRequest();
t.outTimeFun = function() {
i.default.gameUi && i.default.gameUi.openMask(!1);
};
return t;
}
n = t;
...
void 0 === n && (n = null);
void 0 === o && (o = !1);
if (!(u.default.isTouTiaoChannel || r.default.instance.getNetState() < 0)) {
var a = new XMLHttpRequest();
o && i.default.gameUi && i.default.gameUi.openMask(!0);
var l = new Date().getTime();
a.open("POST", this.posturl + e + "?timeStamp=" + l, !0);
a.timeout = 3e3;
a.setRequestHeader("Content-Type", "application/x-www-form-urlencoded");
s.default.error("url:" + this.posturl + e + "?timeStamp=" + l);
s.default.error("params:" + t);
a.send(t);
a.onload = n || this.onPostComplete;
a.onerror = this.onPostIOError;
a.onprogress = this.onPostProgress;
a.ontimeout = this.onTimeOut;
a.abort = this.onAbort;
o && this.scheduleOnce(this.outTimeFun, 1);
}
};
t.prototype.get = function(e, t, n, o) {
void 0 === t && (t = "");
...
t.prototype.onPostComplete = function(e) {
s.default.error("请求成功了");
n.instance.unschedule(n.instance.outTimeFun);
n.instance.isSend = !1;
i.default.gameUi && i.default.gameUi.openMask(!1);
var t = JSON.parse(this.response);
t.code;
1 == t.resultCode && t.data.interfaceName;
};
t.prototype.onPostIOError = function(e) {
s.default.error("请求出错了");
n.instance.unschedule(n.instance.outTimeFun);
i.default.gameUi && i.default.gameUi.openMask(!1);
n.instance.isSend = !1;
};
...
s.default.error("data-----data.code:", e.code, "data.msg:", e.msg, "data.data:", e.data, "data.time:", e.time);
};
t.prototype.register = function() {
"" === this.userid ? r.default.instance.isNative || this.post("user/register", "idfa=" + r.default.instance.getDeviceId() + "&channel=" + c.default.instance.DisChannel + "&system=" + c.default.instance.OS_Channel + "&version=" + r.default.instance.getVserion() + "&istest=1", function(e) {
var t = JSON.parse(this.response);
n.instance.showerror(t);
if (1 == t.code) {
s.default.error("注册成功");
i.default.gameUi && i.default.gameUi.openMask(!1);
l.default.saveItem("userid", t.data);
n.instance.setUserID(t.data);
} else s.default.error("注册失败");
}, !0) : this.login();
};
t.prototype.login = function() {
if (!r.default.instance.isNative) {
if ("" == this.userid) {
this.register();
s.default.error("UID 是空的");
return;
}
this.post("user/login", "uid=" + this.userid + "&version=" + r.default.instance.getVserion() + "&istest=1", function(e) {
var t = JSON.parse(this.response);
n.instance.showerror(t);
1 == t.code ? s.default.error("登陆成功") : s.default.error("登陆失败");
});
}
};
t.prototype.Advert_On_Off = function() {
r.default.instance.isNative || this.post("system/switches", "status=0", function(e) {
var t = JSON.parse(this.response);
n.instance.showerror(t);
if (1 == t.code) {
if (1 == t.switch) {
l.default.saveItem("isopenAdvert", "true");
c.default.instance.isopenAdvert = !0;
} else if (2 == t.switch) {
l.default.saveItem("isopenAdvert", "false");
c.default.instance.isopenAdvert = !1;
}
s.default.error("广告开关请求成功");
} else s.default.error("广告开关请求失败");
});
};
t.prototype.putPoint = function(e) {
if (!r.default.instance.isNative) {
if ("" == this.userid) {
this.register();
s.default.error("UID 是空的");
...
this.post("event/report", "uid=" + this.userid + "&eventid=" + e, function(t) {
var o = JSON.parse(this.response);
n.instance.showerror(o);
1 == o.code ? s.default.error("上报事件成功,", e) : s.default.error("上报事件失败");
});
}
};
t.prototype.putPointLevel = function(e, t, o, a, i, l) {
if (!r.default.instance.isNative) {
if ("" == this.userid) {
this.register();
s.default.error("UID 是空的");
...
var c = "&levelid=" + e + "&usetimes=" + t + "&watchad=" + o + "&coin=" + a + "&result=" + i + "&usediamond=" + l;
this.post("gamelevel/normal", "uid=" + this.userid + c, function(e) {
var t = JSON.parse(this.response);
n.instance.showerror(t);
1 == t.code ? s.default.error("普通关卡上报（领奖）成功") : s.default.error("普通关卡上报（领奖）失败");
});
}
};
t.prototype.putPointAdvertisement = function(e) {
if (!r.default.instance.isNative) {
if ("" == this.userid) {
this.register();
s.default.error("UID 是空的");
...
this.post("ad/click", "uid=" + this.userid + "&adpositionid=" + e, function(e) {
var t = JSON.parse(this.response);
n.instance.showerror(t);
1 == t.code ? s.default.error("广告点击上报  成功") : s.default.error("广告点击上报 失败");
});
}
};
t.prototype.putPointAdvertResult = function(e, t) {
if (!r.default.instance.isNative) {
if ("" == this.userid) {
this.register();
s.default.error("UID 是空的");
...
this.post("ad/report", "uid=" + this.userid + "&status=" + e + "&adpositionid=" + t, function(e) {
var t = JSON.parse(this.response);
n.instance.showerror(t);
1 == t.code ? s.default.error("广告结果上报   成功") : s.default.error("广告结果上报  失败");
});
}
};
t.prototype.putPointEndlessLevel = function(e, t, o, a, i, l) {
if (!r.default.instance.isNative) {
if ("" == this.userid) {
this.register();
s.default.error("UID 是空的");
...
var c = "&levelid=" + e + "&watchad=" + t + "&coin=" + o + "&result=" + a + "&usedimaond=" + i + "&dimaond=" + l;
this.post("gamelevel/normal", "uid=" + this.userid + c, function(e) {
var t = JSON.parse(this.response);
n.instance.showerror(t);
1 == t.code ? s.default.error("无尽关卡上报（领奖）成功") : s.default.error("无尽关卡上报（领奖）失败");
});
}
};
t.prototype.putPintWeaponLevel = function(e, t, o) {
if (!r.default.instance.isNative) {
if ("" == this.userid) {
this.register();
s.default.error("UID 是空的");
...
this.post("equip/weapon", "uid=" + this.userid + "&levelid=" + e + "&coin=" + t + "&watchad=" + o, function(e) {
var t = JSON.parse(this.response);
n.instance.showerror(t);
1 == t.code ? s.default.error("升级武器日志 成功") : s.default.error("升级武器日志 失败");
});
}
};
t.prototype.putPintCoinLevel = function(e, t, o) {
if (!r.default.instance.isNative) {
if ("" == this.userid) {
this.register();
s.default.error("UID 是空的");
...
this.post("equip/coin", "uid=" + this.userid + "&levelid=" + e + "&coin=" + t + "&watchad=" + o, function(e) {
var t = JSON.parse(this.response);
n.instance.showerror(t);
1 == t.code ? s.default.error("离线金币等级日志 成功") : s.default.error("离线金币等级日志 失败");
});
}
};
t.prototype.putPintGun2Level = function(e, t, o) {
if (!r.default.instance.isNative) {
if ("" == this.userid) {
this.register();
s.default.error("UID 是空的");
...
this.post("equip/gun", "uid=" + this.userid + "&gid=" + e + "&levelid=" + t + "&coin=" + o, function(e) {
var t = JSON.parse(this.response);
n.instance.showerror(t);
1 == t.code ? s.default.error("副炮升级日志 成功") : s.default.error("副炮升级日志 失败");
});
}
};
t.prototype.putPintMession = function(e, t, o, a, i) {
if (!r.default.instance.isNative) {
if ("" == this.userid) {
this.register();
s.default.error("UID 是空的");
...
var l = "&coin=" + e + "&levelid=" + t + "&diamond=" + o + "&type=" + a + "&des=" + i;
this.post("daily/report", "uid=" + this.userid + l, function(e) {
var t = JSON.parse(this.response);
n.instance.showerror(t);
1 == t.code ? s.default.error("日常任务上报 成功") : s.default.error("日常任务上报 失败");
});
}
};
t.prototype.putPintofflineCoin = function(e, t) {
if (!r.default.instance.isNative) {
if ("" == this.userid) {
this.register();
s.default.error("UID 是空的");
...
var o = "&coin=" + e + "&watchad=" + t;
this.post("user/offline", "uid=" + this.userid + o, function(e) {
var t = JSON.parse(this.response);
n.instance.showerror(t);
1 == t.code ? s.default.error("离线金币上报 成功") : s.default.error("离线金币上报 失败");
});
}
};
var n;
...
var i = e("./code/Lib/LocalStorage"), r = e("./code/manager/MyRoleDataManager"), l = e("./code/manager/PanelManager"), s = e("./code/manager/TableManager"), c = e(".//code/Lib/Global"), u = e("./code/manager/Advert_Manager"), d = e("./code/manager/SoundManager"), p = e("./code/manager/Umeng_Manager"), f = e("./code/manager/New_HttpManager"), h = e("./code/manager/GuideManager"), g = e("./code/Config/Config"), m = cc._decorator, y = m.ccclass, b = m.property, v = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.LevelValue = null;
...
this.setLabelString[0].string = GlobalFun.i18n.t("lable.10277");
...
var e = "<color=#ff564f>%x</color>".replace("%x", GlobalFun.i18n.t("lable.10299")), t = "<color=#ff564f>%c</color>".replace("%c", GlobalFun.i18n.t("lable.10300"));
this.setRichTextString.string = GlobalFun.i18n.t("lable.10292").replace("%a", e).replace("%b", t);
};
t.prototype.start = function() {
var e = this;
this.node.on("click", function() {
e.goldUpgrade.node.active ? e.goldUpgradeButt() : e.videoUpgradeButt();
l.default.gameUi.HurdleIsOpen && l.default.gameUi.OpenCloseHurdle();
if (l.default.gameUi.isIntensifyGuid) {
var t = Number(i.default.getItem("BtTime", "2"));
if (t < 1) {
l.default.gameUi.isIntensifyGuid = !1;
l.default.instance.closePanel(g.PanelName.GuidePanel);
h.default.instance.completeGuide();
}
i.default.saveItem("BtTime", (t - 1).toString());
}
}, this);
...
this.isOffLineSkill ? f.default.instance.putPoint("18") : f.default.instance.putPoint("17");
d.default.playSoundEffect(d.default.upintensify);
f.default.instance.putPointAdvertisement(this.isOffLineSkill ? "2" : "1");
...
this.LevelValue.string = GlobalFun.i18n.t("lable.10281").replace("%d", this.offLineLevel);
this.switchCalculate();
f.default.instance.putPointAdvertResult("1", this.isOffLineSkill ? "2" : "1");
this.isOffLineSkill ? f.default.instance.putPintCoinLevel(this.offLineLevel.toString(), "0", "1") : f.default.instance.putPintWeaponLevel(this.offLineLevel.toString(), "0", "1");
}.bind(this), function() {
f.default.instance.putPointAdvertResult("0", this.isOffLineSkill ? "2" : "1");
}.bind(this));
};
...
i.default.saveItem(this.offOvBuffName, this.offLineLevel);
this.LevelValue.string = GlobalFun.i18n.t("lable.10281").replace("%d", this.offLineLevel);
this.isOffLineSkill ? f.default.instance.putPintCoinLevel(this.offLineLevel.toString(), this.nowUpgradeGold.toString(), "1") : f.default.instance.putPintWeaponLevel(this.offLineLevel.toString(), this.nowUpgradeGold.toString(), "1");
this.switchCalculate();
this.LineSkil.switchCalculate();
} else {
cc.Tween.stopAllByTarget(this.setRichTextString.node.parent);
this.setRichTextString.node.parent.opacity = 255;
cc.tween(this.setRichTextString.node.parent).delay(2).to(1, {
opacity: 0
}).start();
}
};
var n;
a([ b(cc.Label) ], t.prototype, "LevelValue", void 0);
a([ b(cc.Button) ], t.prototype, "videoUpgrade", void 0);
a([ b(cc.Button) ], t.prototype, "goldUpgrade", void 0);
a([ b(cc.Label) ], t.prototype, "upgradeGold", void 0);
a([ b(cc.Node) ], t.prototype, "tishi", void 0);
a([ b(cc.Animation) ], t.prototype, "effect", void 0);
a([ b(cc.Boolean) ], t.prototype, "isOffLineSkill", void 0);
a([ b(n) ], t.prototype, "LineSkil", void 0);
a([ b([ cc.Label ]) ], t.prototype, "setLabelString", void 0);
a([ b([ cc.Node ]) ], t.prototype, "fullLevel", void 0);
a([ b(cc.RichText) ], t.prototype, "setRichTextString", void 0);
return t = n = a([ y ], t);
}(cc.Component);
n.default = v;
cc._RF.pop();
...
var n = Number(i.default.getItem("FailTime", "0"));
if (1 == n) {
if (h.default.instance.checkCanGuide(10006, 0)) {
this.isguide = !0;
h.default.instance.startGuide(10006);
}
} else if (2 == n && (h.default.instance.checkCanGuide(10001, 0) || h.default.instance.checkCanGuide(10001, 1) || h.default.instance.checkCanGuide(10001, 2) || !h.default.instance.getEndlessState(10001))) {
this.isguide = !0;
this.scheduleOnce(function() {
...
g.default.instance.putPintofflineCoin(this.earnings.toString(), "0");
this.node.active = !1;
l.default.instance.gameState = 8;
if (l.default.instance.curLevel >= 16 && (h.default.instance.checkCanGuide(10003, 0) || h.default.instance.checkCanGuide(10003, 1) || !h.default.instance.getEndlessState(10003))) {
this.isguide = !0;
...
g.default.instance.putPointAdvertisement("9");
...
t.init(n);
t.rewardFly([ this.targetGold ], o);
l.default.instance.addCurrency(this.earnings * o);
g.default.instance.putPointAdvertResult("1", "9");
g.default.instance.putPintofflineCoin((this.earnings * o).toString(), "1");
i.default.saveItem("earnings", "0");
this.node.active = !1;
l.default.instance.gameState = 8;
if (l.default.instance.curLevel >= 16 && (h.default.instance.checkCanGuide(10003, 0) || h.default.instance.checkCanGuide(10003, 1) || !h.default.instance.getEndlessState(10003))) {
...
var a = Number(i.default.getItem("FailTime", "0"));
if (1 == a) {
if (h.default.instance.checkCanGuide(10006, 0)) {
this.isguide = !0;
h.default.instance.startGuide(10006);
}
} else if (2 == a && (h.default.instance.checkCanGuide(10001, 0) || h.default.instance.checkCanGuide(10001, 1) || h.default.instance.checkCanGuide(10001, 2) || !h.default.instance.getEndlessState(10001))) {
this.isguide = !0;
this.scheduleOnce(function() {
h.default.instance.startGuide(10001);
}, 1);
...
g.default.instance.putPointAdvertResult("0", "9");
}.bind(this));
};
...
var i = e("../../../code/manager/UiAniManager"), r = e("../../../code/manager/PanelManager"), l = e("../../../code/Config/Config"), s = e("../../../code/manager/MyRoleDataManager"), c = e("../MissionPanel/MissionItem"), u = e("../../../code/manager/MissionManger"), d = e("../../../code/manager/SoundManager"), p = e("../../../code/basecode/BasePanel"), f = cc._decorator, h = f.ccclass, g = f.property, m = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.backNode = null;
...
var i = e("../../code/Lib/Global"), r = e("../../code/manager/NodePoolMananger"), l = e("../../code/manager/TableManager"), s = e("../../code/manager/MyRoleDataManager"), c = e("../../code/manager/PanelManager"), u = e("../../code/manager/SoundManager"), d = e("../../code/manager/MissionManger"), p = e("../../code/manager/EffectManager"), f = e("../../code/Config/Config"), h = e("../../code/manager/BallManager"), g = e("../../BuffManager"), m = cc._decorator, y = m.ccclass, b = m.property, v = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.propIcon = null;
...
var i = e("../../../code/manager/MyRoleDataManager"), r = e("../../../code/manager/PanelManager"), l = e("../../../code/Config/Config"), s = e("../../../code/Lib/Global"), c = e("../../../code/manager/TableManager"), u = e("../../../code/manager/SoundManager"), d = e("../../../code/manager/EffectManager"), p = e("../LatticeProgress"), f = e("../../../code/manager/SDKManager"), h = cc._decorator, g = h.ccclass, m = h.property, y = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.infoBtn = null;
...
var i = e("../../../code/manager/UiAniManager"), r = e("../../../code/manager/MyRoleDataManager"), l = e("./RefitItem"), s = e("../../../code/manager/TableManager"), c = e("../../../code/manager/SoundManager"), u = e("../../../code/Config/Config"), d = e("../../../code/manager/PanelManager"), p = e("../../../code/basecode/BasePanel"), f = e("../../../code/manager/GuideManager"), h = e("../../../code/Lib/Global"), g = e("../../../code/manager/SDKManager"), m = e("../../../code/Lib/LocalStorage"), y = e("../../../code/manager/Advert_Manager"), b = e("../../../code/manager/Umeng_Manager"), v = e("../../../code/manager/New_HttpManager"), S = cc._decorator, _ = S.ccclass, P = S.property, M = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.nameNode = null;
...
v.default.instance.putPoint("13");
}
};
t.prototype.openPanel = function(e) {
void 0 === e && (e = 0);
...
m.default.saveItem("curCannonID", r.default.instance.curCannonID.toString());
this.outAction();
this.dleEvent();
this.playUIAni(i.InOrOut.OUT);
};
...
v.default.instance.putPoint("14");
};
...
this.NotUnlockHint.getComponentInChildren(cc.RichText).string = GlobalFun.i18n.t("lable." + s.default.instance.guideTable.getWord(10002, 2));
this.scheduleOnce(function() {
...
var n = (a = "<color=#ff564f>%x</color>").replace("%x", GlobalFun.i18n.t("lable.10299")), o = "<color=#ff564f>%c</color>".replace("%c", GlobalFun.i18n.t("lable.10300"));
this.NotUnlockHint.getComponentInChildren(cc.RichText).string = GlobalFun.i18n.t("lable.10292").replace("%a", n).replace("%b", o);
...
var a = "<color=#ff564f>%x</color>", i = GlobalFun.i18n.t("lable.10301").replace("%d", e);
n = a.replace("%x", i);
this.NotUnlockHint.getComponentInChildren(cc.RichText).string = GlobalFun.i18n.t("lable.10296").replace("%a", n);
cc.tween(this.NotUnlockHint).to(1, {
opacity: 255
}).delay(1).to(1, {
opacity: 0
...
var e = s.default.instance.cannonUnlock.getMap(this.chooseConnonID, !0);
b.default.instance.putPoint(b.Point_EventID.workshop_AdvClick_num);
if (r.default.instance.curLevel >= Number(e)) {
v.default.instance.putPointAdvertisement("11");
y.default.instance.show_Ad(y.Adver_Type.ReWardVideo_Adv, function(e) {
v.default.instance.putPointAdvertResult("1", "11");
r.default.instance.addConnon(this.chooseConnonID);
this.showButton(this.ButtonS[0]);
d.default.gameUi.HaveUnlock.isHaveUnlock();
this.connonGroup[this.chooseConnonID].getChildByName("connon").color = cc.color(255, 255, 255);
...
v.default.instance.putPointAdvertResult("0", "11");
}.bind(this));
} else {
var t = GlobalFun.i18n.t("lable.10301").replace("%d", e), n = "<color=#ff564f>%x</color>".replace("%x", t);
this.NotUnlockHint.getComponentInChildren(cc.RichText).string = GlobalFun.i18n.t("lable.10296").replace("%a", n);
cc.tween(this.NotUnlockHint).to(1, {
opacity: 255
}).delay(1).to(1, {
...
var e = s.default.instance.cannonUnlock.getMap(this.chooseConnonID, !0), t = GlobalFun.i18n.t("lable.10301").replace("%d", e), n = "<color=#ff564f>%x</color>".replace("%x", t);
this.NotUnlockHint.getComponentInChildren(cc.RichText).string = GlobalFun.i18n.t("lable.10296").replace("%a", n);
cc.tween(this.NotUnlockHint).to(1, {
opacity: 255
}).delay(1).to(1, {
...
v.default.instance.putPointAdvertisement("3");
y.default.instance.show_Ad(y.Adver_Type.ReWardVideo_Adv, function(e) {
r.default.instance.addCurrency(1e3);
d.default.gameUi.HaveUnlock.isHaveUnlock();
v.default.instance.putPointAdvertResult("1", "3");
}.bind(this), function() {
v.default.instance.putPointAdvertResult("0", "3");
}.bind(this));
};
...
var n = (a = "<color=#ff564f>%x</color>").replace("%x", GlobalFun.i18n.t("lable.10299")), o = "<color=#ff564f>%c</color>".replace("%c", GlobalFun.i18n.t("lable.10300"));
this.NotUnlockHint.getComponentInChildren(cc.RichText).string = GlobalFun.i18n.t("lable.10291").replace("%a", n).replace("%b", o);
cc.tween(this.NotUnlockHint).to(1, {
opacity: 255
}).delay(1).to(1, {
opacity: 0
...
a([ P([ cc.Label ]) ], t.prototype, "setLabelString", void 0);
return t = a([ _ ], t);
}(p.default);
n.default = M;
cc._RF.pop();
...
e("../../code/Config/Config")), u = e("../../code/manager/SoundManager"), d = e("../../code/basecode/BasePanel"), p = e("../../code/manager/UiAniManager"), f = e("../../code/manager/Advert_Manager"), h = e("../../code/manager/Umeng_Manager"), g = e("../../code/manager/New_HttpManager"), m = cc._decorator, y = m.ccclass, b = m.property, v = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.timePro = null;
...
return i(this, void 0, void 0, function() {
return r(this, function(e) {
this.countAni.pause("ResurgenceCount");
h.default.instance.putPoint(0 == s.default.instance.gameType ? h.Point_EventID.fighting_fuhuo_Click_num : h.Point_EventID.endless_fuhuo_Click_num);
g.default.instance.putPointAdvertisement(0 == s.default.instance.gameType ? "7" : "5");
...
l.default.gameUi.updataGold();
l.default.game.wacthAdvTimes++;
g.default.instance.putPointAdvertResult("1", 0 == s.default.instance.gameType ? "7" : "5");
}.bind(this), function() {
this.countAni.resume("ResurgenceCount");
g.default.instance.putPointAdvertResult("0", 0 == s.default.instance.gameType ? "7" : "5");
}.bind(this));
return [ 2 ];
});
});
...
l.default.instance.closePanel(c.PanelName.ResurgenceUi);
l.default.gameUi.updataGold();
l.default.game.Diamodnum += this.needDiamod;
} else {
this.resumeTime();
...
t.prototype.setLable = function() {
var e = "<color=#ff564f>%x</color>".replace("%x", GlobalFun.i18n.t("lable.10299")), t = "<color=#ff564f>%c</color>".replace("%c", GlobalFun.i18n.t("lable.10300"));
this.resurgenceLable.getComponentInChildren(cc.RichText).string = GlobalFun.i18n.t("lable.10291").replace("%a", e).replace("%b", t);
...
a([ b(cc.ProgressBar) ], t.prototype, "timePro", void 0);
a([ b(cc.Node) ], t.prototype, "resurgenceLable", void 0);
a([ b({
type: cc.Label,
tooltip: "复活钻石数量"
}) ], t.prototype, "diamondLable", void 0);
...
var i = e("./MyRoleDataManager"), r = (e("../Lib/LocalStorage"), e("./PanelManager")), l = e("../Config/Config"), s = e("../Lib/Global"), c = cc._decorator, u = c.ccclass, d = (c.property, 
function() {
function e() {}
t = e;
Object.defineProperty(e, "instance", {
...
void 0 === e && (e = "");
cc.sys.isNative && this.callJava("showToast", "(Ljava/lang/String;)V", e);
};
e.prototype.getDeviceId = function() {
return cc.sys.isNative ? this.callJava("getDeviceId", "()Ljava/lang/String;") : "111111";
};
...
e.prototype.getVserion = function() {
var e = l.default.Verison;
cc.sys.isNative && (e = this.callJava("getVersion", "()Ljava/lang/String;"));
return e;
};
...
if ("" === l) return "";
if (cc.sys.isNative) if (jsb) {
s.default.error.apply(s.default, a([ l, e ], i));
if (cc.sys.os === cc.sys.OS_ANDROID) return (n = jsb.reflection).callStaticMethod.apply(n, a([ l, e, t ], i));
if (cc.sys.os === cc.sys.OS_IOS) return (o = jsb.reflection).callStaticMethod.apply(o, a([ l, e ], i));
} else GlobalFun.log("no jsb");
return "";
};
...
case "onEventObject":
case "onEventValue":
return l.IosClassName.UmengSDKManager;
...
case "getSysCountry":
case "getVersion":
return l.IosClassName.ToolManager;
...
case "onEventObject":
return "onEventObject:attributes:";

case "onEventValue":
return "onEventValue:label:";
...
i.default.instance.DisChannel = e;
cc.sys.os === cc.sys.OS_ANDROID ? i.default.instance.OS_Channel = l.default.AndroidChannel : cc.sys.os === cc.sys.OS_IOS ? i.default.instance.OS_Channel = l.default.IOSChannel : i.default.instance.OS_Channel = l.default.OtherChannel;
};
var t;
return e = t = o([ u ], e);
}());
...
var i = e("../../code/basecode/BasePanel"), r = e("../../code/manager/UiAniManager"), l = e("../../code/manager/SoundManager"), s = e("../../code/basecode/CheckBox"), c = e("../../code/Lib/LocalStorage"), u = e("../../code/manager/MyRoleDataManager"), d = e("../../code/manager/PanelManager"), p = e("../../code/Config/Config"), f = e("../../code/manager/New_HttpManager"), h = cc._decorator, g = h.ccclass, m = h.property, y = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
...
this.setLable();
this.isEndLeftRight();
f.default.instance.putPoint("7");
};
t.prototype.isEndLeftRight = function() {};
t.prototype.closeBtnTap = function() {
d.default.instance.closePanel(p.PanelName.SetPanel);
};
a([ m(cc.Toggle) ], t.prototype, "backSoundToggle", void 0);
a([ m(cc.Toggle) ], t.prototype, "effectSoundToggle", void 0);
a([ m(cc.Toggle) ], t.prototype, "shackToggle", void 0);
a([ m(cc.Button) ], t.prototype, "leftButon", void 0);
a([ m(cc.Button) ], t.prototype, "rightButon", void 0);
a([ m(cc.Button) ], t.prototype, "closeBtn", void 0);
a([ m(cc.PageView) ], t.prototype, "languesPage", void 0);
a([ m(cc.Node) ], t.prototype, "languesLabel", void 0);
a([ m(cc.Label) ], t.prototype, "nameLabel", void 0);
return t = a([ g ], t);
}(i.default);
n.default = y;
cc._RF.pop();
...
var i = e("../../../code/manager/SDKManager"), r = e("../../../code/Lib/Secret"), l = e("../../../code/Config/Config"), s = e("../../../code/manager/PanelManager"), c = e("../../../code/manager/TableManager"), u = e("../../../code/manager/MyRoleDataManager"), d = e("../../../code/Lib/LocalStorage"), p = e("../../../code/manager/EffectManager"), f = e("../../../code/Lib/Global"), h = cc._decorator, g = h.ccclass, m = h.property, y = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.buyBtn = null;
...
t.prototype.start = function() {
y.default.instance.addPool(this.giftPrefab);
y.default.instance.addPool(this.shopPrefab);
};
...
r = y.default.instance.pop(e.giftPrefab.name);
e.scroll.content.addChild(r);
r.getComponent(m.default).init(i.id);
r.getComponent(m.default).setLable();
e.itemScriptArr.push(r.getComponent(m.default));
}, .1 * n) : 2 == i.type || 3 == i.type ? o.scheduleOnce(function() {
r = y.default.instance.pop(e.shopPrefab.name);
e.scroll.content.addChild(r);
...
var i = e("../../../code/manager/MyRoleDataManager"), r = e("../../../code/manager/TableManager"), l = e("../../../code/Lib/LocalStorage"), s = e("../../../code/manager/PanelManager"), c = e("../../../code/Config/Config"), u = e("../../../code/manager/SDKManager"), d = e("../../../code/manager/Advert_Manager"), p = e("../../../code/manager/Umeng_Manager"), f = e("../../../code/manager/New_HttpManager"), h = cc._decorator, g = h.ccclass, m = h.property, y = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
...
f.default.instance.putPointAdvertisement("10");
...
f.default.instance.putPointAdvertResult("1", "10");
}.bind(this), function() {
f.default.instance.putPointAdvertResult("0", "10");
}.bind(this));
...
var i = e("../../../code/basecode/BasePanel"), r = e("../../../code/manager/UiAniManager"), l = e("../../../code/manager/PanelManager"), s = e("../../../code/Config/Config"), c = e("../../../code/manager/MyRoleDataManager"), u = e("./SkinItem"), d = e("../../../code/manager/TableManager"), p = e("../../../code/manager/SDKManager"), f = e("../../../code/Lib/LocalStorage"), h = e("../../../code/manager/GuideManager"), g = e("../../../code/manager/Umeng_Manager"), m = e("../../../code/manager/New_HttpManager"), y = cc._decorator, b = y.ccclass, v = y.property, S = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.closeButton = null;
...
h.default.instance.get_isInGuide() ? m.default.instance.putPoint("4") : m.default.instance.putPoint("15");
};
t.prototype.openPanel = function() {
...
if (h.default.instance.get_isInGuide()) {
g.default.instance.putPoint(g.Point_EventID.ClickButton_gameStartBtn);
m.default.instance.putPoint("5");
} else m.default.instance.putPoint("16");
this.closePanel();
...
this.boxTable = new m.default(this.table.box);
this.OffLineTable = new y.default(this.table.offLine);
...
case cc.macro.KEY.s:
i.default.saveItem("curLevel", "10");
}
};
return t = a([ l ], t);
}(cc.Component));
...
e.workshop_AdvClick_num = "workshop_AdvClick_num";
...
e.ClickButton_gameStartBtn = "ClickButton_gameStartBtn";
...
var i = e("../../../code/manager/UiAniManager"), r = e("../../../code/manager/PanelManager"), l = e("../../../code/Config/Config"), s = e("../../../code/manager/TableManager"), c = e("../../../code/manager/SoundManager"), u = e("./WorkItem"), d = e("../../../code/manager/NodePoolMananger"), p = e("../../../code/basecode/BasePanel"), f = cc._decorator, h = f.ccclass, g = f.property, m = function(e) {
o(t, e);
function t() {
var t = null !== e && e.apply(this, arguments) || this;
t.nameLable = null;
